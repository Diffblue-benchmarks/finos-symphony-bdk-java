...
class BdkDatafeedConfigDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link BdkDatafeedConfig} (default constructor) IdFilePath is empty string.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test getIdFilePath(); given BdkDatafeedConfig (default constructor) IdFilePath is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
   ...
   *
   * <ul>
   *   <li>Given {@link BdkDatafeedConfig} (default constructor) IdFilePath is {@code foo}.
  ...
  @Test
  @DisplayName(
      "Test getIdFilePath(); given BdkDatafeedConfig (default constructor) IdFilePath is 'foo'; then return 'foo/'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String BdkDatafeedConfig.getIdFilePath()"})
