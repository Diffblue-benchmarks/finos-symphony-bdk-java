...
class BdkConfigFormatExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link BdkConfigFormatException#BdkConfigFormatException(String)}
   */
  @Test
  ...
  void testNewBdkConfigFormatException() {
    // Arrange and Act
    BdkConfigFormatException actualBdkConfigFormatException =
        new BdkConfigFormatException("An error occurred");
