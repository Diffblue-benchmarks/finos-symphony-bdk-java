...
class BotNotConfiguredExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: default or parameterless constructor of {@link BotNotConfiguredException}
   */
  @Test
  ...
  void testNewBotNotConfiguredException() {
    ...
    // Assert
    assertEquals(
        "Bot (service account) credentials have not been configured. You can however use services in OBO mode"
            + " if app authentication is configured.",
        actualBotNotConfiguredException.getMessage());
