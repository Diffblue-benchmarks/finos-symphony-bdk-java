...
class PaginationDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, pagination2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link Pagination#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Pagination.<init>()", "Pagination Pagination.cursors(PaginationCursors)",
      "PaginationCursors Pagination.getCursors()", "String Pagination.getNext()", "String Pagination.getPrevious()",
      "Pagination Pagination.next(String)", "Pagination Pagination.previous(String)",
      "void Pagination.setCursors(PaginationCursors)", "void Pagination.setNext(String)",
      "void Pagination.setPrevious(String)", "String Pagination.toString()"})
