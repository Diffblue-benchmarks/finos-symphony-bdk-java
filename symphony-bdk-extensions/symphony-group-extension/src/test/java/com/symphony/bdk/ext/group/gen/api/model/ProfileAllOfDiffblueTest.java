...
class ProfileAllOfDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link ProfileAllOf} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link ProfileAllOf#addAvatarsItem(Avatar)}
   */
  @Test
  ...
  void testAddAvatarsItem_givenProfileAllOf() {
    ...
    // Act and Assert
    assertSame(profileAllOf, profileAllOf.addAvatarsItem(new Avatar()));
  }

  /**
   * Test {@link ProfileAllOf#addAvatarsItem(Avatar)}.
   * <ul>
   *   <li>Given {@link ProfileAllOf} (default constructor) avatars {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ProfileAllOf#addAvatarsItem(Avatar)}
   */
  @Test
  @DisplayName("Test addAvatarsItem(Avatar); given ProfileAllOf (default constructor) avatars ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ProfileAllOf ProfileAllOf.addAvatarsItem(Avatar)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, profileAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ProfileAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ProfileAllOf.<init>()", "ProfileAllOf ProfileAllOf.avatars(List)",
      "List ProfileAllOf.getAvatars()", "String ProfileAllOf.getId()", "ProfileAllOf ProfileAllOf.id(String)",
      "void ProfileAllOf.setAvatars(List)", "void ProfileAllOf.setId(String)", "String ProfileAllOf.toString()"})
