...
class UploadAvatarDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UploadAvatar#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UploadAvatar.<init>()", "byte[] UploadAvatar.getImage()",
      "UploadAvatar UploadAvatar.image(byte[])", "void UploadAvatar.setImage(byte[])",
