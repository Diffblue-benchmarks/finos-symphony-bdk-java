...
class ProfileControlDiffblueTest {
  ...
  void testAddProfileFieldsItem_givenProfileControl() {
    ...
    // Act
    ProfileControl actualAddProfileFieldsItemResult =
        profileControl.addProfileFieldsItem("Profile Fields Item");

    // Assert
    assertSame(profileControl, actualAddProfileFieldsItemResult);
  }
  ...
  void testAddSearchFieldsItem_givenProfileControl() {
    ...
    // Act
    ProfileControl actualAddSearchFieldsItemResult =
        profileControl.addSearchFieldsItem("Search Fields Item");

    // Assert
    assertSame(profileControl, actualAddSearchFieldsItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(profileControl.hashCode(), profileControl2.hashCode());
  }
