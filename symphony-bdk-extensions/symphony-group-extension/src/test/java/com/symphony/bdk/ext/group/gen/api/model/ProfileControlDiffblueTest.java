...
class ProfileControlDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link ProfileControl} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link ProfileControl#addProfileFieldsItem(String)}
   */
  @Test
   ...
   * Test {@link ProfileControl#addProfileFieldsItem(String)}.
   * <ul>
   *   <li>Given {@link ProfileControl} (default constructor) profileFields {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ProfileControl#addProfileFieldsItem(String)}
   */
  @Test
  @DisplayName("Test addProfileFieldsItem(String); given ProfileControl (default constructor) profileFields HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ProfileControl ProfileControl.addProfileFieldsItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ProfileControl#addSearchFieldsItem(String)}
   */
  @Test
   ...
   * Test {@link ProfileControl#addSearchFieldsItem(String)}.
   * <ul>
   *   <li>Given {@link ProfileControl} (default constructor) SearchFields is {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link ProfileControl#addSearchFieldsItem(String)}
   */
  @Test
  @DisplayName("Test addSearchFieldsItem(String); given ProfileControl (default constructor) SearchFields is HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ProfileControl ProfileControl.addSearchFieldsItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link ProfileControl#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ProfileControl.<init>()", "ProfileControl ProfileControl.canHavePublicProfile(Boolean)",
      "Boolean ProfileControl.getCanHavePublicProfile()", "ImplicitConnection ProfileControl.getImplicitConnection()",
      "Set ProfileControl.getProfileFields()", "Set ProfileControl.getSearchFields()",
      "VisibilityRestriction ProfileControl.getVisibilityRestriction()", "Boolean ProfileControl.getWallSupport()",
      "ProfileControl ProfileControl.implicitConnection(ImplicitConnection)",
      "ProfileControl ProfileControl.profileFields(Set)", "ProfileControl ProfileControl.searchFields(Set)",
      "void ProfileControl.setCanHavePublicProfile(Boolean)",
      "void ProfileControl.setImplicitConnection(ImplicitConnection)", "void ProfileControl.setProfileFields(Set)",
      "void ProfileControl.setSearchFields(Set)", "void ProfileControl.setVisibilityRestriction(VisibilityRestriction)",
      "void ProfileControl.setWallSupport(Boolean)", "String ProfileControl.toString()",
  ...
  void testGettersAndSetters() {
    ...
    ProfileControl actualCanHavePublicProfileResult = actualProfileControl.canHavePublicProfile(true);
    ProfileControl actualImplicitConnectionResult = actualProfileControl.implicitConnection(new ImplicitConnection());
    ...
    ProfileControl actualVisibilityRestrictionResult = actualProfileControl
    ...
    VisibilityRestriction actualVisibilityRestriction = actualProfileControl.getVisibilityRestriction();

    // Assert
    assertEquals("class ProfileControl {\n" + "    visibilityRestriction: class VisibilityRestriction {\n"
