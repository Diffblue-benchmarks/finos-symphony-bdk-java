...
class VisibilityRestrictionDiffblueTest {
  /**
   * Test {@link VisibilityRestriction#equals(Object)}, and {@link
   * VisibilityRestriction#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean VisibilityRestriction.equals(Object)",
    "int VisibilityRestriction.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(visibilityRestriction.hashCode(), visibilityRestriction2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link VisibilityRestriction#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void VisibilityRestriction.<init>()",
    "Boolean VisibilityRestriction.getRestrictToTenants()",
    "Boolean VisibilityRestriction.getRestrictToUsers()",
    "Boolean VisibilityRestriction.getVisible()",
    ...
    "void VisibilityRestriction.setRestrictToUsers(Boolean)",
    "void VisibilityRestriction.setVisible(Boolean)",
    "String VisibilityRestriction.toString()",
    "VisibilityRestriction VisibilityRestriction.visible(Boolean)"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    VisibilityRestriction actualVisibilityRestriction = new VisibilityRestriction();
    VisibilityRestriction actualRestrictToTenantsResult =
        actualVisibilityRestriction.restrictToTenants(true);
    VisibilityRestriction actualRestrictToUsersResult =
        actualVisibilityRestriction.restrictToUsers(true);
