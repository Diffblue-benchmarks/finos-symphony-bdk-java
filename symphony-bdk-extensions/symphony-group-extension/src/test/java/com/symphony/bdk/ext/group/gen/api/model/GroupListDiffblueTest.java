...
class GroupListDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link GroupList} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link GroupList#addDataItem(ReadGroup)}
   */
  @Test
  ...
  void testAddDataItem_givenGroupList() {
    ...
    // Act
    GroupList actualAddDataItemResult = groupList.addDataItem(new ReadGroup());

    // Assert
    assertSame(groupList, actualAddDataItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link GroupList} (default constructor) data {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link GroupList#addDataItem(ReadGroup)}
   */
  @Test
  @DisplayName(
      "Test addDataItem(ReadGroup); given GroupList (default constructor) data ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"GroupList GroupList.addDataItem(ReadGroup)"})
  ...
  @MethodsUnderTest({
    ...
    "List GroupList.getData()",
    "Pagination GroupList.getPagination()",
    "GroupList GroupList.pagination(Pagination)",
    "void GroupList.setData(List)",
    "void GroupList.setPagination(Pagination)",
    "String GroupList.toString()"
  })
