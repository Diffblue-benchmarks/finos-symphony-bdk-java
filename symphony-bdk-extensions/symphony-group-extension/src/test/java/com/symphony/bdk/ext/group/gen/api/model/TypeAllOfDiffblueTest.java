...
class TypeAllOfDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(typeAllOf.hashCode(), typeAllOf2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link TypeAllOf#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void TypeAllOf.<init>()",
    "InteractionControl TypeAllOf.getInteractionControl()",
    "MembershipControl TypeAllOf.getMembershipControl()",
    "ProfileControl TypeAllOf.getProfileControl()",
    "TypeAllOf TypeAllOf.interactionControl(InteractionControl)",
    "TypeAllOf TypeAllOf.membershipControl(MembershipControl)",
    "TypeAllOf TypeAllOf.profileControl(ProfileControl)",
    "void TypeAllOf.setInteractionControl(InteractionControl)",
    "void TypeAllOf.setMembershipControl(MembershipControl)",
    "void TypeAllOf.setProfileControl(ProfileControl)",
    "String TypeAllOf.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    TypeAllOf actualTypeAllOf = new TypeAllOf();
    TypeAllOf actualInteractionControlResult =
        actualTypeAllOf.interactionControl(new InteractionControl());
    TypeAllOf actualMembershipControlResult =
        actualTypeAllOf.membershipControl(new MembershipControl());
