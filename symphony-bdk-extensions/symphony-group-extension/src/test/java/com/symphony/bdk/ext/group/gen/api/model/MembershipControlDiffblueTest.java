...
class MembershipControlDiffblueTest {
  ...
  void testAddEntitlementsItem_givenMembershipControl() {
    ...
    // Act
    MembershipControl actualAddEntitlementsItemResult = membershipControl.addEntitlementsItem("Dr");

    // Assert
    assertSame(membershipControl, actualAddEntitlementsItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(membershipControl.hashCode(), membershipControl2.hashCode());
  }
