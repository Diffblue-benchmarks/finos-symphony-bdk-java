...
class MembershipControlDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MembershipControl} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link MembershipControl#addEntitlementsItem(String)}
   */
  @Test
   ...
   * Test {@link MembershipControl#addEntitlementsItem(String)}.
   * <ul>
   *   <li>Given {@link MembershipControl} (default constructor) entitlements {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MembershipControl#addEntitlementsItem(String)}
   */
  @Test
  @DisplayName("Test addEntitlementsItem(String); given MembershipControl (default constructor) entitlements HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MembershipControl MembershipControl.addEntitlementsItem(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean MembershipControl.equals(Object)", "int MembershipControl.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link MembershipControl#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MembershipControl.<init>()",
      "MembershipControl MembershipControl.canBelongToMultipleGroup(Boolean)",
      "MembershipControl MembershipControl.entitlements(Set)",
      "Boolean MembershipControl.getCanBelongToMultipleGroup()", "Set MembershipControl.getEntitlements()",
      "Boolean MembershipControl.getManualMembership()", "Boolean MembershipControl.getNotifyMembersOnUpdate()",
      "Boolean MembershipControl.getRuleMembership()", "Boolean MembershipControl.getUpdateMembershipOnRuleUpdate()",
      ...
      "void MembershipControl.setCanBelongToMultipleGroup(Boolean)", "void MembershipControl.setEntitlements(Set)",
      "void MembershipControl.setManualMembership(Boolean)", "void MembershipControl.setNotifyMembersOnUpdate(Boolean)",
      "void MembershipControl.setRuleMembership(Boolean)",
      "void MembershipControl.setUpdateMembershipOnRuleUpdate(Boolean)", "String MembershipControl.toString()",
  ...
  void testGettersAndSetters() {
    ...
    MembershipControl actualCanBelongToMultipleGroupResult = actualMembershipControl.canBelongToMultipleGroup(true);
    MembershipControl actualEntitlementsResult = actualMembershipControl.entitlements(new HashSet<>());
    MembershipControl actualManualMembershipResult = actualMembershipControl.manualMembership(true);
    MembershipControl actualNotifyMembersOnUpdateResult = actualMembershipControl.notifyMembersOnUpdate(true);
    ...
    MembershipControl actualUpdateMembershipOnRuleUpdateResult = actualMembershipControl
    ...
    // Assert
    assertEquals("class MembershipControl {\n" + "    entitlements: []\n" + "    manualMembership: true\n"
        + "    ruleMembership: true\n" + "    updateMembershipOnRuleUpdate: true\n"
