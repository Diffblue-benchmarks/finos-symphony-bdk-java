...
class ProfileDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link Profile#addIndustryOfInterestItem(String)}
   */
  @Test
  ...
  void testAddIndustryOfInterestItem_givenProfile() {
    ...
    // Act
    Profile actualAddIndustryOfInterestItemResult =
        profile.addIndustryOfInterestItem("Industry Of Interest Item");

    // Assert
    assertSame(profile, actualAddIndustryOfInterestItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) industryOfInterest {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addIndustryOfInterestItem(String)}
  ...
  @Test
  @DisplayName(
      "Test addIndustryOfInterestItem(String); given Profile (default constructor) industryOfInterest ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addIndustryOfInterestItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#addAssetClassesOfInterestItem(String)}
   */
  @Test
  ...
  void testAddAssetClassesOfInterestItem_givenProfile() {
    ...
    // Act
    Profile actualAddAssetClassesOfInterestItemResult =
        profile.addAssetClassesOfInterestItem("Asset Classes Of Interest Item");

    // Assert
    assertSame(profile, actualAddAssetClassesOfInterestItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) assetClassesOfInterest {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addAssetClassesOfInterestItem(String)}
  ...
  @Test
  @DisplayName(
      "Test addAssetClassesOfInterestItem(String); given Profile (default constructor) assetClassesOfInterest ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addAssetClassesOfInterestItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#addMarketCoverageItem(String)}
   */
  @Test
  ...
  void testAddMarketCoverageItem_givenProfile() {
    ...
    // Act
    Profile actualAddMarketCoverageItemResult =
        profile.addMarketCoverageItem("Market Coverage Item");

    // Assert
    assertSame(profile, actualAddMarketCoverageItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) marketCoverage {@link HashSet#HashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addMarketCoverageItem(String)}
   */
  @Test
  @DisplayName(
      "Test addMarketCoverageItem(String); given Profile (default constructor) marketCoverage HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addMarketCoverageItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#addResponsibilityItem(String)}
   */
  @Test
  ...
  void testAddResponsibilityItem_givenProfile() {
    ...
    // Act
    Profile actualAddResponsibilityItemResult =
        profile.addResponsibilityItem("Responsibility Item");

    // Assert
    assertSame(profile, actualAddResponsibilityItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) responsibility {@link HashSet#HashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addResponsibilityItem(String)}
   */
  @Test
  @DisplayName(
      "Test addResponsibilityItem(String); given Profile (default constructor) responsibility HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addResponsibilityItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#addFunctionItem(String)}
   */
  @Test
  ...
  void testAddFunctionItem_givenProfile() {
    ...
    // Act
    Profile actualAddFunctionItemResult = profile.addFunctionItem("Function Item");

    // Assert
    assertSame(profile, actualAddFunctionItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) function {@link HashSet#HashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addFunctionItem(String)}
   */
  @Test
  @DisplayName(
      "Test addFunctionItem(String); given Profile (default constructor) function HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addFunctionItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#addInstrumentItem(String)}
   */
  @Test
  ...
  void testAddInstrumentItem_givenProfile() {
    ...
    // Act
    Profile actualAddInstrumentItemResult = profile.addInstrumentItem("Instrument Item");

    // Assert
    assertSame(profile, actualAddInstrumentItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) instrument {@link HashSet#HashSet()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addInstrumentItem(String)}
   */
  @Test
  @DisplayName(
      "Test addInstrumentItem(String); given Profile (default constructor) instrument HashSet()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addInstrumentItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#addAvatarsItem(Avatar)}
   */
  @Test
  ...
  void testAddAvatarsItem_givenProfile() {
    ...
    // Act
    Profile actualAddAvatarsItemResult = profile.addAvatarsItem(new Avatar());

    // Assert
    assertSame(profile, actualAddAvatarsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link Profile} (default constructor) avatars {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link Profile#addAvatarsItem(Avatar)}
   */
  @Test
  @DisplayName(
      "Test addAvatarsItem(Avatar); given Profile (default constructor) avatars ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Profile Profile.addAvatarsItem(Avatar)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link Profile#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void Profile.<init>()",
    "Profile Profile.assetClassesOfInterest(List)",
    "Profile Profile.avatars(List)",
    "Profile Profile.companyName(String)",
    "Profile Profile.displayName(String)",
    "Profile Profile.email(String)",
    "Profile Profile.function(Set)",
    "List Profile.getAssetClassesOfInterest()",
    "List Profile.getAvatars()",
    "String Profile.getCompanyName()",
    "String Profile.getDisplayName()",
    "String Profile.getEmail()",
    "Set Profile.getFunction()",
    "String Profile.getId()",
    "List Profile.getIndustryOfInterest()",
    "Set Profile.getInstrument()",
    "String Profile.getJobCity()",
    "String Profile.getJobDepartment()",
    "String Profile.getJobDivision()",
    "String Profile.getJobPhone()",
    "String Profile.getJobRole()",
    "String Profile.getJobTitle()",
    "Set Profile.getMarketCoverage()",
    "String Profile.getMobile()",
    "Set Profile.getResponsibility()",
    "Profile Profile.id(String)",
    "Profile Profile.industryOfInterest(List)",
    "Profile Profile.instrument(Set)",
    "Profile Profile.jobCity(String)",
    "Profile Profile.jobDepartment(String)",
    "Profile Profile.jobDivision(String)",
    "Profile Profile.jobPhone(String)",
    "Profile Profile.jobRole(String)",
    "Profile Profile.jobTitle(String)",
    "Profile Profile.marketCoverage(Set)",
    "Profile Profile.mobile(String)",
    "Profile Profile.responsibility(Set)",
    "void Profile.setAssetClassesOfInterest(List)",
    "void Profile.setAvatars(List)",
    "void Profile.setCompanyName(String)",
    "void Profile.setDisplayName(String)",
    "void Profile.setEmail(String)",
    "void Profile.setFunction(Set)",
    "void Profile.setId(String)",
    "void Profile.setIndustryOfInterest(List)",
    "void Profile.setInstrument(Set)",
    "void Profile.setJobCity(String)",
    "void Profile.setJobDepartment(String)",
    "void Profile.setJobDivision(String)",
    "void Profile.setJobPhone(String)",
    "void Profile.setJobRole(String)",
    "void Profile.setJobTitle(String)",
    "void Profile.setMarketCoverage(Set)",
    "void Profile.setMobile(String)",
    "void Profile.setResponsibility(Set)",
    "String Profile.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    Profile actualProfile = new Profile();
    Profile actualAssetClassesOfInterestResult =
        actualProfile.assetClassesOfInterest(new ArrayList<>());
