...
class PaginationCursorsDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean PaginationCursors.equals(Object)",
    "int PaginationCursors.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(paginationCursors.hashCode(), paginationCursors2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link PaginationCursors#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void PaginationCursors.<init>()",
    "PaginationCursors PaginationCursors.after(String)",
    "PaginationCursors PaginationCursors.before(String)",
    "String PaginationCursors.getAfter()",
    "String PaginationCursors.getBefore()",
    "void PaginationCursors.setAfter(String)",
    "void PaginationCursors.setBefore(String)",
    "String PaginationCursors.toString()"
  })
