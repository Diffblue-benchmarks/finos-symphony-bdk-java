...
class GroupImplicitConnectionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GroupImplicitConnection#addConnectedTenantsListItem(Integer)}
   */
  @Test
  @DisplayName("Test addConnectedTenantsListItem(Integer)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupImplicitConnection GroupImplicitConnection.addConnectedTenantsListItem(Integer)"})
  void testAddConnectedTenantsListItem() {
    ...
    // Act and Assert
    assertSame(groupImplicitConnection, groupImplicitConnection.addConnectedTenantsListItem(2));
  }

  /**
   * Test {@link GroupImplicitConnection#addConnectedTenantsListItem(Integer)}.
   * <ul>
   *   <li>Given {@link GroupImplicitConnection} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link GroupImplicitConnection#addConnectedTenantsListItem(Integer)}
   */
  @Test
  @DisplayName("Test addConnectedTenantsListItem(Integer); given GroupImplicitConnection (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupImplicitConnection GroupImplicitConnection.addConnectedTenantsListItem(Integer)"})
   ...
   * <p>
   * Method under test: {@link GroupImplicitConnection#addConnectedUsersListItem(Long)}
   */
  @Test
  @DisplayName("Test addConnectedUsersListItem(Long)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupImplicitConnection GroupImplicitConnection.addConnectedUsersListItem(Long)"})
  void testAddConnectedUsersListItem() {
    ...
    // Act and Assert
    assertSame(groupImplicitConnection, groupImplicitConnection.addConnectedUsersListItem(1L));
  }
   ...
   */
  @Test
  @DisplayName("Test addConnectedUsersListItem(Long); given GroupImplicitConnection (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupImplicitConnection GroupImplicitConnection.addConnectedUsersListItem(Long)"})
  ...
  /**
   * Test {@link GroupImplicitConnection#equals(Object)}, and {@link GroupImplicitConnection#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean GroupImplicitConnection.equals(Object)", "int GroupImplicitConnection.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, groupImplicitConnection2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link GroupImplicitConnection#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void GroupImplicitConnection.<init>()",
      ...
      "List GroupImplicitConnection.getConnectedTenantsList()", "List GroupImplicitConnection.getConnectedUsersList()",
      "void GroupImplicitConnection.setConnectedTenantsList(List)",
      "void GroupImplicitConnection.setConnectedUsersList(List)", "String GroupImplicitConnection.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    GroupImplicitConnection actualGroupImplicitConnection = new GroupImplicitConnection();
    GroupImplicitConnection actualConnectedTenantsListResult = actualGroupImplicitConnection
        .connectedTenantsList(new ArrayList<>());
    GroupImplicitConnection actualConnectedUsersListResult = actualGroupImplicitConnection
    ...
    List<Integer> actualConnectedTenantsList = actualGroupImplicitConnection.getConnectedTenantsList();
    List<Long> actualConnectedUsersList = actualGroupImplicitConnection.getConnectedUsersList();

    // Assert
    assertEquals("class GroupImplicitConnection {\n    connectedTenantsList: []\n    connectedUsersList: []\n}",
