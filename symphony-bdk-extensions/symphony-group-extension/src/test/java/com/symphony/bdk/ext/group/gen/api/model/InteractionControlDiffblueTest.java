...
class InteractionControlDiffblueTest {
  ...
  @MethodsUnderTest({"boolean InteractionControl.equals(Object)", "int InteractionControl.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link InteractionControl#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void InteractionControl.<init>()", "InteractionControl InteractionControl.allowIMs(Boolean)",
      "InteractionControl InteractionControl.allowRooms(Boolean)",
      "InteractionControl InteractionControl.canHaveInteraction(Boolean)", "Boolean InteractionControl.getAllowIMs()",
      "Boolean InteractionControl.getAllowRooms()", "Boolean InteractionControl.getCanHaveInteraction()",
      "InteractionTransfer InteractionControl.getInteractionTransfer()", "String InteractionControl.getTagStream()",
      "InteractionControl InteractionControl.interactionTransfer(InteractionTransfer)",
      "void InteractionControl.setAllowIMs(Boolean)", "void InteractionControl.setAllowRooms(Boolean)",
      "void InteractionControl.setCanHaveInteraction(Boolean)",
      "void InteractionControl.setInteractionTransfer(InteractionTransfer)",
      "void InteractionControl.setTagStream(String)", "InteractionControl InteractionControl.tagStream(String)",
  ...
  void testGettersAndSetters() {
    ...
    InteractionControl actualCanHaveInteractionResult = actualInteractionControl.canHaveInteraction(true);
    InteractionControl actualInteractionTransferResult = actualInteractionControl
    ...
    InteractionTransfer actualInteractionTransfer = actualInteractionControl.getInteractionTransfer();

    // Assert
    assertEquals("Tag Stream", actualInteractionControl.getTagStream());
    assertEquals("class InteractionControl {\n" + "    allowIMs: true\n" + "    allowRooms: true\n"
