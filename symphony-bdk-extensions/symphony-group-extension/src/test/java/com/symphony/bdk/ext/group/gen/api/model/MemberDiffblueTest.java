...
class MemberDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link Member#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Member.<init>()", "Long Member.getMemberId()", "Integer Member.getMemberTenant()",
      "Member Member.memberId(Long)", "Member Member.memberTenant(Integer)", "void Member.setMemberId(Long)",
      "void Member.setMemberTenant(Integer)", "String Member.toString()"})
