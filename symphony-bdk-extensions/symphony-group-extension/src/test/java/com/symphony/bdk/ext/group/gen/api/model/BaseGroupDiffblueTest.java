...
class BaseGroupDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(baseGroup.hashCode(), baseGroup2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link BaseGroup#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void BaseGroup.<init>()",
    "String BaseGroup.getName()",
    "Long BaseGroup.getOwnerId()",
    "Owner BaseGroup.getOwnerType()",
    "String BaseGroup.getType()",
    "BaseGroup BaseGroup.name(String)",
    "BaseGroup BaseGroup.ownerId(Long)",
    "BaseGroup BaseGroup.ownerType(Owner)",
    "void BaseGroup.setName(String)",
    "void BaseGroup.setOwnerId(Long)",
    "void BaseGroup.setOwnerType(Owner)",
    "void BaseGroup.setType(String)",
    "String BaseGroup.toString()",
    "BaseGroup BaseGroup.type(String)"
  })
