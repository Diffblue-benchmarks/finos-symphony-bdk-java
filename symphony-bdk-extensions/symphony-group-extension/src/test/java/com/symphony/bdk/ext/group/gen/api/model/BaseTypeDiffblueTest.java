...
class BaseTypeDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link BaseType#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void BaseType.<init>()", "String BaseType.getId()", "String BaseType.getName()",
      "Owner BaseType.getOwnerType()", "Status BaseType.getStatus()", "BaseType BaseType.id(String)",
      "BaseType BaseType.name(String)", "BaseType BaseType.ownerType(Owner)", "void BaseType.setId(String)",
      "void BaseType.setName(String)", "void BaseType.setOwnerType(Owner)", "void BaseType.setStatus(Status)",
      "BaseType BaseType.status(Status)", "String BaseType.toString()"})
