...
class BaseProfileDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link BaseProfile} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addIndustryOfInterestItem(String)}
   */
  @Test
  ...
  void testAddIndustryOfInterestItem_givenBaseProfile() {
    ...
    // Act and Assert
    assertSame(baseProfile, baseProfile.addIndustryOfInterestItem("Industry Of Interest Item"));
  }

  /**
   * Test {@link BaseProfile#addIndustryOfInterestItem(String)}.
   * <ul>
   *   <li>Given {@link BaseProfile} (default constructor) industryOfInterest {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addIndustryOfInterestItem(String)}
   */
  @Test
  @DisplayName("Test addIndustryOfInterestItem(String); given BaseProfile (default constructor) industryOfInterest ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"BaseProfile BaseProfile.addIndustryOfInterestItem(String)"})
   ...
   * <p>
   * Method under test: {@link BaseProfile#addAssetClassesOfInterestItem(String)}
   */
  @Test
  ...
  void testAddAssetClassesOfInterestItem() {
    ...
    // Act and Assert
    assertSame(baseProfile, baseProfile.addAssetClassesOfInterestItem("Asset Classes Of Interest Item"));
  }
   ...
   */
  @Test
  @DisplayName("Test addAssetClassesOfInterestItem(String); given BaseProfile (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"BaseProfile BaseProfile.addAssetClassesOfInterestItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addMarketCoverageItem(String)}
   */
  @Test
  ...
  void testAddMarketCoverageItem_givenBaseProfile() {
    ...
    // Act and Assert
    assertSame(baseProfile, baseProfile.addMarketCoverageItem("Market Coverage Item"));
  }

  /**
   * Test {@link BaseProfile#addMarketCoverageItem(String)}.
   * <ul>
   *   <li>Given {@link BaseProfile} (default constructor) marketCoverage {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addMarketCoverageItem(String)}
   */
  @Test
  @DisplayName("Test addMarketCoverageItem(String); given BaseProfile (default constructor) marketCoverage HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"BaseProfile BaseProfile.addMarketCoverageItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addResponsibilityItem(String)}
   */
  @Test
  ...
  void testAddResponsibilityItem_givenBaseProfile() {
    ...
    // Act and Assert
    assertSame(baseProfile, baseProfile.addResponsibilityItem("Responsibility Item"));
  }

  /**
   * Test {@link BaseProfile#addResponsibilityItem(String)}.
   * <ul>
   *   <li>Given {@link BaseProfile} (default constructor) responsibility {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addResponsibilityItem(String)}
   */
  @Test
  @DisplayName("Test addResponsibilityItem(String); given BaseProfile (default constructor) responsibility HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"BaseProfile BaseProfile.addResponsibilityItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addFunctionItem(String)}
   */
  @Test
  ...
  void testAddFunctionItem_givenBaseProfile() {
    ...
    // Act and Assert
    assertSame(baseProfile, baseProfile.addFunctionItem("Function Item"));
  }

  /**
   * Test {@link BaseProfile#addFunctionItem(String)}.
   * <ul>
   *   <li>Given {@link BaseProfile} (default constructor) function {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addFunctionItem(String)}
   */
  @Test
  @DisplayName("Test addFunctionItem(String); given BaseProfile (default constructor) function HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"BaseProfile BaseProfile.addFunctionItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addInstrumentItem(String)}
   */
  @Test
  ...
  void testAddInstrumentItem_givenBaseProfile() {
    ...
    // Act and Assert
    assertSame(baseProfile, baseProfile.addInstrumentItem("Instrument Item"));
  }

  /**
   * Test {@link BaseProfile#addInstrumentItem(String)}.
   * <ul>
   *   <li>Given {@link BaseProfile} (default constructor) instrument {@link HashSet#HashSet()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#addInstrumentItem(String)}
   */
  @Test
  @DisplayName("Test addInstrumentItem(String); given BaseProfile (default constructor) instrument HashSet()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"BaseProfile BaseProfile.addInstrumentItem(String)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, baseProfile2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link BaseProfile#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void BaseProfile.<init>()", "BaseProfile BaseProfile.assetClassesOfInterest(List)",
      "BaseProfile BaseProfile.companyName(String)", "BaseProfile BaseProfile.displayName(String)",
      "BaseProfile BaseProfile.email(String)", "BaseProfile BaseProfile.function(Set)",
      "List BaseProfile.getAssetClassesOfInterest()", "String BaseProfile.getCompanyName()",
      "String BaseProfile.getDisplayName()", "String BaseProfile.getEmail()", "Set BaseProfile.getFunction()",
      "List BaseProfile.getIndustryOfInterest()", "Set BaseProfile.getInstrument()", "String BaseProfile.getJobCity()",
      "String BaseProfile.getJobDepartment()", "String BaseProfile.getJobDivision()",
      "String BaseProfile.getJobPhone()", "String BaseProfile.getJobRole()", "String BaseProfile.getJobTitle()",
      "Set BaseProfile.getMarketCoverage()", "String BaseProfile.getMobile()", "Set BaseProfile.getResponsibility()",
      "BaseProfile BaseProfile.industryOfInterest(List)", "BaseProfile BaseProfile.instrument(Set)",
      "BaseProfile BaseProfile.jobCity(String)", "BaseProfile BaseProfile.jobDepartment(String)",
      "BaseProfile BaseProfile.jobDivision(String)", "BaseProfile BaseProfile.jobPhone(String)",
      "BaseProfile BaseProfile.jobRole(String)", "BaseProfile BaseProfile.jobTitle(String)",
      "BaseProfile BaseProfile.marketCoverage(Set)", "BaseProfile BaseProfile.mobile(String)",
      "BaseProfile BaseProfile.responsibility(Set)", "void BaseProfile.setAssetClassesOfInterest(List)",
      "void BaseProfile.setCompanyName(String)", "void BaseProfile.setDisplayName(String)",
      "void BaseProfile.setEmail(String)", "void BaseProfile.setFunction(Set)",
      "void BaseProfile.setIndustryOfInterest(List)", "void BaseProfile.setInstrument(Set)",
      "void BaseProfile.setJobCity(String)", "void BaseProfile.setJobDepartment(String)",
      "void BaseProfile.setJobDivision(String)", "void BaseProfile.setJobPhone(String)",
      "void BaseProfile.setJobRole(String)", "void BaseProfile.setJobTitle(String)",
      "void BaseProfile.setMarketCoverage(Set)", "void BaseProfile.setMobile(String)",
      "void BaseProfile.setResponsibility(Set)", "String BaseProfile.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    BaseProfile actualBaseProfile = new BaseProfile();
    BaseProfile actualAssetClassesOfInterestResult = actualBaseProfile.assetClassesOfInterest(new ArrayList<>());
    ...
    BaseProfile actualIndustryOfInterestResult = actualBaseProfile.industryOfInterest(new ArrayList<>());
    ...
    assertEquals("class BaseProfile {\n" + "    displayName: Display Name\n" + "    companyName: Company Name\n"
