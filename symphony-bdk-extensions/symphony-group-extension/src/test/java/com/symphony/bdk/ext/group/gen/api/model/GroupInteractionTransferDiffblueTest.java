...
class GroupInteractionTransferDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GroupInteractionTransfer#addRestrictedTenantsListItem(Integer)}
   */
  @Test
  @DisplayName("Test addRestrictedTenantsListItem(Integer)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupInteractionTransfer GroupInteractionTransfer.addRestrictedTenantsListItem(Integer)"})
  void testAddRestrictedTenantsListItem() {
    ...
    // Act and Assert
    assertSame(groupInteractionTransfer, groupInteractionTransfer.addRestrictedTenantsListItem(2));
  }

  /**
   * Test {@link GroupInteractionTransfer#addRestrictedTenantsListItem(Integer)}.
   * <ul>
   *   <li>Given {@link GroupInteractionTransfer} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link GroupInteractionTransfer#addRestrictedTenantsListItem(Integer)}
   */
  @Test
  @DisplayName("Test addRestrictedTenantsListItem(Integer); given GroupInteractionTransfer (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupInteractionTransfer GroupInteractionTransfer.addRestrictedTenantsListItem(Integer)"})
   ...
   * <p>
   * Method under test: {@link GroupInteractionTransfer#addRestrictedUsersListItem(Long)}
   */
  @Test
  @DisplayName("Test addRestrictedUsersListItem(Long)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupInteractionTransfer GroupInteractionTransfer.addRestrictedUsersListItem(Long)"})
  void testAddRestrictedUsersListItem() {
    ...
    // Act and Assert
    assertSame(groupInteractionTransfer, groupInteractionTransfer.addRestrictedUsersListItem(1L));
  }
   ...
   */
  @Test
  @DisplayName("Test addRestrictedUsersListItem(Long); given GroupInteractionTransfer (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupInteractionTransfer GroupInteractionTransfer.addRestrictedUsersListItem(Long)"})
  ...
  /**
   * Test {@link GroupInteractionTransfer#equals(Object)}, and {@link GroupInteractionTransfer#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean GroupInteractionTransfer.equals(Object)", "int GroupInteractionTransfer.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, groupInteractionTransfer2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link GroupInteractionTransfer#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void GroupInteractionTransfer.<init>()",
      ...
      "void GroupInteractionTransfer.setRestrictedUsersList(List)", "String GroupInteractionTransfer.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    GroupInteractionTransfer actualGroupInteractionTransfer = new GroupInteractionTransfer();
    GroupInteractionTransfer actualRestrictedTenantsListResult = actualGroupInteractionTransfer
        .restrictedTenantsList(new ArrayList<>());
    GroupInteractionTransfer actualRestrictedUsersListResult = actualGroupInteractionTransfer
    ...
    List<Integer> actualRestrictedTenantsList = actualGroupInteractionTransfer.getRestrictedTenantsList();
    List<Long> actualRestrictedUsersList = actualGroupInteractionTransfer.getRestrictedUsersList();

    // Assert
    assertEquals("class GroupInteractionTransfer {\n    restrictedTenantsList: []\n    restrictedUsersList: []\n}",
