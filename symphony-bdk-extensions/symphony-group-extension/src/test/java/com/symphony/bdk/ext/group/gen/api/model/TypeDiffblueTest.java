...
class TypeDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Type.<init>()", "String Type.getId()", "InteractionControl Type.getInteractionControl()",
      "MembershipControl Type.getMembershipControl()", "String Type.getName()", "Owner Type.getOwnerType()",
      "ProfileControl Type.getProfileControl()", "Status Type.getStatus()", "Type Type.id(String)",
      "Type Type.interactionControl(InteractionControl)", "Type Type.membershipControl(MembershipControl)",
      "Type Type.name(String)", "Type Type.ownerType(Owner)", "Type Type.profileControl(ProfileControl)",
      "void Type.setId(String)", "void Type.setInteractionControl(InteractionControl)",
      "void Type.setMembershipControl(MembershipControl)", "void Type.setName(String)", "void Type.setOwnerType(Owner)",
      "void Type.setProfileControl(ProfileControl)", "void Type.setStatus(Status)", "Type Type.status(Status)",
