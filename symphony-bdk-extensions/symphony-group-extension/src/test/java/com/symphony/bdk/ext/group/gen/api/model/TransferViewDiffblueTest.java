...
class TransferViewDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(transferView.hashCode(), transferView2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link TransferView#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    ...
    "Boolean TransferView.getRestrictToTenants()",
    "Boolean TransferView.getRestrictToUsers()",
    "Boolean TransferView.getVisible()",
    "TransferView TransferView.restrictToTenants(Boolean)",
    "TransferView TransferView.restrictToUsers(Boolean)",
    "void TransferView.setRestrictToTenants(Boolean)",
    "void TransferView.setRestrictToUsers(Boolean)",
    "void TransferView.setVisible(Boolean)",
    "String TransferView.toString()",
