...
class ImplicitConnectionDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean ImplicitConnection.equals(Object)",
    "int ImplicitConnection.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(implicitConnection.hashCode(), implicitConnection2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link ImplicitConnection#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ImplicitConnection.<init>()",
    "ImplicitConnection ImplicitConnection.all(Boolean)",
    "ImplicitConnection ImplicitConnection.connectToTenants(Boolean)",
    "ImplicitConnection ImplicitConnection.connectToUsers(Boolean)",
    "Boolean ImplicitConnection.getAll()",
    "Boolean ImplicitConnection.getConnectToTenants()",
    "Boolean ImplicitConnection.getConnectToUsers()",
    "void ImplicitConnection.setAll(Boolean)",
    "void ImplicitConnection.setConnectToTenants(Boolean)",
    "void ImplicitConnection.setConnectToUsers(Boolean)",
    "String ImplicitConnection.toString()"
  })
  void testGettersAndSetters() {
    ...
    ImplicitConnection actualConnectToTenantsResult =
        actualImplicitConnection.connectToTenants(true);
