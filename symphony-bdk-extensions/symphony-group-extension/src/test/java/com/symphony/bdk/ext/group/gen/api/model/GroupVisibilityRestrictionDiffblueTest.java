...
class GroupVisibilityRestrictionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GroupVisibilityRestriction#addRestrictedTenantsListItem(Integer)}
   */
  @Test
  @DisplayName("Test addRestrictedTenantsListItem(Integer)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupVisibilityRestriction GroupVisibilityRestriction.addRestrictedTenantsListItem(Integer)"})
  void testAddRestrictedTenantsListItem() {
    ...
    // Act and Assert
    assertSame(groupVisibilityRestriction, groupVisibilityRestriction.addRestrictedTenantsListItem(2));
  }

  /**
   * Test {@link GroupVisibilityRestriction#addRestrictedTenantsListItem(Integer)}.
   * <ul>
   *   <li>Given {@link GroupVisibilityRestriction} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link GroupVisibilityRestriction#addRestrictedTenantsListItem(Integer)}
   */
  @Test
  @DisplayName("Test addRestrictedTenantsListItem(Integer); given GroupVisibilityRestriction (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupVisibilityRestriction GroupVisibilityRestriction.addRestrictedTenantsListItem(Integer)"})
   ...
   * <p>
   * Method under test: {@link GroupVisibilityRestriction#addRestrictedUsersListItem(Long)}
   */
  @Test
  @DisplayName("Test addRestrictedUsersListItem(Long)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupVisibilityRestriction GroupVisibilityRestriction.addRestrictedUsersListItem(Long)"})
  void testAddRestrictedUsersListItem() {
    ...
    // Act and Assert
    assertSame(groupVisibilityRestriction, groupVisibilityRestriction.addRestrictedUsersListItem(1L));
  }
   ...
   */
  @Test
  @DisplayName("Test addRestrictedUsersListItem(Long); given GroupVisibilityRestriction (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"GroupVisibilityRestriction GroupVisibilityRestriction.addRestrictedUsersListItem(Long)"})
  ...
  /**
   * Test {@link GroupVisibilityRestriction#equals(Object)}, and {@link GroupVisibilityRestriction#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean GroupVisibilityRestriction.equals(Object)", "int GroupVisibilityRestriction.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link GroupVisibilityRestriction#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new GroupVisibilityRestriction(), "Different type to GroupVisibilityRestriction");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void GroupVisibilityRestriction.<init>()",
      ...
      "void GroupVisibilityRestriction.setRestrictedUsersList(List)", "String GroupVisibilityRestriction.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    GroupVisibilityRestriction actualGroupVisibilityRestriction = new GroupVisibilityRestriction();
    GroupVisibilityRestriction actualRestrictedTenantsListResult = actualGroupVisibilityRestriction
        .restrictedTenantsList(new ArrayList<>());
    GroupVisibilityRestriction actualRestrictedUsersListResult = actualGroupVisibilityRestriction
        .restrictedUsersList(new ArrayList<>());
    ...
    List<Integer> actualRestrictedTenantsList = actualGroupVisibilityRestriction.getRestrictedTenantsList();
    List<Long> actualRestrictedUsersList = actualGroupVisibilityRestriction.getRestrictedUsersList();

    // Assert
    assertEquals("class GroupVisibilityRestriction {\n    restrictedTenantsList: []\n    restrictedUsersList: []\n}",
