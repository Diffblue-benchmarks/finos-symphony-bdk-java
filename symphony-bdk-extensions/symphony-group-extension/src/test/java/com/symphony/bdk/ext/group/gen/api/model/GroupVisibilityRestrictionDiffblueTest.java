...
class GroupVisibilityRestrictionDiffblueTest {
  ...
  void testAddRestrictedTenantsListItem() {
    ...
    // Act
    GroupVisibilityRestriction actualAddRestrictedTenantsListItemResult =
        groupVisibilityRestriction.addRestrictedTenantsListItem(2);

    // Assert
    assertSame(groupVisibilityRestriction, actualAddRestrictedTenantsListItemResult);
  }
  ...
  void testAddRestrictedUsersListItem() {
    ...
    // Act
    GroupVisibilityRestriction actualAddRestrictedUsersListItemResult =
        groupVisibilityRestriction.addRestrictedUsersListItem(1L);

    // Assert
    assertSame(groupVisibilityRestriction, actualAddRestrictedUsersListItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(groupVisibilityRestriction.hashCode(), groupVisibilityRestriction2.hashCode());
  }
