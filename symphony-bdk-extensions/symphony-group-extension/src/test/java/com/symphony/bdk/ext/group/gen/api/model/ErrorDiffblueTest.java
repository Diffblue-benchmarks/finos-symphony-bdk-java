...
class ErrorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Error} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link Error#putContextItem(String, String)}
   */
  @Test
   ...
   * Test {@link Error#putContextItem(String, String)}.
   * <ul>
   *   <li>Given {@link Error} (default constructor) context {@link HashMap#HashMap()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Error#putContextItem(String, String)}
   */
  @Test
  @DisplayName("Test putContextItem(String, String); given Error (default constructor) context HashMap()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Error Error.putContextItem(String, String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Error.<init>()", "Error Error.code(String)", "Error Error.context(Map)",
      "Error Error.details(Object)", "String Error.getCode()", "Map Error.getContext()", "Object Error.getDetails()",
      "String Error.getMessage()", "Error Error.message(String)", "void Error.setCode(String)",
      "void Error.setContext(Map)", "void Error.setDetails(Object)", "void Error.setMessage(String)",
