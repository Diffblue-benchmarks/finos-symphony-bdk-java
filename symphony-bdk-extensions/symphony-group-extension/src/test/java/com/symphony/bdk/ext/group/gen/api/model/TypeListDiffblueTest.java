...
class TypeListDiffblueTest {
  ...
  void testAddDataItem_givenTypeList() {
    ...
    // Act
    TypeList actualAddDataItemResult = typeList.addDataItem(new BaseType());

    // Assert
    assertSame(typeList, actualAddDataItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(typeList.hashCode(), typeList2.hashCode());
  }
