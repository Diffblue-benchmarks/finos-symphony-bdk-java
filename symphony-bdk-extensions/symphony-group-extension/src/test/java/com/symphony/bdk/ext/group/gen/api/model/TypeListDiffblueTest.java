...
class TypeListDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link TypeList} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link TypeList#addDataItem(BaseType)}
   */
  @Test
   ...
   * Test {@link TypeList#addDataItem(BaseType)}.
   * <ul>
   *   <li>Given {@link TypeList} (default constructor) data {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TypeList#addDataItem(BaseType)}
   */
   ...
   * </ul>
   * <p>
   * Method under test: {@link TypeList#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void TypeList.<init>()", "TypeList TypeList.data(List)", "List TypeList.getData()",
      "Pagination TypeList.getPagination()", "TypeList TypeList.pagination(Pagination)", "void TypeList.setData(List)",
      "void TypeList.setPagination(Pagination)", "String TypeList.toString()"})
