...
class BotInfoServiceDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link BotInfoService#BotInfoService(SessionService)}
   */
  @Test
  @DisplayName("Test new BotInfoService(SessionService); given UserV2 (default constructor); then return BotInfo is UserV2 (default constructor)")
