...
class BdkOboServiceConfigDiffblueTest {
   ...
   * BdkOboServiceConfig#extensionAppAuthenticator(AuthenticatorFactory)}
   */
  @Test
  @DisplayName(
      "Test extensionAppAuthenticator(AuthenticatorFactory); given BdkRsaKeyConfig (default constructor) Content is 'AXAXAXAX' Bytes is 'UTF-8'")
  ...
  void testExtensionAppAuthenticator_givenBdkRsaKeyConfigContentIsAxaxaxaxBytesIsUtf8()
    ...
    assertThrows(
        ...
        () ->
            bdkOboServiceConfig.extensionAppAuthenticator(
   ...
   *
   * <ul>
   *   <li>Given {@link BeanInitializationException#BeanInitializationException(String)} with {@code
   *       Msg}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  @Test
  @DisplayName(
      "Test extensionAppAuthenticator(AuthenticatorFactory); given BeanInitializationException(String) with 'Msg'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.auth.ExtensionAppAuthenticator BdkOboServiceConfig.extensionAppAuthenticator(AuthenticatorFactory)"
  })
  void testExtensionAppAuthenticator_givenBeanInitializationExceptionWithMsg() {
    // Arrange
    BdkOboServiceConfig bdkOboServiceConfig = new BdkOboServiceConfig();
    BdkConfig bdkConfig = mock(BdkConfig.class);
    when(bdkConfig.getApp()).thenThrow(new BeanInitializationException("Msg"));
   ...
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboAuthenticator(AuthenticatorFactory)}
   */
  @Test
  @DisplayName(
      "Test oboAuthenticator(AuthenticatorFactory); given BdkRsaKeyConfig (default constructor) Content is 'AXAXAXAX' Bytes is 'UTF-8'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.auth.OboAuthenticator BdkOboServiceConfig.oboAuthenticator(AuthenticatorFactory)"
  })
  void testOboAuthenticator_givenBdkRsaKeyConfigContentIsAxaxaxaxBytesIsUtf8()
      throws UnsupportedEncodingException {
    // Arrange
    BdkOboServiceConfig bdkOboServiceConfig = new BdkOboServiceConfig();
    ...
    assertThrows(
        BeanInitializationException.class,
        () ->
            bdkOboServiceConfig.oboAuthenticator(
                new AuthenticatorFactory(bdkConfig, mock(ApiClientFactory.class))));
    verify(bdkConfig).getApp();
  }
  ...
  @Test
  @DisplayName(
      "Test oboAuthenticator(AuthenticatorFactory); given BeanInitializationException(String) with 'Msg'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.auth.OboAuthenticator BdkOboServiceConfig.oboAuthenticator(AuthenticatorFactory)"
  })
  void testOboAuthenticator_givenBeanInitializationExceptionWithMsg() {
    // Arrange
    BdkOboServiceConfig bdkOboServiceConfig = new BdkOboServiceConfig();
    BdkConfig bdkConfig = mock(BdkConfig.class);
    when(bdkConfig.getApp()).thenThrow(new BeanInitializationException("Msg"));
   ...
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboSessionService(SessionApi, BdkConfig)}
   */
  @Test
  ...
  @Test
  @DisplayName(
      "Test oboSessionService(SessionApi, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.service.session.SessionService BdkOboServiceConfig.oboSessionService(SessionApi, BdkConfig)"
  ...
  /**
   * Test {@link BdkOboServiceConfig#oboStreamService(StreamsApi, RoomMembershipApi, ShareApi,
   * BdkConfig)}.
   *
   * <ul>
   *   <li>Given {@link BdkRetryConfig#BdkRetryConfig()}.
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboStreamService(StreamsApi,
   * RoomMembershipApi, ShareApi, BdkConfig)}
   */
  @Test
  @DisplayName(
      "Test oboStreamService(StreamsApi, RoomMembershipApi, ShareApi, BdkConfig); given BdkRetryConfig()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @Test
  @DisplayName(
      "Test oboStreamService(StreamsApi, RoomMembershipApi, ShareApi, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.service.stream.StreamService BdkOboServiceConfig.oboStreamService(StreamsApi, RoomMembershipApi, ShareApi, BdkConfig)"
   ...
   * <ul>
   *   <li>Given {@link BdkRetryConfig#BdkRetryConfig()}.
   *   <li>When {@link BdkConfig} {@link BdkConfig#getRetry()} return {@link
   *       BdkRetryConfig#BdkRetryConfig()}.
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboUserService(UserApi, UsersApi,
   * AuditTrailApi, BdkConfig)}
   */
  @Test
  @DisplayName(
      "Test oboUserService(UserApi, UsersApi, AuditTrailApi, BdkConfig); given BdkRetryConfig(); when BdkConfig getRetry() return BdkRetryConfig()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  @Test
  @DisplayName(
      "Test oboUserService(UserApi, UsersApi, AuditTrailApi, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.service.user.UserService BdkOboServiceConfig.oboUserService(UserApi, UsersApi, AuditTrailApi, BdkConfig)"
   ...
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboPresenceService(PresenceApi, BdkConfig)}
   */
  @Test
  ...
  @Test
  @DisplayName(
      "Test oboPresenceService(PresenceApi, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.service.presence.PresenceService BdkOboServiceConfig.oboPresenceService(PresenceApi, BdkConfig)"
   ...
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboConnectionService(ConnectionApi,
   * BdkConfig)}
   */
  @Test
  ...
  @Test
  @DisplayName(
      "Test oboConnectionService(ConnectionApi, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.service.connection.ConnectionService BdkOboServiceConfig.oboConnectionService(ConnectionApi, BdkConfig)"
   ...
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboSignalService(SignalsApi, BdkConfig)}
   */
  @Test
  ...
  @Test
  @DisplayName(
      "Test oboSignalService(SignalsApi, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.core.service.signal.SignalService BdkOboServiceConfig.oboSignalService(SignalsApi, BdkConfig)"
  ...
  /**
   * Test {@link BdkOboServiceConfig#oboMessageService(MessagesApi, MessageApi,
   * MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, TemplateEngine,
   * BdkConfig)}.
   *
   * <ul>
   *   <li>Given {@link BdkRetryConfig#BdkRetryConfig()}.
   *   <li>Then return templates is {@link TemplateEngine}.
   * </ul>
   *
   * <p>Method under test: {@link BdkOboServiceConfig#oboMessageService(MessagesApi, MessageApi,
   * MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, TemplateEngine,
   * BdkConfig)}
   */
  @Test
  @DisplayName(
      "Test oboMessageService(MessagesApi, MessageApi, MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, TemplateEngine, BdkConfig); given BdkRetryConfig(); then return templates is TemplateEngine")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testOboMessageService_givenBdkRetryConfig_thenReturnTemplatesIsTemplateEngine() {
    ...
    // Act
    MessageService actualOboMessageServiceResult =
        bdkOboServiceConfig.oboMessageService(
            messagesApi,
            messageApi,
  ...
  @Test
  @DisplayName(
      "Test oboMessageService(MessagesApi, MessageApi, MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, TemplateEngine, BdkConfig); then throw BeanInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MessageService BdkOboServiceConfig.oboMessageService(MessagesApi, MessageApi, MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, TemplateEngine, BdkConfig)"
