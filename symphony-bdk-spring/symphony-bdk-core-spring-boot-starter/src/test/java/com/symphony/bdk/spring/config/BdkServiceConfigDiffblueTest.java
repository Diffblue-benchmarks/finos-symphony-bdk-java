...
class BdkServiceConfigDiffblueTest {
   ...
   * <ul>
   *   <li>When {@link AuthSession}.</li>
   *   <li>Then calls {@link BdkConfig#getRetry()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#sessionService(SessionApi, AuthSession, BdkConfig)}
   */
  @Test
  @DisplayName("Test sessionService(SessionApi, AuthSession, BdkConfig); when AuthSession; then calls getRetry()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"SessionService BdkServiceConfig.sessionService(SessionApi, AuthSession, BdkConfig)"})
  void testSessionService_whenAuthSession_thenCallsGetRetry() {
    // Arrange
  ...
  /**
   * Test {@link BdkServiceConfig#streamService(StreamsApi, RoomMembershipApi, ShareApi, AuthSession, BdkConfig)}.
   * <ul>
   *   <li>When {@link AuthSession}.</li>
   *   <li>Then calls {@link BdkConfig#getRetry()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#streamService(StreamsApi, RoomMembershipApi, ShareApi, AuthSession, BdkConfig)}
   */
  @Test
  @DisplayName("Test streamService(StreamsApi, RoomMembershipApi, ShareApi, AuthSession, BdkConfig); when AuthSession; then calls getRetry()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testStreamService_whenAuthSession_thenCallsGetRetry() {
    // Arrange
    BdkServiceConfig bdkServiceConfig = new BdkServiceConfig();
   ...
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#disclaimerService(DisclaimerApi, AuthSession, BdkConfig)}
   */
  @Test
  @DisplayName("Test disclaimerService(DisclaimerApi, AuthSession, BdkConfig); when AuthSession; then calls getRetry()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testDisclaimerService_whenAuthSession_thenCallsGetRetry() {
    // Arrange
    BdkServiceConfig bdkServiceConfig = new BdkServiceConfig();
   ...
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#presenceService(PresenceApi, AuthSession, BdkConfig)}
   */
  @Test
  @DisplayName("Test presenceService(PresenceApi, AuthSession, BdkConfig); when AuthSession; then calls getRetry()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testPresenceService_whenAuthSession_thenCallsGetRetry() {
    // Arrange
    BdkServiceConfig bdkServiceConfig = new BdkServiceConfig();
   ...
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#connectionService(ConnectionApi, AuthSession, BdkConfig)}
   */
  @Test
  @DisplayName("Test connectionService(ConnectionApi, AuthSession, BdkConfig); when AuthSession; then calls getRetry()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testConnectionService_whenAuthSession_thenCallsGetRetry() {
    // Arrange
    BdkServiceConfig bdkServiceConfig = new BdkServiceConfig();
  ...
  /**
   * Test {@link BdkServiceConfig#applicationService(ApplicationApi, AppEntitlementApi, AuthSession, BdkConfig)}.
   * <p>
   * Method under test: {@link BdkServiceConfig#applicationService(ApplicationApi, AppEntitlementApi, AuthSession, BdkConfig)}
   */
  @Test
  ...
  /**
   * Test {@link BdkServiceConfig#messageService(MessagesApi, MessageApi, MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, AuthSession, TemplateEngine, BdkConfig)}.
   * <ul>
   *   <li>When {@link AuthSession}.</li>
   *   <li>Then return templates is {@link TemplateEngine}.</li>
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#messageService(MessagesApi, MessageApi, MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, AuthSession, TemplateEngine, BdkConfig)}
   */
  @Test
  @DisplayName("Test messageService(MessagesApi, MessageApi, MessageSuppressionApi, StreamsApi, PodApi, AttachmentsApi, DefaultApi, AuthSession, TemplateEngine, BdkConfig); when AuthSession; then return templates is TemplateEngine")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testMessageService_whenAuthSession_thenReturnTemplatesIsTemplateEngine() {
    // Arrange
    BdkServiceConfig bdkServiceConfig = new BdkServiceConfig();
    ...
    // Act
    MessageService actualMessageServiceResult = bdkServiceConfig.messageService(messagesApi, messageApi,
        messageSuppressionApi, streamsApi, podApi, attachmentsApi, defaultApi, botSession, templateEngine, config);
   ...
   * <ul>
   *   <li>Given {@link UserV2} (default constructor).</li>
   *   <li>Then return BotInfo is {@link UserV2} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link BdkServiceConfig#botInfoService(SessionService)}
   */
  @Test
  @DisplayName("Test botInfoService(SessionService); given UserV2 (default constructor); then return BotInfo is UserV2 (default constructor)")
  @Tag("MaintainedByDiffblue")
