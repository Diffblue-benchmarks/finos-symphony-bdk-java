...
class BdkCommonFeedConfigDiffblueTest {
   ...
   * <p>
   * Method under test: {@link BdkCommonFeedConfig#simpleApplicationEventMulticaster()}
   */
  @Test
  ...
  void testSimpleApplicationEventMulticaster() {
    ...
    assertTrue(
        (new BdkCommonFeedConfig()).simpleApplicationEventMulticaster() instanceof SimpleApplicationEventMulticaster);
  }
}
