...
class BdkRetryConfigDiffblueTest {
   ...
   * <p>
   * Method under test: {@link BdkRetryConfig#retryWithRecoveryBuilder(BdkConfig)}
   */
  @Test
  @DisplayName("Test retryWithRecoveryBuilder(BdkConfig)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "com.symphony.bdk.core.retry.RetryWithRecoveryBuilder BdkRetryConfig.retryWithRecoveryBuilder(BdkConfig)"})
  void testRetryWithRecoveryBuilder() throws UnsupportedEncodingException {
    ...
    // Act and Assert
    assertTrue(bdkRetryConfig.retryWithRecoveryBuilder(config).build() instanceof Resilience4jRetryWithRecovery);
  }
}
