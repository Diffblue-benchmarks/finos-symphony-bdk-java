...
class CircleOfTrustControllerDiffblueTest {
  ...
  void testValidateTokens() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder =
        contentTypeResult.content(
            objectMapper.writeValueAsString(new TokenPair("ABC123", "ABC123")));
  ...
  void testValidateJwt_thenStatusFourHundred() throws Exception {
    ...
    ObjectMapper objectMapper = new ObjectMapper();
    MockHttpServletRequestBuilder requestBuilder =
        contentTypeResult.content(objectMapper.writeValueAsString(new JwtInfo("")));
    ...
    MockMvcBuilders.standaloneSetup(circleOfTrustController)
        ...
        .andExpect(
            MockMvcResultMatchers.content()
                .string("{\"code\":\"MISSING_FIELDS\",\"message\":[\"Jwt is mandatory\"]}"));
  }
  ...
  void testValidateJwt_thenStatusIsOk() throws Exception {
    ...
    ObjectMapper objectMapper = new ObjectMapper();
    MockHttpServletRequestBuilder requestBuilder =
        contentTypeResult.content(objectMapper.writeValueAsString(new JwtInfo("Jwt")));
