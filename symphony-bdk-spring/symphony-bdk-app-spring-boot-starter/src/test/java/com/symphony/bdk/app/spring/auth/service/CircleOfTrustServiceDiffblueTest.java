...
class CircleOfTrustServiceDiffblueTest {
   ...
   * <p>
   * Method under test: {@link CircleOfTrustService#validateTokens(TokenPair)}
   */
  @Test
  ...
  void testValidateTokens() {
    ...
    // Act and Assert
    assertThrows(BdkAppException.class, () -> circleOfTrustService.validateTokens(new TokenPair("ABC123", "ABC123")));
    verify(extensionAppAuthenticator).validateTokens(eq("ABC123"), eq("ABC123"));
  }

  /**
   * Test {@link CircleOfTrustService#validateTokens(TokenPair)}.
   * <ul>
   *   <li>Given {@link ExtensionAppAuthenticator} {@link ExtensionAppAuthenticator#validateTokens(String, String)} return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CircleOfTrustService#validateTokens(TokenPair)}
   */
  @Test
  @DisplayName("Test validateTokens(TokenPair); given ExtensionAppAuthenticator validateTokens(String, String) return 'false'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CircleOfTrustService.validateTokens(TokenPair)"})
  void testValidateTokens_givenExtensionAppAuthenticatorValidateTokensReturnFalse() {
    // Arrange
    when(extensionAppAuthenticator.validateTokens(Mockito.<String>any(), Mockito.<String>any())).thenReturn(false);
   ...
   * Test {@link CircleOfTrustService#validateTokens(TokenPair)}.
   * <ul>
   *   <li>Given {@link ExtensionAppAuthenticator} {@link ExtensionAppAuthenticator#validateTokens(String, String)} return {@code true}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CircleOfTrustService#validateTokens(TokenPair)}
   */
  @Test
  @DisplayName("Test validateTokens(TokenPair); given ExtensionAppAuthenticator validateTokens(String, String) return 'true'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CircleOfTrustService.validateTokens(TokenPair)"})
  void testValidateTokens_givenExtensionAppAuthenticatorValidateTokensReturnTrue() {
    // Arrange
    when(extensionAppAuthenticator.validateTokens(Mockito.<String>any(), Mockito.<String>any())).thenReturn(true);
   ...
   * <p>
   * Method under test: {@link CircleOfTrustService#validateJwt(String)}
   */
  @Test
