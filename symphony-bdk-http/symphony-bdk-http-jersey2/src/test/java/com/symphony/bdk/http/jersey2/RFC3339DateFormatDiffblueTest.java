...
class RFC3339DateFormatDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test format(Date, StringBuffer, FieldPosition) with 'Date', 'StringBuffer', 'FieldPosition'")
  ...
  void testFormatWithDateStringBufferFieldPosition() {
    ...
    StringBuffer toAppendTo = new StringBuffer("Str");
    ...
    // Assert
    assertEquals("Str1970-01-01T00:00:00.000Z", toAppendTo.toString());
