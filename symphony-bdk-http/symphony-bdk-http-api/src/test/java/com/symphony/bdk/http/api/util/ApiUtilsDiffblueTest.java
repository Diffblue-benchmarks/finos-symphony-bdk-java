...
class ApiUtilsDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ApiUtils#isCollectionOfApiClientBodyPart(Object)}
   */
  @Test
  @DisplayName("Test isCollectionOfApiClientBodyPart(Object); given '42'; when LinkedList() add '42'")
  @Tag("MaintainedByDiffblue")
