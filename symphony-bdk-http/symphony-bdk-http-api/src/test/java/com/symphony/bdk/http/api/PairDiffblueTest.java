...
class PairDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test new Pair(String, String); when 'null'; then return Name is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Pair.<init>(String, String)"})
  void testNewPair_whenNull_thenReturnNameIsEmptyString() {
    // Arrange and Act
    Pair actualPair = new Pair("", null);
  ...
  void testPair_whenEmptyString_thenReturnNameIsEmptyString() {
    // Arrange and Act
    Pair actualPairResult = Pair.pair("", "");
   ...
   */
  @Test
  @DisplayName("Test pair(String, String); when 'null'; then return Name is empty string")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Pair Pair.pair(String, String)"})
  void testPair_whenNull_thenReturnNameIsEmptyString() {
    // Arrange and Act
    Pair actualPairResult = Pair.pair("", null);
