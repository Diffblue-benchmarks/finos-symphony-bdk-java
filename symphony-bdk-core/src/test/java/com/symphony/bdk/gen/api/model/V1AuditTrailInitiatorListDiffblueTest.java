...
class V1AuditTrailInitiatorListDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V1AuditTrailInitiatorList} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link
   * V1AuditTrailInitiatorList#addItemsItem(V1AuditTrailInitiatorResponse)}
   */
  @Test
  @DisplayName(
      "Test addItemsItem(V1AuditTrailInitiatorResponse); given V1AuditTrailInitiatorList (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V1AuditTrailInitiatorList V1AuditTrailInitiatorList.addItemsItem(V1AuditTrailInitiatorResponse)"
  })
  void testAddItemsItem_givenV1AuditTrailInitiatorList() {
    ...
    // Act
    V1AuditTrailInitiatorList actualAddItemsItemResult =
        v1AuditTrailInitiatorList.addItemsItem(new V1AuditTrailInitiatorResponse());

    // Assert
    assertSame(v1AuditTrailInitiatorList, actualAddItemsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V1AuditTrailInitiatorList} (default constructor) items {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link
  ...
  @Test
  @DisplayName(
      "Test addItemsItem(V1AuditTrailInitiatorResponse); given V1AuditTrailInitiatorList (default constructor) items ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V1AuditTrailInitiatorList V1AuditTrailInitiatorList.addItemsItem(V1AuditTrailInitiatorResponse)"
  ...
  /**
   * Test {@link V1AuditTrailInitiatorList#equals(Object)}, and {@link
   * V1AuditTrailInitiatorList#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1AuditTrailInitiatorList.equals(Object)",
    "int V1AuditTrailInitiatorList.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1AuditTrailInitiatorList.hashCode(), v1AuditTrailInitiatorList2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1AuditTrailInitiatorList#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1AuditTrailInitiatorList.<init>()",
    "List V1AuditTrailInitiatorList.getItems()",
    ...
    "void V1AuditTrailInitiatorList.setItems(List)",
    "void V1AuditTrailInitiatorList.setPagination(Pagination)",
  ...
  void testGettersAndSetters() {
    ...
    V1AuditTrailInitiatorList actualItemsResult =
        actualV1AuditTrailInitiatorList.items(new ArrayList<>());
    V1AuditTrailInitiatorList actualPaginationResult =
        actualV1AuditTrailInitiatorList.pagination(new Pagination());
