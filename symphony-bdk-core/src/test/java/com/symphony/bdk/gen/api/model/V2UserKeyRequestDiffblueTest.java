...
class V2UserKeyRequestDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2UserKeyRequest.hashCode(), v2UserKeyRequest2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2UserKeyRequest#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2UserKeyRequest.<init>()",
    "V2UserKeyRequest V2UserKeyRequest.action(String)",
    "V2UserKeyRequest V2UserKeyRequest.expirationDate(Long)",
    "String V2UserKeyRequest.getAction()",
    "Long V2UserKeyRequest.getExpirationDate()",
    "String V2UserKeyRequest.getKey()",
    "V2UserKeyRequest V2UserKeyRequest.key(String)",
    "void V2UserKeyRequest.setAction(String)",
    "void V2UserKeyRequest.setExpirationDate(Long)",
    "void V2UserKeyRequest.setKey(String)",
