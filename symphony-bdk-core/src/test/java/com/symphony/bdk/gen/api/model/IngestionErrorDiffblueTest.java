...
class IngestionErrorDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link IngestionError#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void IngestionError.<init>()", "IngestionError IngestionError.code(Integer)",
      "Integer IngestionError.getCode()", "String IngestionError.getIngestionStatus()",
      "String IngestionError.getMessage()", "IngestionError IngestionError.ingestionStatus(String)",
      "IngestionError IngestionError.message(String)", "void IngestionError.setCode(Integer)",
      "void IngestionError.setIngestionStatus(String)", "void IngestionError.setMessage(String)",
  ...
  void testGettersAndSetters() {
    ...
    IngestionError actualIngestionStatusResult = actualIngestionError.ingestionStatus("Ingestion Status");
    IngestionError actualMessageResult = actualIngestionError.message("Not all who wander are lost");
    ...
    assertEquals("class IngestionError {\n" + "    code: 1\n" + "    message: Not all who wander are lost\n"
