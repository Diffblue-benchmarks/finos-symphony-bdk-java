...
class MessageIdsFromStreamDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MessageIdsFromStream} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageIdsFromStream#addDataItem(String)}
   */
  @Test
  ...
  void testAddDataItem_givenMessageIdsFromStream() {
    ...
    // Act and Assert
    assertSame(messageIdsFromStream, messageIdsFromStream.addDataItem("Data Item"));
  }

  /**
   * Test {@link MessageIdsFromStream#addDataItem(String)}.
   * <ul>
   *   <li>Given {@link MessageIdsFromStream} (default constructor) data {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageIdsFromStream#addDataItem(String)}
   */
  @Test
  @DisplayName("Test addDataItem(String); given MessageIdsFromStream (default constructor) data ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageIdsFromStream MessageIdsFromStream.addDataItem(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean MessageIdsFromStream.equals(Object)", "int MessageIdsFromStream.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageIdsFromStream2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageIdsFromStream#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageIdsFromStream.<init>()", "MessageIdsFromStream MessageIdsFromStream.data(List)",
      "List MessageIdsFromStream.getData()", "Long MessageIdsFromStream.getNextStartNumber()",
      "Long MessageIdsFromStream.getNumberReturned()", "Long MessageIdsFromStream.getTotalNumberFound()",
      "MessageIdsFromStream MessageIdsFromStream.nextStartNumber(Long)",
      "MessageIdsFromStream MessageIdsFromStream.numberReturned(Long)", "void MessageIdsFromStream.setData(List)",
      "void MessageIdsFromStream.setNextStartNumber(Long)", "void MessageIdsFromStream.setNumberReturned(Long)",
      "void MessageIdsFromStream.setTotalNumberFound(Long)", "String MessageIdsFromStream.toString()",
  ...
  void testGettersAndSetters() {
    ...
    MessageIdsFromStream actualNextStartNumberResult = actualMessageIdsFromStream.nextStartNumber(1L);
    ...
    MessageIdsFromStream actualTotalNumberFoundResult = actualMessageIdsFromStream.totalNumberFound(1L);
    ...
    // Assert
    assertEquals("class MessageIdsFromStream {\n" + "    data: []\n" + "    totalNumberFound: 1\n"
