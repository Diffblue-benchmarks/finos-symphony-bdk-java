...
class UserGroupDataDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupData#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupData.<init>()", "UserGroupData UserGroupData.active(Boolean)",
      "UserGroupData UserGroupData.area(String)", "Boolean UserGroupData.getActive()", "String UserGroupData.getArea()",
      "String UserGroupData.getId()", "String UserGroupData.getName()", "String UserGroupData.getType()",
      "UserGroupData UserGroupData.id(String)", "UserGroupData UserGroupData.name(String)",
      "void UserGroupData.setActive(Boolean)", "void UserGroupData.setArea(String)", "void UserGroupData.setId(String)",
      "void UserGroupData.setName(String)", "void UserGroupData.setType(String)", "String UserGroupData.toString()",
