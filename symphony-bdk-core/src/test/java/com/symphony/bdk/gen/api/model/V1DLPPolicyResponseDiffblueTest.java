...
class V1DLPPolicyResponseDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPPolicyResponse.equals(Object)",
    "int V1DLPPolicyResponse.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpPolicyResponse.hashCode(), v1dlpPolicyResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPPolicyResponse#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPPolicyResponse.<init>()",
    "V1DLPPolicyResponse V1DLPPolicyResponse.data(V1DLPPolicy)",
    "V1DLPPolicy V1DLPPolicyResponse.getData()",
    "void V1DLPPolicyResponse.setData(V1DLPPolicy)",
