...
class JwtTokenDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, jwtToken2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link JwtToken#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void JwtToken.<init>()", "JwtToken JwtToken.accessToken(String)",
      "JwtToken JwtToken.expiresIn(Long)", "String JwtToken.getAccessToken()", "Long JwtToken.getExpiresIn()",
      "String JwtToken.getTokenType()", "void JwtToken.setAccessToken(String)", "void JwtToken.setExpiresIn(Long)",
      "void JwtToken.setTokenType(String)", "String JwtToken.toString()", "JwtToken JwtToken.tokenType(String)"})
