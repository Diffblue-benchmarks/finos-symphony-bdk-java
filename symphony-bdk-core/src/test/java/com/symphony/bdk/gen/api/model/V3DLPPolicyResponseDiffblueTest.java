...
class V3DLPPolicyResponseDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V3DLPPolicyResponse.equals(Object)",
    "int V3DLPPolicyResponse.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v3dlpPolicyResponse.hashCode(), v3dlpPolicyResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V3DLPPolicyResponse#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V3DLPPolicyResponse.<init>()",
    "V3DLPPolicyResponse V3DLPPolicyResponse.data(V3DLPPolicy)",
    "V3DLPPolicy V3DLPPolicyResponse.getData()",
    "void V3DLPPolicyResponse.setData(V3DLPPolicy)",
