...
class V3DLPPolicyAppliesToDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPPolicyAppliesTo#addRulesItem(V3DLPRule)}
   */
  @Test
  ...
  void testAddRulesItem() {
    ...
    // Act and Assert
    assertSame(v3dlpPolicyAppliesTo, v3dlpPolicyAppliesTo.addRulesItem(new V3DLPRule()));
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPPolicyAppliesTo.equals(Object)", "int V3DLPPolicyAppliesTo.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpPolicyAppliesTo2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPPolicyAppliesTo#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPPolicyAppliesTo.<init>()", "V3DLPPolicyAppliesTo V3DLPPolicyAppliesTo.action(String)",
      "V3DLPPolicyAppliesTo V3DLPPolicyAppliesTo.dataType(String)", "String V3DLPPolicyAppliesTo.getAction()",
      "String V3DLPPolicyAppliesTo.getDataType()", "List V3DLPPolicyAppliesTo.getRules()",
      "V3DLPPolicyAppliesTo V3DLPPolicyAppliesTo.rules(List)", "void V3DLPPolicyAppliesTo.setAction(String)",
      "void V3DLPPolicyAppliesTo.setDataType(String)", "void V3DLPPolicyAppliesTo.setRules(List)",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class V3DLPPolicyAppliesTo {\n    dataType: Data Type\n    action: Action\n    rules: []\n}",
