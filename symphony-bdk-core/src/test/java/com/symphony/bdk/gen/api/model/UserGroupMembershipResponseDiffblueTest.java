...
class UserGroupMembershipResponseDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserGroupMembershipResponse} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupMembershipResponse#addDataItem(UserGroupMembershipResponseData)}
   */
  @Test
  @DisplayName("Test addDataItem(UserGroupMembershipResponseData); given UserGroupMembershipResponse (default constructor)")
  ...
  void testAddDataItem_givenUserGroupMembershipResponse() {
    ...
    // Act and Assert
    assertSame(userGroupMembershipResponse,
   ...
   * Test {@link UserGroupMembershipResponse#addDataItem(UserGroupMembershipResponseData)}.
   * <ul>
   *   <li>Given {@link UserGroupMembershipResponse} (default constructor) data {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupMembershipResponse#addDataItem(UserGroupMembershipResponseData)}
   */
  @Test
  @DisplayName("Test addDataItem(UserGroupMembershipResponseData); given UserGroupMembershipResponse (default constructor) data ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "UserGroupMembershipResponse UserGroupMembershipResponse.addDataItem(UserGroupMembershipResponseData)"})
  ...
  /**
   * Test {@link UserGroupMembershipResponse#equals(Object)}, and {@link UserGroupMembershipResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean UserGroupMembershipResponse.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, userGroupMembershipResponse2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupMembershipResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new UserGroupMembershipResponse(), "Different type to UserGroupMembershipResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupMembershipResponse.<init>()",
      "UserGroupMembershipResponse UserGroupMembershipResponse.data(List)",
      "List UserGroupMembershipResponse.getData()", "Pagination UserGroupMembershipResponse.getPagination()",
      "UserGroupMembershipResponse UserGroupMembershipResponse.pagination(Pagination)",
      "void UserGroupMembershipResponse.setData(List)", "void UserGroupMembershipResponse.setPagination(Pagination)",
      "String UserGroupMembershipResponse.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    UserGroupMembershipResponse actualUserGroupMembershipResponse = new UserGroupMembershipResponse();
    UserGroupMembershipResponse actualDataResult = actualUserGroupMembershipResponse.data(new ArrayList<>());
    UserGroupMembershipResponse actualPaginationResult = actualUserGroupMembershipResponse.pagination(new Pagination());
