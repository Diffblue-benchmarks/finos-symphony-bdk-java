...
class V2AdminStreamInfoDiffblueTest {
  ...
  @MethodsUnderTest({"void V2AdminStreamInfo.<init>()",
      ...
      "V2AdminStreamAttributes V2AdminStreamInfo.getAttributes()", "Boolean V2AdminStreamInfo.getCrossPod()",
      "String V2AdminStreamInfo.getId()", "Boolean V2AdminStreamInfo.getIsActive()",
      "Boolean V2AdminStreamInfo.getIsExternal()", "Boolean V2AdminStreamInfo.getIsPublic()",
      "String V2AdminStreamInfo.getOrigin()", "String V2AdminStreamInfo.getType()",
      ...
      "V2AdminStreamInfo V2AdminStreamInfo.isPublic(Boolean)", "V2AdminStreamInfo V2AdminStreamInfo.origin(String)",
      "void V2AdminStreamInfo.setAttributes(V2AdminStreamAttributes)", "void V2AdminStreamInfo.setCrossPod(Boolean)",
      "void V2AdminStreamInfo.setId(String)", "void V2AdminStreamInfo.setIsActive(Boolean)",
      "void V2AdminStreamInfo.setIsExternal(Boolean)", "void V2AdminStreamInfo.setIsPublic(Boolean)",
      "void V2AdminStreamInfo.setOrigin(String)", "void V2AdminStreamInfo.setType(String)",
