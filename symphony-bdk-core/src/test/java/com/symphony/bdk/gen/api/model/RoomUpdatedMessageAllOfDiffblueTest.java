...
class RoomUpdatedMessageAllOfDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link RoomUpdatedMessageAllOf} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link RoomUpdatedMessageAllOf#addKeywordsItem(RoomTag)}
   */
  @Test
  ...
  void testAddKeywordsItem_givenRoomUpdatedMessageAllOf() {
    ...
    // Act
    RoomUpdatedMessageAllOf actualAddKeywordsItemResult =
        roomUpdatedMessageAllOf.addKeywordsItem(new RoomTag());

    // Assert
    assertSame(roomUpdatedMessageAllOf, actualAddKeywordsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link RoomUpdatedMessageAllOf} (default constructor) keywords {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link RoomUpdatedMessageAllOf#addKeywordsItem(RoomTag)}
  ...
  @Test
  @DisplayName(
      "Test addKeywordsItem(RoomTag); given RoomUpdatedMessageAllOf (default constructor) keywords ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"RoomUpdatedMessageAllOf RoomUpdatedMessageAllOf.addKeywordsItem(RoomTag)"})
  ...
  /**
   * Test {@link RoomUpdatedMessageAllOf#equals(Object)}, and {@link
   * RoomUpdatedMessageAllOf#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean RoomUpdatedMessageAllOf.equals(Object)",
    "int RoomUpdatedMessageAllOf.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(roomUpdatedMessageAllOf.hashCode(), roomUpdatedMessageAllOf2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link RoomUpdatedMessageAllOf#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void RoomUpdatedMessageAllOf.<init>()",
    ...
    "Boolean RoomUpdatedMessageAllOf.getCopyProtected()",
    "Boolean RoomUpdatedMessageAllOf.getDiscoverable()",
    "List RoomUpdatedMessageAllOf.getKeywords()",
    "Boolean RoomUpdatedMessageAllOf.getMembersCanInvite()",
    "String RoomUpdatedMessageAllOf.getNewDescription()",
    "String RoomUpdatedMessageAllOf.getNewName()",
    "String RoomUpdatedMessageAllOf.getOldDescription()",
    "String RoomUpdatedMessageAllOf.getOldName()",
    "Boolean RoomUpdatedMessageAllOf.getReadOnly()",
    "RoomUpdatedMessageAllOf RoomUpdatedMessageAllOf.keywords(List)",
    ...
    "void RoomUpdatedMessageAllOf.setCopyProtected(Boolean)",
    "void RoomUpdatedMessageAllOf.setDiscoverable(Boolean)",
    "void RoomUpdatedMessageAllOf.setKeywords(List)",
    "void RoomUpdatedMessageAllOf.setMembersCanInvite(Boolean)",
    "void RoomUpdatedMessageAllOf.setNewDescription(String)",
    "void RoomUpdatedMessageAllOf.setNewName(String)",
    "void RoomUpdatedMessageAllOf.setOldDescription(String)",
    "void RoomUpdatedMessageAllOf.setOldName(String)",
    "void RoomUpdatedMessageAllOf.setReadOnly(Boolean)",
    "String RoomUpdatedMessageAllOf.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    RoomUpdatedMessageAllOf actualRoomUpdatedMessageAllOf = new RoomUpdatedMessageAllOf();
    RoomUpdatedMessageAllOf actualCopyProtectedResult =
        actualRoomUpdatedMessageAllOf.copyProtected(true);
    RoomUpdatedMessageAllOf actualDiscoverableResult =
        actualRoomUpdatedMessageAllOf.discoverable(true);
    RoomUpdatedMessageAllOf actualKeywordsResult =
        actualRoomUpdatedMessageAllOf.keywords(new ArrayList<>());
    RoomUpdatedMessageAllOf actualMembersCanInviteResult =
        actualRoomUpdatedMessageAllOf.membersCanInvite(true);
    RoomUpdatedMessageAllOf actualNewDescriptionResult =
        actualRoomUpdatedMessageAllOf.newDescription("New Description");
    RoomUpdatedMessageAllOf actualNewNameResult = actualRoomUpdatedMessageAllOf.newName("New Name");
    RoomUpdatedMessageAllOf actualOldDescriptionResult =
        actualRoomUpdatedMessageAllOf.oldDescription("Old Description");
