...
class V5DatafeedCreateBodyDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V5DatafeedCreateBody.equals(Object)", "int V5DatafeedCreateBody.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v5DatafeedCreateBody2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V5DatafeedCreateBody#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V5DatafeedCreateBody.<init>()", "String V5DatafeedCreateBody.getTag()",
      "void V5DatafeedCreateBody.setTag(String)", "V5DatafeedCreateBody V5DatafeedCreateBody.tag(String)",
