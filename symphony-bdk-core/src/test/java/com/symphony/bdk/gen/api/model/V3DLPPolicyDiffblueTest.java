...
class V3DLPPolicyDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V3DLPPolicy} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V3DLPPolicy#addScopesItem(String)}
   */
  @Test
  ...
  void testAddScopesItem_givenV3DLPPolicy() {
    ...
    // Act and Assert
    assertSame(v3dlpPolicy, v3dlpPolicy.addScopesItem("Scopes Item"));
  }

  /**
   * Test {@link V3DLPPolicy#addScopesItem(String)}.
   * <ul>
   *   <li>Given {@link V3DLPPolicy} (default constructor) scopes {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V3DLPPolicy#addScopesItem(String)}
   */
  @Test
  @DisplayName("Test addScopesItem(String); given V3DLPPolicy (default constructor) scopes ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3DLPPolicy V3DLPPolicy.addScopesItem(String)"})
   ...
   * <p>
   * Method under test: {@link V3DLPPolicy#addAppliesToItem(V3DLPPolicyAppliesTo)}
   */
  @Test
  ...
  void testAddAppliesToItem() {
    ...
    // Act and Assert
    assertSame(v3dlpPolicy, v3dlpPolicy.addAppliesToItem(new V3DLPPolicyAppliesTo()));
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpPolicy2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPPolicy#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPPolicy.<init>()", "V3DLPPolicy V3DLPPolicy.active(Boolean)",
      "V3DLPPolicy V3DLPPolicy.appliesTo(List)", "V3DLPPolicy V3DLPPolicy.creationDate(Long)",
      "V3DLPPolicy V3DLPPolicy.creatorId(Long)", "V3DLPPolicy V3DLPPolicy.deleted(Boolean)",
      "Boolean V3DLPPolicy.getActive()", "List V3DLPPolicy.getAppliesTo()", "Long V3DLPPolicy.getCreationDate()",
      "Long V3DLPPolicy.getCreatorId()", "Boolean V3DLPPolicy.getDeleted()", "String V3DLPPolicy.getId()",
      "Long V3DLPPolicy.getLastDisabledDate()", "Long V3DLPPolicy.getLastUpdatedDate()", "String V3DLPPolicy.getName()",
      "String V3DLPPolicy.getPolicyId()", "List V3DLPPolicy.getScopes()", "Boolean V3DLPPolicy.getSystemPolicy()",
      "String V3DLPPolicy.getVersion()", "V3DLPPolicy V3DLPPolicy.id(String)",
      "V3DLPPolicy V3DLPPolicy.lastDisabledDate(Long)", "V3DLPPolicy V3DLPPolicy.lastUpdatedDate(Long)",
      "V3DLPPolicy V3DLPPolicy.name(String)", "V3DLPPolicy V3DLPPolicy.policyId(String)",
      "V3DLPPolicy V3DLPPolicy.scopes(List)", "void V3DLPPolicy.setActive(Boolean)",
      "void V3DLPPolicy.setAppliesTo(List)", "void V3DLPPolicy.setCreationDate(Long)",
      "void V3DLPPolicy.setCreatorId(Long)", "void V3DLPPolicy.setDeleted(Boolean)", "void V3DLPPolicy.setId(String)",
      "void V3DLPPolicy.setLastDisabledDate(Long)", "void V3DLPPolicy.setLastUpdatedDate(Long)",
      "void V3DLPPolicy.setName(String)", "void V3DLPPolicy.setPolicyId(String)", "void V3DLPPolicy.setScopes(List)",
      "void V3DLPPolicy.setSystemPolicy(Boolean)", "void V3DLPPolicy.setVersion(String)",
      "V3DLPPolicy V3DLPPolicy.systemPolicy(Boolean)", "String V3DLPPolicy.toString()",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class V3DLPPolicy {\n" + "    id: 42\n" + "    policyId: 42\n" + "    version: 1.0.2\n"
        + "    name: Name\n" + "    creatorId: 1\n" + "    scopes: []\n" + "    appliesTo: []\n" + "    active: true\n"
        + "    deleted: true\n" + "    creationDate: 1\n" + "    lastUpdatedDate: 1\n" + "    lastDisabledDate: 1\n"
