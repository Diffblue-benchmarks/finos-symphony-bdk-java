...
class V3DLPViolationStreamResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPViolationStreamResponse#addViolationsItem(V3DLPViolationStream)}
   */
  @Test
  ...
  void testAddViolationsItem() {
    ...
    // Act and Assert
    assertSame(v3dlpViolationStreamResponse,
        v3dlpViolationStreamResponse.addViolationsItem(new V3DLPViolationStream()));
  }

  /**
   * Test {@link V3DLPViolationStreamResponse#equals(Object)}, and {@link V3DLPViolationStreamResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPViolationStreamResponse.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPViolationStreamResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V3DLPViolationStreamResponse(), "Different type to V3DLPViolationStreamResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPViolationStreamResponse.<init>()",
      "String V3DLPViolationStreamResponse.getNextOffset()", "List V3DLPViolationStreamResponse.getViolations()",
      ...
      "void V3DLPViolationStreamResponse.setViolations(List)", "String V3DLPViolationStreamResponse.toString()",
      "V3DLPViolationStreamResponse V3DLPViolationStreamResponse.violations(List)"})
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPViolationStreamResponse actualV3dlpViolationStreamResponse = new V3DLPViolationStreamResponse();
    V3DLPViolationStreamResponse actualNextOffsetResult = actualV3dlpViolationStreamResponse.nextOffset("Next Offset");
    ...
    V3DLPViolationStreamResponse actualViolationsResult = actualV3dlpViolationStreamResponse.violations(violations);
    ...
    List<V3DLPViolationStream> actualViolations = actualV3dlpViolationStreamResponse.getViolations();

    // Assert
    assertEquals("Next Offset", actualNextOffset);
    assertEquals("class V3DLPViolationStreamResponse {\n    violations: []\n    nextOffset: Next Offset\n}",
