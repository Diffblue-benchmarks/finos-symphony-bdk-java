...
class V3DLPViolationStreamResponseDiffblueTest {
  ...
  void testAddViolationsItem() {
    ...
    // Act
    V3DLPViolationStreamResponse actualAddViolationsItemResult =
        v3dlpViolationStreamResponse.addViolationsItem(new V3DLPViolationStream());

    // Assert
    assertSame(v3dlpViolationStreamResponse, actualAddViolationsItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v3dlpViolationStreamResponse.hashCode(), v3dlpViolationStreamResponse2.hashCode());
  }
