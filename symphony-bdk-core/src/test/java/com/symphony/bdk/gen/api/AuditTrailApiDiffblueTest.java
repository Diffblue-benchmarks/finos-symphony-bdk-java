...
class AuditTrailApiDiffblueTest {
  /**
   * Test {@link AuditTrailApi#v1AudittrailPrivilegeduserGet(String, String, Long, Long, String,
   ...
   * </ul>
   *
   * <p>Method under test: {@link AuditTrailApi#v1AudittrailPrivilegeduserGet(String, String, Long,
   * Long, String, String, Integer, Long, String)}
   */
  @Test
  @DisplayName(
      "Test v1AudittrailPrivilegeduserGet(String, String, Long, Long, String, String, Integer, Long, String); then throw ApiException")
  ...
  void testV1AudittrailPrivilegeduserGet_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () ->
            new AuditTrailApi(apiClient)
                .v1AudittrailPrivilegeduserGet(
                    null, "ABC123", 1L, 1L, "Before", "After", 1, 1L, "Role"));
  }
  ...
  void testV1AudittrailPrivilegeduserGet_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(
        ...
        () ->
            new AuditTrailApi(apiClient)
                .v1AudittrailPrivilegeduserGet(
                    "ABC123", null, null, 1L, "Before", "After", 1, 1L, "Role"));
  }

  /**
   * Test {@link AuditTrailApi#v1AudittrailPrivilegeduserGetWithHttpInfo(String, String, Long, Long,
   * String, String, Integer, Long, String)}.
   *
   * <ul>
   *   <li>Then throw {@link ApiException}.
   * </ul>
   *
   * <p>Method under test: {@link AuditTrailApi#v1AudittrailPrivilegeduserGetWithHttpInfo(String,
   * String, Long, Long, String, String, Integer, Long, String)}
   */
  @Test
  @DisplayName(
      "Test v1AudittrailPrivilegeduserGetWithHttpInfo(String, String, Long, Long, String, String, Integer, Long, String); then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
