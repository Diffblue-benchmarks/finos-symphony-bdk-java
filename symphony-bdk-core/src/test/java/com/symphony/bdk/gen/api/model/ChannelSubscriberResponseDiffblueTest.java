...
class ChannelSubscriberResponseDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test addDataItem(ChannelSubscriber); given ChannelSubscriberResponse (default constructor)")
   ...
   */
  @Test
  @DisplayName("Test addDataItem(ChannelSubscriber); given ChannelSubscriberResponse (default constructor) data ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"ChannelSubscriberResponse ChannelSubscriberResponse.addDataItem(ChannelSubscriber)"})
