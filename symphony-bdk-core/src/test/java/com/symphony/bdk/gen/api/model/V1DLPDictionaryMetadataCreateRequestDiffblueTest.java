...
class V1DLPDictionaryMetadataCreateRequestDiffblueTest {
  /**
   * Test {@link V1DLPDictionaryMetadataCreateRequest#equals(Object)}, and {@link
   * V1DLPDictionaryMetadataCreateRequest#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPDictionaryMetadataCreateRequest.equals(Object)",
    "int V1DLPDictionaryMetadataCreateRequest.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1DLPDictionaryMetadataCreateRequest v1dlpDictionaryMetadataCreateRequest =
        new V1DLPDictionaryMetadataCreateRequest();
    V1DLPDictionaryMetadataCreateRequest v1dlpDictionaryMetadataCreateRequest2 =
        new V1DLPDictionaryMetadataCreateRequest();
    ...
    assertEquals(
        v1dlpDictionaryMetadataCreateRequest.hashCode(),
        v1dlpDictionaryMetadataCreateRequest2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPDictionaryMetadataCreateRequest#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(
        v1dlpDictionaryMetadataCreateRequest, new V1DLPDictionaryMetadataCreateRequest());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPDictionaryMetadataCreateRequest.<init>()",
    "String V1DLPDictionaryMetadataCreateRequest.getName()",
    "String V1DLPDictionaryMetadataCreateRequest.getType()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPDictionaryMetadataCreateRequest actualV1dlpDictionaryMetadataCreateRequest =
        new V1DLPDictionaryMetadataCreateRequest();
    V1DLPDictionaryMetadataCreateRequest actualNameResult =
        actualV1dlpDictionaryMetadataCreateRequest.name("Name");
    actualV1dlpDictionaryMetadataCreateRequest.setName("Name");
    actualV1dlpDictionaryMetadataCreateRequest.setType("Type");
    V1DLPDictionaryMetadataCreateRequest actualTypeResult =
        actualV1dlpDictionaryMetadataCreateRequest.type("Type");
