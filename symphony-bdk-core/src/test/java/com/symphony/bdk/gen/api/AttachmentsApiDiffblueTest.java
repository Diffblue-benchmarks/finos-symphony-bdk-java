...
class AttachmentsApiDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link AttachmentsApi#v1StreamSidAttachmentCreatePost(String, String,
   * String, File)}
   */
  @Test
  @DisplayName(
      "Test v1StreamSidAttachmentCreatePost(String, String, String, File); then throw ApiException")
  ...
  void testV1StreamSidAttachmentCreatePost_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () ->
            attachmentsApi.v1StreamSidAttachmentCreatePost(
                null,
                "ABC123",
                "ABC123",
  ...
  @Test
  @DisplayName(
      "Test v1StreamSidAttachmentCreatePost(String, String, String, File); when 'Sid'; then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.gen.api.model.AttachmentInfo AttachmentsApi.v1StreamSidAttachmentCreatePost(String, String, String, File)"
  ...
  /**
   * Test {@link AttachmentsApi#v1StreamSidAttachmentCreatePostWithHttpInfo(String, String, String,
   * File)}.
   *
   * <ul>
   *   <li>Then throw {@link ApiException}.
   * </ul>
   *
   * <p>Method under test: {@link AttachmentsApi#v1StreamSidAttachmentCreatePostWithHttpInfo(String,
   * String, String, File)}
   */
  @Test
  @DisplayName(
      "Test v1StreamSidAttachmentCreatePostWithHttpInfo(String, String, String, File); then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testV1StreamSidAttachmentCreatePostWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () ->
            attachmentsApi.v1StreamSidAttachmentCreatePostWithHttpInfo(
                null,
                "https://example.org/example",
                "https://example.org/example",
                Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile()));
  ...
  void testV1StreamSidAttachmentCreatePostWithHttpInfo_thenThrowApiException2()
      throws ApiException {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
   ...
   * </ul>
   *
   * <p>Method under test: {@link AttachmentsApi#v1StreamSidAttachmentGet(String, String, String,
   * String, String)}
   */
  @Test
  @DisplayName(
      "Test v1StreamSidAttachmentGet(String, String, String, String, String); then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "byte[] AttachmentsApi.v1StreamSidAttachmentGet(String, String, String, String, String)"
  })
  ...
  @Test
  @DisplayName(
      "Test v1StreamSidAttachmentGet(String, String, String, String, String); when 'Sid'; then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "byte[] AttachmentsApi.v1StreamSidAttachmentGet(String, String, String, String, String)"
  ...
  /**
   * Test {@link AttachmentsApi#v1StreamSidAttachmentGetWithHttpInfo(String, String, String, String,
   * String)}.
   *
   * <ul>
   *   <li>Then throw {@link ApiException}.
   * </ul>
   *
   * <p>Method under test: {@link AttachmentsApi#v1StreamSidAttachmentGetWithHttpInfo(String,
   * String, String, String, String)}
   */
  @Test
  @DisplayName(
      "Test v1StreamSidAttachmentGetWithHttpInfo(String, String, String, String, String); then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
   ...
   * </ul>
   *
   * <p>Method under test: {@link AttachmentsApi#v3StreamSidAttachmentCreatePost(String, String,
   * String, File)}
   */
  @Test
  @DisplayName(
      "Test v3StreamSidAttachmentCreatePost(String, String, String, File); then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testV3StreamSidAttachmentCreatePost_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () ->
            attachmentsApi.v3StreamSidAttachmentCreatePost(
                null,
                "ABC123",
                "ABC123",
                Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile()));
  ...
  @Test
  @DisplayName(
      "Test v3StreamSidAttachmentCreatePost(String, String, String, File); when 'Sid'; then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.gen.api.model.AttachmentInfo AttachmentsApi.v3StreamSidAttachmentCreatePost(String, String, String, File)"
  ...
  /**
   * Test {@link AttachmentsApi#v3StreamSidAttachmentCreatePostWithHttpInfo(String, String, String,
   * File)}.
   *
   * <ul>
   *   <li>Then throw {@link ApiException}.
   * </ul>
   *
   * <p>Method under test: {@link AttachmentsApi#v3StreamSidAttachmentCreatePostWithHttpInfo(String,
   * String, String, File)}
   */
  @Test
  @DisplayName(
      "Test v3StreamSidAttachmentCreatePostWithHttpInfo(String, String, String, File); then throw ApiException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testV3StreamSidAttachmentCreatePostWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () ->
            attachmentsApi.v3StreamSidAttachmentCreatePostWithHttpInfo(
                null,
                "https://example.org/example",
                "https://example.org/example",
                Paths.get(System.getProperty("java.io.tmpdir"), "test.txt").toFile()));
  ...
  void testV3StreamSidAttachmentCreatePostWithHttpInfo_thenThrowApiException2()
      throws ApiException {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
