...
class V3RoomSearchResultsDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test addRoomsItem(V3RoomDetail); given V3RoomSearchResults (default constructor) rooms ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3RoomSearchResults V3RoomSearchResults.addRoomsItem(V3RoomDetail)"})
   ...
   */
  @Test
  @DisplayName("Test addFacetedMatchCountItem(FacetedMatchCount); given V3RoomSearchResults (default constructor)")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test addFacetedMatchCountItem(FacetedMatchCount); given V3RoomSearchResults (default constructor) facetedMatchCount ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3RoomSearchResults V3RoomSearchResults.addFacetedMatchCountItem(FacetedMatchCount)"})
  ...
  @MethodsUnderTest({"void V3RoomSearchResults.<init>()", "V3RoomSearchResults V3RoomSearchResults.count(Long)",
      ...
      "V2RoomSearchCriteria V3RoomSearchResults.getQuery()", "List V3RoomSearchResults.getRooms()",
      ...
      "void V3RoomSearchResults.setQuery(V2RoomSearchCriteria)", "void V3RoomSearchResults.setRooms(List)",
  ...
  void testGettersAndSetters() {
    ...
    V3RoomSearchResults actualQueryResult = actualV3RoomSearchResults.query(new V2RoomSearchCriteria());
