...
class V3RoomDetailDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V3RoomDetail} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V3RoomDetail#addGroupsItem(GroupItem)}
   */
  @Test
   ...
   * Test {@link V3RoomDetail#addGroupsItem(GroupItem)}.
   * <ul>
   *   <li>Given {@link V3RoomDetail} (default constructor) groups {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V3RoomDetail#addGroupsItem(GroupItem)}
   */
  @Test
  @DisplayName("Test addGroupsItem(GroupItem); given V3RoomDetail (default constructor) groups ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3RoomDetail V3RoomDetail.addGroupsItem(GroupItem)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3RoomDetail.<init>()", "List V3RoomDetail.getGroups()",
      "V3RoomAttributes V3RoomDetail.getRoomAttributes()", "RoomSystemInfo V3RoomDetail.getRoomSystemInfo()",
      "V3RoomDetail V3RoomDetail.groups(List)", "V3RoomDetail V3RoomDetail.roomAttributes(V3RoomAttributes)",
      "V3RoomDetail V3RoomDetail.roomSystemInfo(RoomSystemInfo)", "void V3RoomDetail.setGroups(List)",
