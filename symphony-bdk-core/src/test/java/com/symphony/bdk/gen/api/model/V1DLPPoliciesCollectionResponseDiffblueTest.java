...
class V1DLPPoliciesCollectionResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V1DLPPoliciesCollectionResponse#addPoliciesItem(V1DLPPolicy)}
   */
  @Test
  @DisplayName("Test addPoliciesItem(V1DLPPolicy)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V1DLPPoliciesCollectionResponse V1DLPPoliciesCollectionResponse.addPoliciesItem(V1DLPPolicy)"})
  void testAddPoliciesItem() {
    // Arrange
    V1DLPPoliciesCollectionResponse v1dlpPoliciesCollectionResponse = new V1DLPPoliciesCollectionResponse();

    // Act and Assert
    assertSame(v1dlpPoliciesCollectionResponse, v1dlpPoliciesCollectionResponse.addPoliciesItem(new V1DLPPolicy()));
  }

  /**
   * Test {@link V1DLPPoliciesCollectionResponse#equals(Object)}, and {@link V1DLPPoliciesCollectionResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V1DLPPoliciesCollectionResponse.equals(Object)",
      "int V1DLPPoliciesCollectionResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1DLPPoliciesCollectionResponse v1dlpPoliciesCollectionResponse = new V1DLPPoliciesCollectionResponse();
    V1DLPPoliciesCollectionResponse v1dlpPoliciesCollectionResponse2 = new V1DLPPoliciesCollectionResponse();
    ...
    assertEquals(expectedHashCodeResult, v1dlpPoliciesCollectionResponse2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPPoliciesCollectionResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V1DLPPoliciesCollectionResponse(), "Different type to V1DLPPoliciesCollectionResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPPoliciesCollectionResponse.<init>()",
      "Integer V1DLPPoliciesCollectionResponse.getPage()", "Integer V1DLPPoliciesCollectionResponse.getPageCount()",
      ...
      "void V1DLPPoliciesCollectionResponse.setPolicies(List)", "String V1DLPPoliciesCollectionResponse.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPPoliciesCollectionResponse actualV1dlpPoliciesCollectionResponse = new V1DLPPoliciesCollectionResponse();
    V1DLPPoliciesCollectionResponse actualPageResult = actualV1dlpPoliciesCollectionResponse.page(1);
    V1DLPPoliciesCollectionResponse actualPageCountResult = actualV1dlpPoliciesCollectionResponse.pageCount(3);
    V1DLPPoliciesCollectionResponse actualPoliciesResult = actualV1dlpPoliciesCollectionResponse
    ...
    // Assert
    assertEquals("class V1DLPPoliciesCollectionResponse {\n    policies: []\n    page: 1\n    pageCount: 3\n}",
