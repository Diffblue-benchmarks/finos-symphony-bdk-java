...
class ConversationSpecificStreamAttributesDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link ConversationSpecificStreamAttributes} (default constructor) members {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link ConversationSpecificStreamAttributes#addMembersItem(Long)}
   */
  @Test
  @DisplayName(
      "Test addMembersItem(Long); given ConversationSpecificStreamAttributes (default constructor) members ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "ConversationSpecificStreamAttributes ConversationSpecificStreamAttributes.addMembersItem(Long)"
  })
  ...
  void testAddMembersItem_thenReturnMembersSizeIsOne() {
    ...
    // Act
    ConversationSpecificStreamAttributes actualAddMembersItemResult =
        conversationSpecificStreamAttributes.addMembersItem(1L);
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(
        conversationSpecificStreamAttributes, new ConversationSpecificStreamAttributes());
  }
  ...
  void testGettersAndSetters() {
    ...
    ConversationSpecificStreamAttributes actualMembersResult =
        actualConversationSpecificStreamAttributes.members(new ArrayList<>());
