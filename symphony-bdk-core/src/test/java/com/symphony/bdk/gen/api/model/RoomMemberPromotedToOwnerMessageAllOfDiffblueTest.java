...
class RoomMemberPromotedToOwnerMessageAllOfDiffblueTest {
  /**
   * Test {@link RoomMemberPromotedToOwnerMessageAllOf#equals(Object)}, and {@link RoomMemberPromotedToOwnerMessageAllOf#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean RoomMemberPromotedToOwnerMessageAllOf.equals(Object)",
      "int RoomMemberPromotedToOwnerMessageAllOf.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    RoomMemberPromotedToOwnerMessageAllOf roomMemberPromotedToOwnerMessageAllOf = new RoomMemberPromotedToOwnerMessageAllOf();
    RoomMemberPromotedToOwnerMessageAllOf roomMemberPromotedToOwnerMessageAllOf2 = new RoomMemberPromotedToOwnerMessageAllOf();
    ...
    assertEquals(expectedHashCodeResult, roomMemberPromotedToOwnerMessageAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link RoomMemberPromotedToOwnerMessageAllOf#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(roomMemberPromotedToOwnerMessageAllOf, new RoomMemberPromotedToOwnerMessageAllOf());
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new RoomMemberPromotedToOwnerMessageAllOf(),
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RoomMemberPromotedToOwnerMessageAllOf.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    RoomMemberPromotedToOwnerMessageAllOf actualRoomMemberPromotedToOwnerMessageAllOf = new RoomMemberPromotedToOwnerMessageAllOf();
    RoomMemberPromotedToOwnerMessageAllOf actualPromotedByUserIdResult = actualRoomMemberPromotedToOwnerMessageAllOf
        .promotedByUserId(1L);
    RoomMemberPromotedToOwnerMessageAllOf actualPromotedUserIdResult = actualRoomMemberPromotedToOwnerMessageAllOf
        .promotedUserId(1L);
    ...
    // Assert
    assertEquals("class RoomMemberPromotedToOwnerMessageAllOf {\n    promotedByUserId: 1\n    promotedUserId: 1\n}",
