...
class V2AdminStreamTypeDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V2AdminStreamType.equals(Object)",
    "int V2AdminStreamType.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2AdminStreamType.hashCode(), v2AdminStreamType2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2AdminStreamType#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2AdminStreamType.<init>()",
    "String V2AdminStreamType.getType()",
    "void V2AdminStreamType.setType(String)",
    "String V2AdminStreamType.toString()",
