...
class MessageDetailDiffblueTest {
   ...
   * MessageDetail#addDownloadReceiptCountsItem(MessageDownloadReceiptCount)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MessageDetail MessageDetail.addDownloadReceiptCountsItem(MessageDownloadReceiptCount)"
  })
  void testAddDownloadReceiptCountsItem() {
    ...
    // Act
    MessageDetail actualAddDownloadReceiptCountsItemResult =
        messageDetail.addDownloadReceiptCountsItem(new MessageDownloadReceiptCount());

    // Assert
    assertSame(messageDetail, actualAddDownloadReceiptCountsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link MessageDetail} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link
   * MessageDetail#addDownloadReceiptCountsItem(MessageDownloadReceiptCount)}
  ...
  @Test
  @DisplayName(
      "Test addDownloadReceiptCountsItem(MessageDownloadReceiptCount); given MessageDetail (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "MessageDetail MessageDetail.addDownloadReceiptCountsItem(MessageDownloadReceiptCount)"
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(messageDetail.hashCode(), messageDetail2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link MessageDetail#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MessageDetail.<init>()",
    "MessageDetail MessageDetail.creationDate(Long)",
    "MessageDetail MessageDetail.creator(MessageUser)",
    "MessageDetail MessageDetail.deliveryReceiptCount(Long)",
    "MessageDetail MessageDetail.downloadReceiptCounts(List)",
    "MessageDetail MessageDetail.emailNotificationCount(Long)",
    "Long MessageDetail.getCreationDate()",
    "MessageUser MessageDetail.getCreator()",
    "Long MessageDetail.getDeliveryReceiptCount()",
    "List MessageDetail.getDownloadReceiptCounts()",
    "Long MessageDetail.getEmailNotificationCount()",
    "String MessageDetail.getMessageId()",
    "MessageUser MessageDetail.getOnBehalfOfUser()",
    "Long MessageDetail.getReadReceiptCount()",
    "MessageStream MessageDetail.getStream()",
    "MessageDetail MessageDetail.messageId(String)",
    "MessageDetail MessageDetail.onBehalfOfUser(MessageUser)",
    "MessageDetail MessageDetail.readReceiptCount(Long)",
    "void MessageDetail.setCreationDate(Long)",
    "void MessageDetail.setCreator(MessageUser)",
    "void MessageDetail.setDeliveryReceiptCount(Long)",
    "void MessageDetail.setDownloadReceiptCounts(List)",
    "void MessageDetail.setEmailNotificationCount(Long)",
    "void MessageDetail.setMessageId(String)",
    "void MessageDetail.setOnBehalfOfUser(MessageUser)",
    "void MessageDetail.setReadReceiptCount(Long)",
    "void MessageDetail.setStream(MessageStream)",
    "MessageDetail MessageDetail.stream(MessageStream)",
    "String MessageDetail.toString()"
  })
  void testGettersAndSetters() {
    ...
    MessageDetail actualDownloadReceiptCountsResult =
        actualMessageDetail.downloadReceiptCounts(new ArrayList<>());
    MessageDetail actualEmailNotificationCountResult =
        actualMessageDetail.emailNotificationCount(3L);
    MessageDetail actualMessageIdResult = actualMessageDetail.messageId("42");
    MessageDetail actualOnBehalfOfUserResult =
        actualMessageDetail.onBehalfOfUser(new MessageUser());
    ...
    List<MessageDownloadReceiptCount> actualDownloadReceiptCounts =
        actualMessageDetail.getDownloadReceiptCounts();
