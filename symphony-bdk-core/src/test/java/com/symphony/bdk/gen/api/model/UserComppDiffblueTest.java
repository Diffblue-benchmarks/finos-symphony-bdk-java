...
class UserComppDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserCompp#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserCompp.<init>()", "UserCompp UserCompp.emailAddress(String)",
      "UserCompp UserCompp.firstName(String)", "String UserCompp.getEmailAddress()", "String UserCompp.getFirstName()",
      "Long UserCompp.getId()", "String UserCompp.getLastName()", "String UserCompp.getUsername()",
      "UserCompp UserCompp.id(Long)", "UserCompp UserCompp.lastName(String)", "void UserCompp.setEmailAddress(String)",
      "void UserCompp.setFirstName(String)", "void UserCompp.setId(Long)", "void UserCompp.setLastName(String)",
      "void UserCompp.setUsername(String)", "String UserCompp.toString()", "UserCompp UserCompp.username(String)"})
