...
class AssigneeCandidatesDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link AssigneeCandidates} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link AssigneeCandidates#addUsersItem(AssigneeCandidate)}
   */
  @Test
  @DisplayName(
      "Test addUsersItem(AssigneeCandidate); given AssigneeCandidates (default constructor)")
  ...
  void testAddUsersItem_givenAssigneeCandidates() {
    ...
    // Act
    AssigneeCandidates actualAddUsersItemResult =
        assigneeCandidates.addUsersItem(new AssigneeCandidate());

    // Assert
    assertSame(assigneeCandidates, actualAddUsersItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link AssigneeCandidates} (default constructor) users {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link AssigneeCandidates#addUsersItem(AssigneeCandidate)}
  ...
  @Test
  @DisplayName(
      "Test addUsersItem(AssigneeCandidate); given AssigneeCandidates (default constructor) users ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"AssigneeCandidates AssigneeCandidates.addUsersItem(AssigneeCandidate)"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean AssigneeCandidates.equals(Object)",
    "int AssigneeCandidates.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(assigneeCandidates.hashCode(), assigneeCandidates2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link AssigneeCandidates#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AssigneeCandidates.<init>()",
    "Pagination AssigneeCandidates.getPagination()",
    "List AssigneeCandidates.getUsers()",
    "AssigneeCandidates AssigneeCandidates.pagination(Pagination)",
    "void AssigneeCandidates.setPagination(Pagination)",
    "void AssigneeCandidates.setUsers(List)",
    "String AssigneeCandidates.toString()",
    "AssigneeCandidates AssigneeCandidates.users(List)"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    AssigneeCandidates actualAssigneeCandidates = new AssigneeCandidates();
    AssigneeCandidates actualPaginationResult =
        actualAssigneeCandidates.pagination(new Pagination());
