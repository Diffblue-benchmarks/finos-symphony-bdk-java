...
class FollowersListResponseDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link FollowersListResponse} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link FollowersListResponse#addFollowersItem(Long)}
   */
  @Test
  ...
  void testAddFollowersItem_givenFollowersListResponse() {
    ...
    // Act
    FollowersListResponse actualAddFollowersItemResult = followersListResponse.addFollowersItem(1L);

    // Assert
    assertSame(followersListResponse, actualAddFollowersItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link FollowersListResponse} (default constructor) followers {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link FollowersListResponse#addFollowersItem(Long)}
  ...
  @Test
  @DisplayName(
      "Test addFollowersItem(Long); given FollowersListResponse (default constructor) followers ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"FollowersListResponse FollowersListResponse.addFollowersItem(Long)"})
  ...
  /**
   * Test {@link FollowersListResponse#equals(Object)}, and {@link
   * FollowersListResponse#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean FollowersListResponse.equals(Object)",
    "int FollowersListResponse.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(followersListResponse.hashCode(), followersListResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link FollowersListResponse#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void FollowersListResponse.<init>()",
    "FollowersListResponse FollowersListResponse.count(Long)",
    "FollowersListResponse FollowersListResponse.followers(List)",
    "Long FollowersListResponse.getCount()",
    "List FollowersListResponse.getFollowers()",
    "Pagination FollowersListResponse.getPagination()",
    "FollowersListResponse FollowersListResponse.pagination(Pagination)",
    "void FollowersListResponse.setCount(Long)",
    "void FollowersListResponse.setFollowers(List)",
    "void FollowersListResponse.setPagination(Pagination)",
  ...
  void testGettersAndSetters() {
    ...
    FollowersListResponse actualFollowersResult =
        actualFollowersListResponse.followers(new ArrayList<>());
    FollowersListResponse actualPaginationResult =
        actualFollowersListResponse.pagination(new Pagination());
