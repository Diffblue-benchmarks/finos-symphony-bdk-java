...
class V1DLPDictionaryRefDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V1DLPDictionaryRef.equals(Object)", "int V1DLPDictionaryRef.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v1dlpDictionaryRef2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPDictionaryRef#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPDictionaryRef.<init>()", "V1DLPDictionaryRef V1DLPDictionaryRef.dictId(String)",
      "String V1DLPDictionaryRef.getDictId()", "String V1DLPDictionaryRef.getName()",
      "String V1DLPDictionaryRef.getVersion()", "V1DLPDictionaryRef V1DLPDictionaryRef.name(String)",
      "void V1DLPDictionaryRef.setDictId(String)", "void V1DLPDictionaryRef.setName(String)",
      "void V1DLPDictionaryRef.setVersion(String)", "String V1DLPDictionaryRef.toString()",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class V1DLPDictionaryRef {\n    dictId: 42\n    name: Name\n    version: 1.0.2\n}",
