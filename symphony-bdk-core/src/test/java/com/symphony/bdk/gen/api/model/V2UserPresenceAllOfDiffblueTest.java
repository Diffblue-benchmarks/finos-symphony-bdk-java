...
class V2UserPresenceAllOfDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V2UserPresenceAllOf.equals(Object)", "int V2UserPresenceAllOf.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2UserPresenceAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2UserPresenceAllOf.<init>()", "Long V2UserPresenceAllOf.getUserId()",
      "void V2UserPresenceAllOf.setUserId(Long)", "String V2UserPresenceAllOf.toString()",
