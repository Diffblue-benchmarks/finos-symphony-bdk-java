...
class FollowingListResponseDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link FollowingListResponse} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link FollowingListResponse#addFollowingItem(Long)}
   */
  @Test
  ...
  void testAddFollowingItem_givenFollowingListResponse() {
    ...
    // Act
    FollowingListResponse actualAddFollowingItemResult = followingListResponse.addFollowingItem(1L);

    // Assert
    assertSame(followingListResponse, actualAddFollowingItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link FollowingListResponse} (default constructor) following {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link FollowingListResponse#addFollowingItem(Long)}
  ...
  @Test
  @DisplayName(
      "Test addFollowingItem(Long); given FollowingListResponse (default constructor) following ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"FollowingListResponse FollowingListResponse.addFollowingItem(Long)"})
  ...
  /**
   * Test {@link FollowingListResponse#equals(Object)}, and {@link
   * FollowingListResponse#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean FollowingListResponse.equals(Object)",
    "int FollowingListResponse.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(followingListResponse.hashCode(), followingListResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link FollowingListResponse#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void FollowingListResponse.<init>()",
    "FollowingListResponse FollowingListResponse.count(Long)",
    "FollowingListResponse FollowingListResponse.following(List)",
    "Long FollowingListResponse.getCount()",
    "List FollowingListResponse.getFollowing()",
    "Pagination FollowingListResponse.getPagination()",
    "FollowingListResponse FollowingListResponse.pagination(Pagination)",
    "void FollowingListResponse.setCount(Long)",
    "void FollowingListResponse.setFollowing(List)",
    "void FollowingListResponse.setPagination(Pagination)",
  ...
  void testGettersAndSetters() {
    ...
    FollowingListResponse actualFollowingResult =
        actualFollowingListResponse.following(new ArrayList<>());
    FollowingListResponse actualPaginationResult =
        actualFollowingListResponse.pagination(new Pagination());
