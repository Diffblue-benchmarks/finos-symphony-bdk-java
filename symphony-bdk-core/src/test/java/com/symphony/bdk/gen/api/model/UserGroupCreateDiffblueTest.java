...
class UserGroupCreateDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupCreate#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupCreate.<init>()", "UserGroupCreate UserGroupCreate.area(String)",
      "UserGroupCreate UserGroupCreate.description(String)", "String UserGroupCreate.getArea()",
      "String UserGroupCreate.getDescription()", "String UserGroupCreate.getName()", "String UserGroupCreate.getType()",
      "UserGroupCreate UserGroupCreate.name(String)", "void UserGroupCreate.setArea(String)",
      "void UserGroupCreate.setDescription(String)", "void UserGroupCreate.setName(String)",
      "void UserGroupCreate.setType(String)", "String UserGroupCreate.toString()",
  ...
  void testGettersAndSetters() {
    ...
    UserGroupCreate actualDescriptionResult = actualUserGroupCreate
