...
class V5DatafeedDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link V5Datafeed#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V5Datafeed.<init>()", "V5Datafeed V5Datafeed.createdAt(Long)",
      "Long V5Datafeed.getCreatedAt()", "String V5Datafeed.getId()", "String V5Datafeed.getType()",
      "V5Datafeed V5Datafeed.id(String)", "void V5Datafeed.setCreatedAt(Long)", "void V5Datafeed.setId(String)",
      "void V5Datafeed.setType(String)", "String V5Datafeed.toString()", "V5Datafeed V5Datafeed.type(String)"})
