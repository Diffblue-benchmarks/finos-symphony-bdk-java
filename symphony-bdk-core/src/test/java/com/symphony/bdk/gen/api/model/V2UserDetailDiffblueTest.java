...
class V2UserDetailDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V2UserDetail} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addFeaturesItem(Long)}
   */
  @Test
  ...
  void testAddFeaturesItem_givenV2UserDetail() {
    ...
    // Act
    V2UserDetail actualAddFeaturesItemResult = v2UserDetail.addFeaturesItem(1L);

    // Assert
    assertSame(v2UserDetail, actualAddFeaturesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2UserDetail} (default constructor) features {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addFeaturesItem(Long)}
   */
  @Test
  @DisplayName(
      "Test addFeaturesItem(Long); given V2UserDetail (default constructor) features ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V2UserDetail V2UserDetail.addFeaturesItem(Long)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addAppsItem(Long)}
   */
  @Test
  ...
  void testAddAppsItem_givenV2UserDetail() {
    ...
    // Act
    V2UserDetail actualAddAppsItemResult = v2UserDetail.addAppsItem(1L);

    // Assert
    assertSame(v2UserDetail, actualAddAppsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2UserDetail} (default constructor) apps {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addAppsItem(Long)}
   */
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addGroupsItem(Long)}
   */
  @Test
  ...
  void testAddGroupsItem_givenV2UserDetail() {
    ...
    // Act
    V2UserDetail actualAddGroupsItemResult = v2UserDetail.addGroupsItem(1L);

    // Assert
    assertSame(v2UserDetail, actualAddGroupsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2UserDetail} (default constructor) groups {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addGroupsItem(Long)}
   */
  @Test
  @DisplayName(
      "Test addGroupsItem(Long); given V2UserDetail (default constructor) groups ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V2UserDetail V2UserDetail.addGroupsItem(Long)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addRolesItem(String)}
   */
  @Test
  ...
  void testAddRolesItem_givenV2UserDetail() {
    ...
    // Act
    V2UserDetail actualAddRolesItemResult = v2UserDetail.addRolesItem("Roles Item");

    // Assert
    assertSame(v2UserDetail, actualAddRolesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2UserDetail} (default constructor) roles {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addRolesItem(String)}
   */
  @Test
  @DisplayName(
      "Test addRolesItem(String); given V2UserDetail (default constructor) roles ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V2UserDetail V2UserDetail.addRolesItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addDisclaimersItem(Long)}
   */
  @Test
  ...
  void testAddDisclaimersItem_givenV2UserDetail() {
    ...
    // Act
    V2UserDetail actualAddDisclaimersItemResult = v2UserDetail.addDisclaimersItem(1L);

    // Assert
    assertSame(v2UserDetail, actualAddDisclaimersItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2UserDetail} (default constructor) disclaimers {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#addDisclaimersItem(Long)}
  ...
  @Test
  @DisplayName(
      "Test addDisclaimersItem(Long); given V2UserDetail (default constructor) disclaimers ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V2UserDetail V2UserDetail.addDisclaimersItem(Long)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2UserDetail.hashCode(), v2UserDetail2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2UserDetail#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2UserDetail.<init>()",
    "V2UserDetail V2UserDetail.apps(List)",
    "V2UserDetail V2UserDetail.avatar(Avatar)",
    "V2UserDetail V2UserDetail.disclaimers(List)",
    "V2UserDetail V2UserDetail.features(List)",
    "List V2UserDetail.getApps()",
    "Avatar V2UserDetail.getAvatar()",
    "List V2UserDetail.getDisclaimers()",
    "List V2UserDetail.getFeatures()",
    "List V2UserDetail.getGroups()",
    "List V2UserDetail.getRoles()",
    "V2UserAttributes V2UserDetail.getUserAttributes()",
    "UserSystemInfo V2UserDetail.getUserSystemInfo()",
    "V2UserDetail V2UserDetail.groups(List)",
    "V2UserDetail V2UserDetail.roles(List)",
    "void V2UserDetail.setApps(List)",
    "void V2UserDetail.setAvatar(Avatar)",
    "void V2UserDetail.setDisclaimers(List)",
    "void V2UserDetail.setFeatures(List)",
    "void V2UserDetail.setGroups(List)",
    "void V2UserDetail.setRoles(List)",
    "void V2UserDetail.setUserAttributes(V2UserAttributes)",
    "void V2UserDetail.setUserSystemInfo(UserSystemInfo)",
    "String V2UserDetail.toString()",
    "V2UserDetail V2UserDetail.userAttributes(V2UserAttributes)",
