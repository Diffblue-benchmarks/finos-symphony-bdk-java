...
class CompanyCertDetailDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link CompanyCertDetail} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link CompanyCertDetail#addCertInfoItem(CertInfoItem)}
   */
  @Test
  ...
  void testAddCertInfoItem_givenCompanyCertDetail() {
    ...
    // Act and Assert
    assertSame(companyCertDetail, companyCertDetail.addCertInfoItem(new CertInfoItem()));
  }

  /**
   * Test {@link CompanyCertDetail#addCertInfoItem(CertInfoItem)}.
   * <ul>
   *   <li>Given {@link CompanyCertDetail} (default constructor) certInfo {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link CompanyCertDetail#addCertInfoItem(CertInfoItem)}
   */
  @Test
  @DisplayName("Test addCertInfoItem(CertInfoItem); given CompanyCertDetail (default constructor) certInfo ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"CompanyCertDetail CompanyCertDetail.addCertInfoItem(CertInfoItem)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CompanyCertDetail.<init>()", "CompanyCertDetail CompanyCertDetail.certInfo(List)",
      "CompanyCertDetail CompanyCertDetail.companyCertAttributes(CompanyCertAttributes)",
      "CompanyCertDetail CompanyCertDetail.companyCertInfo(CompanyCertInfo)", "List CompanyCertDetail.getCertInfo()",
      "CompanyCertAttributes CompanyCertDetail.getCompanyCertAttributes()",
      "CompanyCertInfo CompanyCertDetail.getCompanyCertInfo()", "void CompanyCertDetail.setCertInfo(List)",
