...
class V3DLPViolationStreamDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V3DLPViolationStream.equals(Object)", "int V3DLPViolationStream.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpViolationStream2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPViolationStream#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPViolationStream.<init>()", "V1DLPStream V3DLPViolationStream.getStream()",
      "V3DLPViolation V3DLPViolationStream.getViolation()", "void V3DLPViolationStream.setStream(V1DLPStream)",
      "void V3DLPViolationStream.setViolation(V3DLPViolation)",
      "V3DLPViolationStream V3DLPViolationStream.stream(V1DLPStream)", "String V3DLPViolationStream.toString()",
  ...
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("class V3DLPViolationStream {\n" + "    violation: class V3DLPViolation {\n"
