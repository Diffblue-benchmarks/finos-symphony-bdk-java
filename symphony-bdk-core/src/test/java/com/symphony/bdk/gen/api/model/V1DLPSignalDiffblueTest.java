...
class V1DLPSignalDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPSignal#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPSignal.<init>()", "V1DLPSignal V1DLPSignal.diagnostic(String)",
      "String V1DLPSignal.getDiagnostic()", "String V1DLPSignal.getId()", "String V1DLPSignal.getName()",
      "String V1DLPSignal.getRules()", "V1DLPSignal V1DLPSignal.id(String)", "V1DLPSignal V1DLPSignal.name(String)",
      "V1DLPSignal V1DLPSignal.rules(String)", "void V1DLPSignal.setDiagnostic(String)",
      "void V1DLPSignal.setId(String)", "void V1DLPSignal.setName(String)", "void V1DLPSignal.setRules(String)",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class V1DLPSignal {\n    id: 42\n    name: Name\n    rules: Rules\n    diagnostic: Diagnostic\n}",
