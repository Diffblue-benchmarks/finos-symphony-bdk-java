...
class UserAppEntitlementDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserAppEntitlement} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserAppEntitlement#addProductsItem(Product)}
   */
  @Test
   ...
   * Test {@link UserAppEntitlement#addProductsItem(Product)}.
   * <ul>
   *   <li>Given {@link UserAppEntitlement} (default constructor) products {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserAppEntitlement#addProductsItem(Product)}
   */
  @Test
  @DisplayName("Test addProductsItem(Product); given UserAppEntitlement (default constructor) products ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserAppEntitlement UserAppEntitlement.addProductsItem(Product)"})
  ...
  @MethodsUnderTest({"void UserAppEntitlement.<init>()", "UserAppEntitlement UserAppEntitlement.appId(String)",
      ...
      "Boolean UserAppEntitlement.getListed()", "List UserAppEntitlement.getProducts()",
      "UserAppEntitlement UserAppEntitlement.install(Boolean)", "UserAppEntitlement UserAppEntitlement.listed(Boolean)",
      "UserAppEntitlement UserAppEntitlement.products(List)", "void UserAppEntitlement.setAppId(String)",
      "void UserAppEntitlement.setAppName(String)", "void UserAppEntitlement.setInstall(Boolean)",
      "void UserAppEntitlement.setListed(Boolean)", "void UserAppEntitlement.setProducts(List)",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class UserAppEntitlement {\n" + "    appId: 42\n" + "    appName: App Name\n" + "    listed: true\n"
