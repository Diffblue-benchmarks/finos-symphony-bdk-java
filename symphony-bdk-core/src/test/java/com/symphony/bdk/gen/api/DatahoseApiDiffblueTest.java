...
class DatahoseApiDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link DatahoseApi#readEvents(String, String, V5EventsReadBody)}
   */
  @Test
  ...
  void testReadEvents_thenThrowApiException() throws ApiException {
    ...
    DatahoseApi datahoseApi = new DatahoseApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example",
        defaultHeaders, "https://example.org/example"));

    // Act and Assert
    assertThrows(ApiException.class, () -> datahoseApi.readEvents(null, "ABC123", new V5EventsReadBody()));
  }
  ...
  void testReadEvents_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new DatahoseApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).readEvents("ABC123", null, null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link DatahoseApi#readEventsWithHttpInfo(String, String, V5EventsReadBody)}
   */
  @Test
  @DisplayName("Test readEventsWithHttpInfo(String, String, V5EventsReadBody); then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testReadEventsWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    // Act and Assert
    assertThrows(ApiException.class,
        () -> datahoseApi.readEventsWithHttpInfo(null, "https://example.org/example", new V5EventsReadBody()));
  }
  ...
  void testReadEventsWithHttpInfo_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new DatahoseApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).readEventsWithHttpInfo("https://example.org/example", null, null));
  }
}
