...
class V2HealthCheckResponseDiffblueTest {
  ...
  @MethodsUnderTest({"void V2HealthCheckResponse.<init>()",
      ...
      "String V2HealthCheckResponse.getCeServiceUserError()", "Boolean V2HealthCheckResponse.getDatafeedConnectivity()",
      "String V2HealthCheckResponse.getDatafeedConnectivityError()",
      "String V2HealthCheckResponse.getDatafeedVersion()", "String V2HealthCheckResponse.getEncryptDecryptError()",
  ...
  void testGettersAndSetters() {
    ...
    V2HealthCheckResponse actualDatafeedConnectivityResult = actualV2HealthCheckResponse.datafeedConnectivity(true);
    V2HealthCheckResponse actualDatafeedConnectivityErrorResult = actualV2HealthCheckResponse
        .datafeedConnectivityError("An error occurred");
    V2HealthCheckResponse actualDatafeedVersionResult = actualV2HealthCheckResponse.datafeedVersion("1.0.2");
    ...
    V2HealthCheckResponse actualFirehoseConnectivityResult = actualV2HealthCheckResponse.firehoseConnectivity(true);
    V2HealthCheckResponse actualFirehoseConnectivityErrorResult = actualV2HealthCheckResponse
    ...
    String actualDatafeedConnectivityError = actualV2HealthCheckResponse.getDatafeedConnectivityError();
    ...
    String actualFirehoseConnectivityError = actualV2HealthCheckResponse.getFirehoseConnectivityError();
