...
class V1DLPDictionaryMetadataDiffblueTest {
  /**
   * Test {@link V1DLPDictionaryMetadata#equals(Object)}, and {@link V1DLPDictionaryMetadata#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean V1DLPDictionaryMetadata.equals(Object)", "int V1DLPDictionaryMetadata.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v1dlpDictionaryMetadata2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPDictionaryMetadata#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPDictionaryMetadata.<init>()",
      ...
      "Long V1DLPDictionaryMetadata.getCreationDate()", "String V1DLPDictionaryMetadata.getCreatorId()",
      "V1DLPDictionaryRef V1DLPDictionaryMetadata.getDictRef()", "Long V1DLPDictionaryMetadata.getLastUpdatedDate()",
      "String V1DLPDictionaryMetadata.getType()",
      "V1DLPDictionaryMetadata V1DLPDictionaryMetadata.lastUpdatedDate(Long)",
      "void V1DLPDictionaryMetadata.setCreationDate(Long)", "void V1DLPDictionaryMetadata.setCreatorId(String)",
      "void V1DLPDictionaryMetadata.setDictRef(V1DLPDictionaryRef)",
      "void V1DLPDictionaryMetadata.setLastUpdatedDate(Long)", "void V1DLPDictionaryMetadata.setType(String)",
      "String V1DLPDictionaryMetadata.toString()", "V1DLPDictionaryMetadata V1DLPDictionaryMetadata.type(String)"})
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPDictionaryMetadata actualV1dlpDictionaryMetadata = new V1DLPDictionaryMetadata();
    V1DLPDictionaryMetadata actualCreationDateResult = actualV1dlpDictionaryMetadata.creationDate(1L);
    V1DLPDictionaryMetadata actualCreatorIdResult = actualV1dlpDictionaryMetadata.creatorId("42");
    V1DLPDictionaryMetadata actualDictRefResult = actualV1dlpDictionaryMetadata.dictRef(new V1DLPDictionaryRef());
    V1DLPDictionaryMetadata actualLastUpdatedDateResult = actualV1dlpDictionaryMetadata.lastUpdatedDate(1L);
