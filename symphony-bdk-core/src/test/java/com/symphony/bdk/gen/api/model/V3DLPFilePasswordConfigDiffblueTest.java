...
class V3DLPFilePasswordConfigDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPFilePasswordConfig#addApplicableFileTypesItem(String)}
   */
  @Test
  @DisplayName("Test addApplicableFileTypesItem(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3DLPFilePasswordConfig V3DLPFilePasswordConfig.addApplicableFileTypesItem(String)"})
  void testAddApplicableFileTypesItem() {
    // Arrange
    V3DLPFilePasswordConfig v3dlpFilePasswordConfig = new V3DLPFilePasswordConfig();

    // Act and Assert
    assertSame(v3dlpFilePasswordConfig,
        v3dlpFilePasswordConfig.addApplicableFileTypesItem("Applicable File Types Item"));
  }

  /**
   * Test {@link V3DLPFilePasswordConfig#equals(Object)}, and {@link V3DLPFilePasswordConfig#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPFilePasswordConfig.equals(Object)", "int V3DLPFilePasswordConfig.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpFilePasswordConfig2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPFilePasswordConfig#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPFilePasswordConfig.<init>()",
      "V3DLPFilePasswordConfig V3DLPFilePasswordConfig.applicableFileTypes(List)",
      "List V3DLPFilePasswordConfig.getApplicableFileTypes()", "String V3DLPFilePasswordConfig.getMatchCriteria()",
      ...
      "void V3DLPFilePasswordConfig.setMatchCriteria(String)", "String V3DLPFilePasswordConfig.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPFilePasswordConfig actualV3dlpFilePasswordConfig = new V3DLPFilePasswordConfig();
    V3DLPFilePasswordConfig actualApplicableFileTypesResult = actualV3dlpFilePasswordConfig
        .applicableFileTypes(new ArrayList<>());
    V3DLPFilePasswordConfig actualMatchCriteriaResult = actualV3dlpFilePasswordConfig.matchCriteria("Match Criteria");
    ...
    assertEquals("class V3DLPFilePasswordConfig {\n    applicableFileTypes: []\n    matchCriteria: Match Criteria\n}",
