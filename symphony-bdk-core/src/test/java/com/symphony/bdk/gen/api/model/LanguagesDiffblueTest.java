...
class LanguagesDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Languages} (default constructor) languages {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link Languages#addLanguagesItem(String)}
   */
  @Test
  @DisplayName(
      "Test addLanguagesItem(String); given Languages (default constructor) languages ArrayList()")
   ...
   *
   * <ul>
   *   <li>Given {@link Languages} (default constructor).
   *   <li>Then return Languages size is one.
   * </ul>
   *
   * <p>Method under test: {@link Languages#addLanguagesItem(String)}
   */
  @Test
  @DisplayName(
      "Test addLanguagesItem(String); given Languages (default constructor); then return Languages size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Languages Languages.addLanguagesItem(String)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(languages.hashCode(), languages2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link Languages#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    ...
    "void Languages.setLanguages(List)",
    "String Languages.toString()"
  })
