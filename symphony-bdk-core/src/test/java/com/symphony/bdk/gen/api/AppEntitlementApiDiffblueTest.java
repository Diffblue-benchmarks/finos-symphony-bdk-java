...
class AppEntitlementApiDiffblueTest {
  ...
  void testV1AdminAppEntitlementListGet_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new AppEntitlementApi(apiClient).v1AdminAppEntitlementListGet(null));
  }
  ...
  void testV1AdminAppEntitlementListGetWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new AppEntitlementApi(apiClient).v1AdminAppEntitlementListGetWithHttpInfo(null));
  }
  ...
  void testV1AdminUserUidAppEntitlementListGet_whenNull_thenThrowApiException()
    ...
    assertThrows(
        ApiException.class,
        () -> new AppEntitlementApi(apiClient).v1AdminUserUidAppEntitlementListGet(null, 1L));
  }
  ...
  void testV1AdminUserUidAppEntitlementListGet_whenNull_thenThrowApiException2()
    ...
    assertThrows(
        ApiException.class,
        () -> new AppEntitlementApi(apiClient).v1AdminUserUidAppEntitlementListGet("ABC123", null));
  }
  ...
  void testV1AdminUserUidAppEntitlementListGetWithHttpInfo_thenThrowApiException()
    ...
    assertThrows(
        ApiException.class,
        () ->
            new AppEntitlementApi(apiClient)
