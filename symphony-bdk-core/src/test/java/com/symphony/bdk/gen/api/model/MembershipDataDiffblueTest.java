...
class MembershipDataDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(membershipData.hashCode(), membershipData2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link MembershipData#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void MembershipData.<init>()",
    "MembershipData MembershipData.emailAddress(String)",
    "MembershipData MembershipData.firstName(String)",
    "String MembershipData.getEmailAddress()",
    "String MembershipData.getFirstName()",
    "Long MembershipData.getId()",
    "String MembershipData.getLastName()",
    "String MembershipData.getUserName()",
    "MembershipData MembershipData.id(Long)",
    "MembershipData MembershipData.lastName(String)",
    "void MembershipData.setEmailAddress(String)",
    "void MembershipData.setFirstName(String)",
    "void MembershipData.setId(Long)",
    "void MembershipData.setLastName(String)",
    "void MembershipData.setUserName(String)",
    "String MembershipData.toString()",
    "MembershipData MembershipData.userName(String)"
  })
