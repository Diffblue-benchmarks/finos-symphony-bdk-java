...
class V4ImportedMessageDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V4ImportedMessage} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link V4ImportedMessage#addAttachmentsItem(V4ImportedMessageAttachment)}
   */
  @Test
  @DisplayName(
      "Test addAttachmentsItem(V4ImportedMessageAttachment); given V4ImportedMessage (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V4ImportedMessage V4ImportedMessage.addAttachmentsItem(V4ImportedMessageAttachment)"
  })
  void testAddAttachmentsItem_givenV4ImportedMessage() {
    ...
    // Act
    V4ImportedMessage actualAddAttachmentsItemResult =
        v4ImportedMessage.addAttachmentsItem(new V4ImportedMessageAttachment());

    // Assert
    assertSame(v4ImportedMessage, actualAddAttachmentsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V4ImportedMessage} (default constructor) attachments {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V4ImportedMessage#addAttachmentsItem(V4ImportedMessageAttachment)}
  ...
  @Test
  @DisplayName(
      "Test addAttachmentsItem(V4ImportedMessageAttachment); given V4ImportedMessage (default constructor) attachments ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V4ImportedMessage V4ImportedMessage.addAttachmentsItem(V4ImportedMessageAttachment)"
   ...
   * </ul>
   *
   * <p>Method under test: {@link V4ImportedMessage#addPreviewsItem(V4ImportedMessageAttachment)}
   */
  @Test
  @DisplayName(
      "Test addPreviewsItem(V4ImportedMessageAttachment); given V4ImportedMessage (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V4ImportedMessage V4ImportedMessage.addPreviewsItem(V4ImportedMessageAttachment)"
  })
  void testAddPreviewsItem_givenV4ImportedMessage() {
    ...
    // Act
    V4ImportedMessage actualAddPreviewsItemResult =
        v4ImportedMessage.addPreviewsItem(new V4ImportedMessageAttachment());

    // Assert
    assertSame(v4ImportedMessage, actualAddPreviewsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V4ImportedMessage} (default constructor) previews {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V4ImportedMessage#addPreviewsItem(V4ImportedMessageAttachment)}
  ...
  @Test
  @DisplayName(
      "Test addPreviewsItem(V4ImportedMessageAttachment); given V4ImportedMessage (default constructor) previews ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V4ImportedMessage V4ImportedMessage.addPreviewsItem(V4ImportedMessageAttachment)"
  ...
  @MethodsUnderTest({
    ...
    "V4ImportedMessage V4ImportedMessage.attachments(List)",
    "V4ImportedMessage V4ImportedMessage.data(String)",
    "List V4ImportedMessage.getAttachments()",
    ...
    "List V4ImportedMessage.getPreviews()",
    ...
    "V4ImportedMessage V4ImportedMessage.previews(List)",
    "void V4ImportedMessage.setAttachments(List)",
    ...
    "void V4ImportedMessage.setPreviews(List)",
  ...
  void testGettersAndSetters() {
    ...
    V4ImportedMessage actualAttachmentsResult =
        actualV4ImportedMessage.attachments(new ArrayList<>());
    V4ImportedMessage actualDataResult =
        actualV4ImportedMessage.data(MessageIdsFromStream.JSON_PROPERTY_DATA);
