...
class V4ImportedMessageDiffblueTest {
  ...
  void testAddAttachmentsItem_givenV4ImportedMessage() {
    ...
    // Act and Assert
    assertSame(
        v4ImportedMessage, v4ImportedMessage.addAttachmentsItem(new V4ImportedMessageAttachment()));
  }
  ...
  void testAddPreviewsItem_givenV4ImportedMessage() {
    ...
    // Act and Assert
    assertSame(
        v4ImportedMessage, v4ImportedMessage.addPreviewsItem(new V4ImportedMessageAttachment()));
  }
