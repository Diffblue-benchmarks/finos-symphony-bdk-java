...
class UserJoinedRoomMessageAllOfDiffblueTest {
  /**
   * Test {@link UserJoinedRoomMessageAllOf#equals(Object)}, and {@link UserJoinedRoomMessageAllOf#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean UserJoinedRoomMessageAllOf.equals(Object)", "int UserJoinedRoomMessageAllOf.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserJoinedRoomMessageAllOf#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new UserJoinedRoomMessageAllOf(), "Different type to UserJoinedRoomMessageAllOf");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserJoinedRoomMessageAllOf.<init>()",
      "UserJoinedRoomMessageAllOf UserJoinedRoomMessageAllOf.addedByUserId(Long)",
      "Long UserJoinedRoomMessageAllOf.getAddedByUserId()", "Long UserJoinedRoomMessageAllOf.getMemberAddedUserId()",
      ...
      "void UserJoinedRoomMessageAllOf.setMemberAddedUserId(Long)", "String UserJoinedRoomMessageAllOf.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    UserJoinedRoomMessageAllOf actualUserJoinedRoomMessageAllOf = new UserJoinedRoomMessageAllOf();
    UserJoinedRoomMessageAllOf actualMemberAddedUserIdResult = actualUserJoinedRoomMessageAllOf.memberAddedUserId(1L);
    actualUserJoinedRoomMessageAllOf.setAddedByUserId(1L);
    actualUserJoinedRoomMessageAllOf.setMemberAddedUserId(1L);
    UserJoinedRoomMessageAllOf actualAddedByUserIdResult = actualUserJoinedRoomMessageAllOf.addedByUserId(1L);
    ...
    // Assert
    assertEquals("class UserJoinedRoomMessageAllOf {\n    addedByUserId: 1\n    memberAddedUserId: 1\n}",
