...
class MessageMetadataResponseDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MessageMetadataResponse} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#addRepliesItem(String)}
   */
  @Test
  ...
  void testAddRepliesItem_givenMessageMetadataResponse() {
    ...
    // Act and Assert
    assertSame(messageMetadataResponse, messageMetadataResponse.addRepliesItem("Replies Item"));
  }

  /**
   * Test {@link MessageMetadataResponse#addRepliesItem(String)}.
   * <ul>
   *   <li>Given {@link MessageMetadataResponse} (default constructor) replies {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#addRepliesItem(String)}
   */
  @Test
  @DisplayName("Test addRepliesItem(String); given MessageMetadataResponse (default constructor) replies ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageMetadataResponse MessageMetadataResponse.addRepliesItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#addForwardsItem(String)}
   */
  @Test
  ...
  void testAddForwardsItem_givenMessageMetadataResponse() {
    ...
    // Act and Assert
    assertSame(messageMetadataResponse, messageMetadataResponse.addForwardsItem("Forwards Item"));
  }

  /**
   * Test {@link MessageMetadataResponse#addForwardsItem(String)}.
   * <ul>
   *   <li>Given {@link MessageMetadataResponse} (default constructor) forwards {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#addForwardsItem(String)}
   */
  @Test
  @DisplayName("Test addForwardsItem(String); given MessageMetadataResponse (default constructor) forwards ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageMetadataResponse MessageMetadataResponse.addForwardsItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#addFormRepliesItem(String)}
   */
  @Test
  @DisplayName("Test addFormRepliesItem(String); given MessageMetadataResponse (default constructor)")
  @Tag("MaintainedByDiffblue")
  ...
  void testAddFormRepliesItem_givenMessageMetadataResponse() {
    ...
    // Act and Assert
    assertSame(messageMetadataResponse, messageMetadataResponse.addFormRepliesItem("Form Replies Item"));
  }

  /**
   * Test {@link MessageMetadataResponse#addFormRepliesItem(String)}.
   * <ul>
   *   <li>Given {@link MessageMetadataResponse} (default constructor) formReplies {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#addFormRepliesItem(String)}
   */
  @Test
  @DisplayName("Test addFormRepliesItem(String); given MessageMetadataResponse (default constructor) formReplies ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageMetadataResponse MessageMetadataResponse.addFormRepliesItem(String)"})
  ...
  /**
   * Test {@link MessageMetadataResponse#equals(Object)}, and {@link MessageMetadataResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean MessageMetadataResponse.equals(Object)", "int MessageMetadataResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageMetadataResponse2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageMetadataResponse#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageMetadataResponse.<init>()",
      "MessageMetadataResponse MessageMetadataResponse.formReplies(List)",
      "MessageMetadataResponse MessageMetadataResponse.forwards(List)", "List MessageMetadataResponse.getFormReplies()",
      "List MessageMetadataResponse.getForwards()", "String MessageMetadataResponse.getMessageId()",
      "MessageMetadataResponseParent MessageMetadataResponse.getParent()", "List MessageMetadataResponse.getReplies()",
      ...
      "void MessageMetadataResponse.setFormReplies(List)", "void MessageMetadataResponse.setForwards(List)",
      "void MessageMetadataResponse.setMessageId(String)",
      "void MessageMetadataResponse.setParent(MessageMetadataResponseParent)",
      "void MessageMetadataResponse.setReplies(List)", "String MessageMetadataResponse.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    MessageMetadataResponse actualMessageMetadataResponse = new MessageMetadataResponse();
    MessageMetadataResponse actualFormRepliesResult = actualMessageMetadataResponse.formReplies(new ArrayList<>());
    MessageMetadataResponse actualForwardsResult = actualMessageMetadataResponse.forwards(new ArrayList<>());
    MessageMetadataResponse actualMessageIdResult = actualMessageMetadataResponse.messageId("42");
    MessageMetadataResponse actualParentResult = actualMessageMetadataResponse
        .parent(new MessageMetadataResponseParent());
    MessageMetadataResponse actualRepliesResult = actualMessageMetadataResponse.replies(new ArrayList<>());
    ...
    assertEquals("class MessageMetadataResponse {\n" + "    messageId: 42\n"
