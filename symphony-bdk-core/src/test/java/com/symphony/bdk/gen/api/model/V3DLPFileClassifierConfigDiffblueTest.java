...
class V3DLPFileClassifierConfigDiffblueTest {
   ...
   *
   * <p>Method under test: {@link V3DLPFileClassifierConfig#putClassifiersItem(String, String)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V3DLPFileClassifierConfig V3DLPFileClassifierConfig.putClassifiersItem(String, String)"
  })
  void testPutClassifiersItem() {
    ...
    // Act
    V3DLPFileClassifierConfig actualPutClassifiersItemResult =
        v3dlpFileClassifierConfig.putClassifiersItem("Key", "Classifiers Item");

    // Assert
    assertSame(v3dlpFileClassifierConfig, actualPutClassifiersItemResult);
  }

  /**
   * Test {@link V3DLPFileClassifierConfig#addApplicableFileTypesItem(String)}.
   *
   * <p>Method under test: {@link V3DLPFileClassifierConfig#addApplicableFileTypesItem(String)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V3DLPFileClassifierConfig V3DLPFileClassifierConfig.addApplicableFileTypesItem(String)"
  })
  void testAddApplicableFileTypesItem() {
    ...
    // Act
    V3DLPFileClassifierConfig actualAddApplicableFileTypesItemResult =
        v3dlpFileClassifierConfig.addApplicableFileTypesItem("Applicable File Types Item");

    // Assert
    assertSame(v3dlpFileClassifierConfig, actualAddApplicableFileTypesItemResult);
  }

  /**
   * Test {@link V3DLPFileClassifierConfig#equals(Object)}, and {@link
   * V3DLPFileClassifierConfig#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V3DLPFileClassifierConfig.equals(Object)",
    "int V3DLPFileClassifierConfig.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v3dlpFileClassifierConfig.hashCode(), v3dlpFileClassifierConfig2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V3DLPFileClassifierConfig#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V3DLPFileClassifierConfig.<init>()",
    ...
    "List V3DLPFileClassifierConfig.getApplicableFileTypes()",
    "Map V3DLPFileClassifierConfig.getClassifiers()",
    "void V3DLPFileClassifierConfig.setApplicableFileTypes(List)",
    "void V3DLPFileClassifierConfig.setClassifiers(Map)",
    "String V3DLPFileClassifierConfig.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPFileClassifierConfig actualV3dlpFileClassifierConfig = new V3DLPFileClassifierConfig();
    V3DLPFileClassifierConfig actualApplicableFileTypesResult =
        actualV3dlpFileClassifierConfig.applicableFileTypes(new ArrayList<>());
    V3DLPFileClassifierConfig actualClassifiersResult =
        actualV3dlpFileClassifierConfig.classifiers(new HashMap<>());
    ...
    List<String> actualApplicableFileTypes =
        actualV3dlpFileClassifierConfig.getApplicableFileTypes();
