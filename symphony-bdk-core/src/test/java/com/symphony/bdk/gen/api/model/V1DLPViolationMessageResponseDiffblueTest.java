...
class V1DLPViolationMessageResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V1DLPViolationMessageResponse#addViolationsItem(V1DLPViolationMessage)}
   */
  @Test
  ...
  void testAddViolationsItem() {
    // Arrange
    V1DLPViolationMessageResponse v1dlpViolationMessageResponse = new V1DLPViolationMessageResponse();

    // Act and Assert
    assertSame(v1dlpViolationMessageResponse,
        v1dlpViolationMessageResponse.addViolationsItem(new V1DLPViolationMessage()));
  }

  /**
   * Test {@link V1DLPViolationMessageResponse#equals(Object)}, and {@link V1DLPViolationMessageResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V1DLPViolationMessageResponse.equals(Object)",
      "int V1DLPViolationMessageResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1DLPViolationMessageResponse v1dlpViolationMessageResponse = new V1DLPViolationMessageResponse();
    V1DLPViolationMessageResponse v1dlpViolationMessageResponse2 = new V1DLPViolationMessageResponse();
    ...
    assertEquals(expectedHashCodeResult, v1dlpViolationMessageResponse2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPViolationMessageResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V1DLPViolationMessageResponse(), "Different type to V1DLPViolationMessageResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPViolationMessageResponse.<init>()",
      "String V1DLPViolationMessageResponse.getNextOffset()", "List V1DLPViolationMessageResponse.getViolations()",
      ...
      "void V1DLPViolationMessageResponse.setViolations(List)", "String V1DLPViolationMessageResponse.toString()",
      "V1DLPViolationMessageResponse V1DLPViolationMessageResponse.violations(List)"})
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPViolationMessageResponse actualV1dlpViolationMessageResponse = new V1DLPViolationMessageResponse();
    V1DLPViolationMessageResponse actualNextOffsetResult = actualV1dlpViolationMessageResponse
    ...
    V1DLPViolationMessageResponse actualViolationsResult = actualV1dlpViolationMessageResponse.violations(violations);
    ...
    List<V1DLPViolationMessage> actualViolations = actualV1dlpViolationMessageResponse.getViolations();

    // Assert
    assertEquals("Next Offset", actualNextOffset);
    assertEquals("class V1DLPViolationMessageResponse {\n    violations: []\n    nextOffset: Next Offset\n}",
