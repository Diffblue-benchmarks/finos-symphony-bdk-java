...
class MessageStatusDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test addReadItem(MessageStatusUser); given MessageStatus (default constructor) read ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageStatus MessageStatus.addReadItem(MessageStatusUser)"})
   ...
   */
  @Test
  @DisplayName("Test addDeliveredItem(MessageStatusUser); given MessageStatus (default constructor)")
  @Tag("MaintainedByDiffblue")
   ...
   */
  @Test
  @DisplayName("Test addDeliveredItem(MessageStatusUser); given MessageStatus (default constructor) delivered ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageStatus MessageStatus.addDeliveredItem(MessageStatusUser)"})
   ...
   */
  @Test
  @DisplayName("Test addSentItem(MessageStatusUser); given MessageStatus (default constructor) sent ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageStatus MessageStatus.addSentItem(MessageStatusUser)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageStatus.<init>()", "MessageStatus MessageStatus.author(MessageStatusUser)",
      "MessageStatus MessageStatus.delivered(List)", "MessageStatusUser MessageStatus.getAuthor()",
      ...
      "void MessageStatus.setAuthor(MessageStatusUser)", "void MessageStatus.setDelivered(List)",
      "void MessageStatus.setRead(List)", "void MessageStatus.setSent(List)", "String MessageStatus.toString()"})
