...
class RoomCreatedMessageAllOfDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link RoomCreatedMessageAllOf} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link RoomCreatedMessageAllOf#addKeywordsItem(RoomTag)}
   */
  @Test
  ...
  void testAddKeywordsItem_givenRoomCreatedMessageAllOf() {
    ...
    // Act and Assert
    assertSame(roomCreatedMessageAllOf, roomCreatedMessageAllOf.addKeywordsItem(new RoomTag()));
  }

  /**
   * Test {@link RoomCreatedMessageAllOf#addKeywordsItem(RoomTag)}.
   * <ul>
   *   <li>Given {@link RoomCreatedMessageAllOf} (default constructor) keywords {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RoomCreatedMessageAllOf#addKeywordsItem(RoomTag)}
   */
  @Test
  @DisplayName("Test addKeywordsItem(RoomTag); given RoomCreatedMessageAllOf (default constructor) keywords ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"RoomCreatedMessageAllOf RoomCreatedMessageAllOf.addKeywordsItem(RoomTag)"})
  ...
  /**
   * Test {@link RoomCreatedMessageAllOf#equals(Object)}, and {@link RoomCreatedMessageAllOf#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean RoomCreatedMessageAllOf.equals(Object)", "int RoomCreatedMessageAllOf.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, roomCreatedMessageAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link RoomCreatedMessageAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RoomCreatedMessageAllOf.<init>()",
      ...
      "Boolean RoomCreatedMessageAllOf.getCopyProtected()", "Long RoomCreatedMessageAllOf.getCreatedByUserId()",
      "Long RoomCreatedMessageAllOf.getCreationDate()", "String RoomCreatedMessageAllOf.getDescription()",
      "Boolean RoomCreatedMessageAllOf.getDiscoverable()", "List RoomCreatedMessageAllOf.getKeywords()",
      "Boolean RoomCreatedMessageAllOf.getMembersCanInvite()", "String RoomCreatedMessageAllOf.getName()",
      "Boolean RoomCreatedMessageAllOf.getPublic()", "Boolean RoomCreatedMessageAllOf.getReadOnly()",
      ...
      "void RoomCreatedMessageAllOf.setCopyProtected(Boolean)", "void RoomCreatedMessageAllOf.setCreatedByUserId(Long)",
      "void RoomCreatedMessageAllOf.setCreationDate(Long)", "void RoomCreatedMessageAllOf.setDescription(String)",
      "void RoomCreatedMessageAllOf.setDiscoverable(Boolean)", "void RoomCreatedMessageAllOf.setKeywords(List)",
      "void RoomCreatedMessageAllOf.setMembersCanInvite(Boolean)", "void RoomCreatedMessageAllOf.setName(String)",
      "void RoomCreatedMessageAllOf.setPublic(Boolean)", "void RoomCreatedMessageAllOf.setReadOnly(Boolean)",
  ...
  void testGettersAndSetters() {
    ...
    RoomCreatedMessageAllOf actualCopyProtectedResult = actualRoomCreatedMessageAllOf.copyProtected(true);
    RoomCreatedMessageAllOf actualCreatedByUserIdResult = actualRoomCreatedMessageAllOf.createdByUserId(1L);
    RoomCreatedMessageAllOf actualCreationDateResult = actualRoomCreatedMessageAllOf.creationDate(1L);
    RoomCreatedMessageAllOf actualDescriptionResult = actualRoomCreatedMessageAllOf
        .description("The characteristics of someone or something");
    RoomCreatedMessageAllOf actualDiscoverableResult = actualRoomCreatedMessageAllOf.discoverable(true);
    RoomCreatedMessageAllOf actualKeywordsResult = actualRoomCreatedMessageAllOf.keywords(new ArrayList<>());
    RoomCreatedMessageAllOf actualMembersCanInviteResult = actualRoomCreatedMessageAllOf.membersCanInvite(true);
    ...
    assertEquals("class RoomCreatedMessageAllOf {\n" + "    creationDate: 1\n" + "    name: Name\n"
        + "    keywords: []\n" + "    description: The characteristics of someone or something\n"
        + "    createdByUserId: 1\n" + "    readOnly: true\n" + "    discoverable: true\n" + "    _public: true\n"
