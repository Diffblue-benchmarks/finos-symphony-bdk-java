...
class MessageAllOfDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageAllOf.<init>()", "MessageAllOf MessageAllOf.fromUserId(Long)",
      "Long MessageAllOf.getFromUserId()", "String MessageAllOf.getMessage()",
      "MessageAllOf MessageAllOf.message(String)", "void MessageAllOf.setFromUserId(Long)",
      "void MessageAllOf.setMessage(String)", "String MessageAllOf.toString()"})
  void testGettersAndSetters() {
    ...
    assertEquals("class MessageAllOf {\n    message: Not all who wander are lost\n    fromUserId: 1\n}",
