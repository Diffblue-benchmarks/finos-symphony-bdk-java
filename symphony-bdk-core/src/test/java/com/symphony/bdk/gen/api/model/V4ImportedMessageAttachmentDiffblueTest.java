...
class V4ImportedMessageAttachmentDiffblueTest {
  /**
   * Test {@link V4ImportedMessageAttachment#equals(Object)}, and {@link V4ImportedMessageAttachment#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean V4ImportedMessageAttachment.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link V4ImportedMessageAttachment#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V4ImportedMessageAttachment(), "Different type to V4ImportedMessageAttachment");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V4ImportedMessageAttachment.<init>()",
      ...
      "String V4ImportedMessageAttachment.getContent()", "String V4ImportedMessageAttachment.getFilename()",
      "void V4ImportedMessageAttachment.setContent(String)", "void V4ImportedMessageAttachment.setFilename(String)",
      "String V4ImportedMessageAttachment.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    V4ImportedMessageAttachment actualV4ImportedMessageAttachment = new V4ImportedMessageAttachment();
    V4ImportedMessageAttachment actualContentResult = actualV4ImportedMessageAttachment
        .content("Not all who wander are lost");
    V4ImportedMessageAttachment actualFilenameResult = actualV4ImportedMessageAttachment.filename("foo.txt");
