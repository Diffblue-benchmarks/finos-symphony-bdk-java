...
class V3HealthDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V3Health} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V3Health#putServicesItem(String, V3HealthComponent)}
   */
  @Test
  @DisplayName("Test putServicesItem(String, V3HealthComponent); given V3Health (default constructor)")
   ...
   * Test {@link V3Health#putServicesItem(String, V3HealthComponent)}.
   * <ul>
   *   <li>Given {@link V3Health} (default constructor) services {@link HashMap#HashMap()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V3Health#putServicesItem(String, V3HealthComponent)}
   */
  @Test
  @DisplayName("Test putServicesItem(String, V3HealthComponent); given V3Health (default constructor) services HashMap()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3Health V3Health.putServicesItem(String, V3HealthComponent)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3Health#putUsersItem(String, V3HealthComponent)}
   */
  @Test
   ...
   * Test {@link V3Health#putUsersItem(String, V3HealthComponent)}.
   * <ul>
   *   <li>Given {@link V3Health} (default constructor) users {@link HashMap#HashMap()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V3Health#putUsersItem(String, V3HealthComponent)}
   */
  @Test
  @DisplayName("Test putUsersItem(String, V3HealthComponent); given V3Health (default constructor) users HashMap()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3Health V3Health.putUsersItem(String, V3HealthComponent)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3Health#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3Health.<init>()", "Map V3Health.getServices()", "V3HealthStatus V3Health.getStatus()",
      "Map V3Health.getUsers()", "String V3Health.getVersion()", "V3Health V3Health.services(Map)",
      "void V3Health.setServices(Map)", "void V3Health.setStatus(V3HealthStatus)", "void V3Health.setUsers(Map)",
      "void V3Health.setVersion(String)", "V3Health V3Health.status(V3HealthStatus)", "String V3Health.toString()",
      "V3Health V3Health.users(Map)", "V3Health V3Health.version(String)"})
