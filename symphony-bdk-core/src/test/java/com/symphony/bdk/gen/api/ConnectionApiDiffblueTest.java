...
class ConnectionApiDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionAcceptPost(String, UserConnectionRequest)}
   */
  @Test
  @DisplayName("Test v1ConnectionAcceptPost(String, UserConnectionRequest); then throw ApiException")
  ...
  void testV1ConnectionAcceptPost_thenThrowApiException() throws ApiException {
    ...
    ConnectionApi connectionApi = new ConnectionApi(new ApiClientJersey2(mock(Client.class),
        "https://example.org/example", defaultHeaders, "https://example.org/example"));

    // Act and Assert
    assertThrows(ApiException.class, () -> connectionApi.v1ConnectionAcceptPost(null, new UserConnectionRequest()));
  }
  ...
  void testV1ConnectionAcceptPost_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionAcceptPost("ABC123", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionAcceptPostWithHttpInfo(String, UserConnectionRequest)}
   */
  @Test
  @DisplayName("Test v1ConnectionAcceptPostWithHttpInfo(String, UserConnectionRequest); then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionAcceptPostWithHttpInfo_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionAcceptPostWithHttpInfo("https://example.org/example", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionCreatePost(String, UserConnectionRequest)}
   */
  @Test
  @DisplayName("Test v1ConnectionCreatePost(String, UserConnectionRequest); then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionCreatePost_thenThrowApiException() throws ApiException {
    ...
    // Act and Assert
    assertThrows(ApiException.class, () -> connectionApi.v1ConnectionCreatePost(null, new UserConnectionRequest()));
  }
  ...
  void testV1ConnectionCreatePost_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionCreatePost("ABC123", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionCreatePostWithHttpInfo(String, UserConnectionRequest)}
   */
  @Test
  @DisplayName("Test v1ConnectionCreatePostWithHttpInfo(String, UserConnectionRequest); then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionCreatePostWithHttpInfo_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionCreatePostWithHttpInfo("https://example.org/example", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionListGet(String, String, String)}
   */
  @Test
  @DisplayName("Test v1ConnectionListGet(String, String, String); when 'null'; then throw ApiException")
  @Tag("MaintainedByDiffblue")
  ...
  void testV1ConnectionListGet_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionListGet(null, "Status", "User Ids"));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionListGetWithHttpInfo(String, String, String)}
   */
  @Test
  @DisplayName("Test v1ConnectionListGetWithHttpInfo(String, String, String); when 'null'; then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionListGetWithHttpInfo_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            ...
            .v1ConnectionListGetWithHttpInfo(null, "https://example.org/example", "https://example.org/example"));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionRejectPost(String, UserConnectionRequest)}
   */
  @Test
  @DisplayName("Test v1ConnectionRejectPost(String, UserConnectionRequest); then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionRejectPost_thenThrowApiException() throws ApiException {
    ...
    // Act and Assert
    assertThrows(ApiException.class, () -> connectionApi.v1ConnectionRejectPost(null, new UserConnectionRequest()));
  }
  ...
  void testV1ConnectionRejectPost_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionRejectPost("ABC123", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionRejectPostWithHttpInfo(String, UserConnectionRequest)}
   */
  @Test
  @DisplayName("Test v1ConnectionRejectPostWithHttpInfo(String, UserConnectionRequest); then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionRejectPostWithHttpInfo_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionRejectPostWithHttpInfo("https://example.org/example", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionUserUidRemovePost(String, Long)}
   */
  @Test
  @DisplayName("Test v1ConnectionUserUidRemovePost(String, Long); when 'null'; then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionUserUidRemovePost_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionUserUidRemovePost(null, 1L));
  }
  ...
  void testV1ConnectionUserUidRemovePost_whenNull_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionUserUidRemovePost("ABC123", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionUserUidRemovePostWithHttpInfo(String, Long)}
   */
  @Test
  @DisplayName("Test v1ConnectionUserUidRemovePostWithHttpInfo(String, Long); when 'null'; then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "com.symphony.bdk.http.api.ApiResponse ConnectionApi.v1ConnectionUserUidRemovePostWithHttpInfo(String, Long)"})
  void testV1ConnectionUserUidRemovePostWithHttpInfo_whenNull_thenThrowApiException() throws ApiException {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionUserUidRemovePostWithHttpInfo(null, 1L));
  }
  ...
  @MethodsUnderTest({
      "com.symphony.bdk.http.api.ApiResponse ConnectionApi.v1ConnectionUserUidRemovePostWithHttpInfo(String, Long)"})
  void testV1ConnectionUserUidRemovePostWithHttpInfo_whenNull_thenThrowApiException2() throws ApiException {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionUserUserIdInfoGet(String, String)}
   */
  @Test
  @DisplayName("Test v1ConnectionUserUserIdInfoGet(String, String); when 'null'; then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
  ...
  void testV1ConnectionUserUserIdInfoGet_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionUserUserIdInfoGet(null, "42"));
  }
  ...
  void testV1ConnectionUserUserIdInfoGet_whenNull_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(ApiException.class,
        () -> (new ConnectionApi(new ApiClientJersey2(mock(Client.class), "https://example.org/example", defaultHeaders,
            "https://example.org/example"))).v1ConnectionUserUserIdInfoGet("ABC123", null));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionApi#v1ConnectionUserUserIdInfoGetWithHttpInfo(String, String)}
   */
  @Test
  @DisplayName("Test v1ConnectionUserUserIdInfoGetWithHttpInfo(String, String); when 'null'; then throw ApiException")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "com.symphony.bdk.http.api.ApiResponse ConnectionApi.v1ConnectionUserUserIdInfoGetWithHttpInfo(String, String)"})
  void testV1ConnectionUserUserIdInfoGetWithHttpInfo_whenNull_thenThrowApiException() throws ApiException {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
  ...
  @MethodsUnderTest({
      "com.symphony.bdk.http.api.ApiResponse ConnectionApi.v1ConnectionUserUserIdInfoGetWithHttpInfo(String, String)"})
  void testV1ConnectionUserUserIdInfoGetWithHttpInfo_whenNull_thenThrowApiException2() throws ApiException {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
