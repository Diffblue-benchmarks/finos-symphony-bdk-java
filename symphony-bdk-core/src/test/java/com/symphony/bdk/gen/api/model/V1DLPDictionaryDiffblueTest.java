...
class V1DLPDictionaryDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpDictionary.hashCode(), v1dlpDictionary2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPDictionary#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPDictionary.<init>()",
    "V1DLPDictionary V1DLPDictionary.content(V1DLPDictionaryContent)",
    ...
    "void V1DLPDictionary.setDictionaryMetadata(V1DLPDictionaryMetadata)",
    "String V1DLPDictionary.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPDictionary actualV1dlpDictionary = new V1DLPDictionary();
    V1DLPDictionary actualContentResult =
        actualV1dlpDictionary.content(new V1DLPDictionaryContent());
    V1DLPDictionary actualDictionaryMetadataResult =
        actualV1dlpDictionary.dictionaryMetadata(new V1DLPDictionaryMetadata());
    ...
    V1DLPDictionaryMetadata actualDictionaryMetadata =
        actualV1dlpDictionary.getDictionaryMetadata();

    // Assert
    assertEquals(
        "class V1DLPDictionary {\n"
    ...
    assertSame(dictionaryMetadata, actualDictionaryMetadata);
  }
}
