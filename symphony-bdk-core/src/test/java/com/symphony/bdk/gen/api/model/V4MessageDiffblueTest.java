...
class V4MessageDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test addAttachmentsItem(V4AttachmentInfo); given V4Message (default constructor) attachments ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V4Message V4Message.addAttachmentsItem(V4AttachmentInfo)"})
  ...
  @MethodsUnderTest({"void V4Message.<init>()", "V4Message V4Message.attachments(List)",
      ...
      "V4Message V4Message.disclaimer(String)", "V4Message V4Message.externalRecipients(Boolean)",
      "List V4Message.getAttachments()", "String V4Message.getData()", "String V4Message.getDiagnostic()",
      "String V4Message.getDisclaimer()", "Boolean V4Message.getExternalRecipients()",
      "String V4Message.getInitialMessageId()", "Long V4Message.getInitialTimestamp()", "String V4Message.getMessage()",
      "String V4Message.getMessageId()", "String V4Message.getOriginalFormat()",
      "String V4Message.getParentMessageId()", "String V4Message.getReplacedBy()", "String V4Message.getReplacing()",
      "V4Message V4Message.getSharedMessage()", "String V4Message.getSid()", "Boolean V4Message.getSilent()",
      "V4Stream V4Message.getStream()", "Long V4Message.getTimestamp()", "V4User V4Message.getUser()",
      "String V4Message.getUserAgent()", "V4Message V4Message.initialMessageId(String)",
      "V4Message V4Message.initialTimestamp(Long)", "V4Message V4Message.message(String)",
      "V4Message V4Message.messageId(String)", "V4Message V4Message.originalFormat(String)",
      "V4Message V4Message.parentMessageId(String)", "V4Message V4Message.replacedBy(String)",
      "V4Message V4Message.replacing(String)", "void V4Message.setAttachments(List)", "void V4Message.setData(String)",
      "void V4Message.setDiagnostic(String)", "void V4Message.setDisclaimer(String)",
      "void V4Message.setExternalRecipients(Boolean)", "void V4Message.setInitialMessageId(String)",
      "void V4Message.setInitialTimestamp(Long)", "void V4Message.setMessage(String)",
      "void V4Message.setMessageId(String)", "void V4Message.setOriginalFormat(String)",
      "void V4Message.setParentMessageId(String)", "void V4Message.setReplacedBy(String)",
      "void V4Message.setReplacing(String)", "void V4Message.setSharedMessage(V4Message)",
      "void V4Message.setSid(String)", "void V4Message.setSilent(Boolean)", "void V4Message.setStream(V4Stream)",
      "void V4Message.setTimestamp(Long)", "void V4Message.setUser(V4User)", "void V4Message.setUserAgent(String)",
      "V4Message V4Message.sharedMessage(V4Message)", "V4Message V4Message.sid(String)",
      "V4Message V4Message.silent(Boolean)", "V4Message V4Message.stream(V4Stream)",
