...
class InfoBarriersApiDiffblueTest {
  ...
  void testV1AdminGroupGidMembershipAddPost_whenNull_thenThrowApiException() throws ApiException {
    ...
    ApiClientJersey2 apiClient =
        new ApiClientJersey2(
            ...
            defaultHeaders,
            "https://example.org/example");
    InfoBarriersApi infoBarriersApi = new InfoBarriersApi(apiClient);
  ...
  void testV1AdminGroupGidMembershipListGet_whenGid_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new InfoBarriersApi(apiClient).v1AdminGroupGidMembershipListGet("Gid", null, 1, 1));
  }
  ...
  void testV1AdminGroupGidMembershipListGet_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () ->
            new InfoBarriersApi(apiClient).v1AdminGroupGidMembershipListGet(null, "ABC123", 1, 1));
  }
  ...
  void testV1AdminGroupListGet_thenThrowApiException() throws ApiException {
    ...
    // Act and Assert
    assertThrows(
        ApiException.class, () -> new InfoBarriersApi(apiClient).v1AdminGroupListGet(null));
  }
  ...
  void testV1AdminGroupListGetWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new InfoBarriersApi(apiClient).v1AdminGroupListGetWithHttpInfo(null));
  }
  ...
  void testV1AdminPolicyListGet_thenThrowApiException() throws ApiException {
    ...
    // Act and Assert
    assertThrows(
        ApiException.class, () -> new InfoBarriersApi(apiClient).v1AdminPolicyListGet(null));
  }
  ...
  void testV1AdminPolicyListGetWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new InfoBarriersApi(apiClient).v1AdminPolicyListGetWithHttpInfo(null));
  }
}
