...
class UserGroupUpdateDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userGroupUpdate.hashCode(), userGroupUpdate2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserGroupUpdate#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserGroupUpdate.<init>()",
    "UserGroupUpdate UserGroupUpdate.active(Boolean)",
    "UserGroupUpdate UserGroupUpdate.area(String)",
    "UserGroupUpdate UserGroupUpdate.description(String)",
    "Boolean UserGroupUpdate.getActive()",
    "String UserGroupUpdate.getArea()",
    "String UserGroupUpdate.getDescription()",
    "String UserGroupUpdate.getName()",
    "UserGroupUpdate UserGroupUpdate.name(String)",
    "void UserGroupUpdate.setActive(Boolean)",
    "void UserGroupUpdate.setArea(String)",
    "void UserGroupUpdate.setDescription(String)",
    "void UserGroupUpdate.setName(String)",
    "String UserGroupUpdate.toString()"
  })
  void testGettersAndSetters() {
    ...
    UserGroupUpdate actualDescriptionResult =
        actualUserGroupUpdate.description("The characteristics of someone or something");
