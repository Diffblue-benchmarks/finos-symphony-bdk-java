...
class GroupItemDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(groupItem.hashCode(), groupItem2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link GroupItem#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void GroupItem.<init>()",
    "GroupItem GroupItem.addedBy(Long)",
    "Long GroupItem.getAddedBy()",
    "Long GroupItem.getId()",
    "GroupItem GroupItem.id(Long)",
    "void GroupItem.setAddedBy(Long)",
    "void GroupItem.setId(Long)",
    "String GroupItem.toString()"
  })
