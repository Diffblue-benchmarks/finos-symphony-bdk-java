...
class V2MessageAllOfDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V2MessageAllOf} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V2MessageAllOf#addAttachmentsItem(AttachmentInfo)}
   */
  @Test
  @DisplayName("Test addAttachmentsItem(AttachmentInfo); given V2MessageAllOf (default constructor)")
  ...
  void testAddAttachmentsItem_givenV2MessageAllOf() {
    ...
    // Act and Assert
    assertSame(v2MessageAllOf, v2MessageAllOf.addAttachmentsItem(new AttachmentInfo()));
  }

  /**
   * Test {@link V2MessageAllOf#addAttachmentsItem(AttachmentInfo)}.
   * <ul>
   *   <li>Given {@link V2MessageAllOf} (default constructor) attachments {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V2MessageAllOf#addAttachmentsItem(AttachmentInfo)}
   */
  @Test
  @DisplayName("Test addAttachmentsItem(AttachmentInfo); given V2MessageAllOf (default constructor) attachments ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2MessageAllOf V2MessageAllOf.addAttachmentsItem(AttachmentInfo)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v2MessageAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2MessageAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2MessageAllOf.<init>()", "V2MessageAllOf V2MessageAllOf.attachments(List)",
      "V2MessageAllOf V2MessageAllOf.fromUserId(Long)", "List V2MessageAllOf.getAttachments()",
      "Long V2MessageAllOf.getFromUserId()", "String V2MessageAllOf.getMessage()",
      "V2MessageAllOf V2MessageAllOf.message(String)", "void V2MessageAllOf.setAttachments(List)",
      "void V2MessageAllOf.setFromUserId(Long)", "void V2MessageAllOf.setMessage(String)",
  ...
  void testGettersAndSetters() {
    ...
    V2MessageAllOf actualMessageResult = actualV2MessageAllOf.message("Not all who wander are lost");
    ...
    assertEquals("class V2MessageAllOf {\n" + "    message: Not all who wander are lost\n" + "    fromUserId: 1\n"
