...
class V3DLPDictionaryMetaDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V3DLPDictionaryMeta.equals(Object)", "int V3DLPDictionaryMeta.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPDictionaryMeta#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPDictionaryMeta.<init>()", "V3DLPDictionaryMeta V3DLPDictionaryMeta.dictId(String)",
      "String V3DLPDictionaryMeta.getDictId()", "String V3DLPDictionaryMeta.getName()",
      "String V3DLPDictionaryMeta.getVersion()", "V3DLPDictionaryMeta V3DLPDictionaryMeta.name(String)",
      "void V3DLPDictionaryMeta.setDictId(String)", "void V3DLPDictionaryMeta.setName(String)",
      "void V3DLPDictionaryMeta.setVersion(String)", "String V3DLPDictionaryMeta.toString()",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class V3DLPDictionaryMeta {\n    dictId: 42\n    version: 1.0.2\n    name: Name\n}",
