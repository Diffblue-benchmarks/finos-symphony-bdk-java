...
class UserDataDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userData.hashCode(), userData2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserData#equals(Object)}
   */
  @Test
  ...
  @MethodsUnderTest({
    "void UserData.<init>()",
    "UserData UserData.emailAddress(String)",
    "UserData UserData.firstName(String)",
    "String UserData.getEmailAddress()",
    "String UserData.getFirstName()",
    "Long UserData.getId()",
    "String UserData.getLastName()",
    "String UserData.getUsername()",
    "UserData UserData.id(Long)",
    "UserData UserData.lastName(String)",
    "void UserData.setEmailAddress(String)",
    "void UserData.setFirstName(String)",
    "void UserData.setId(Long)",
    "void UserData.setLastName(String)",
    "void UserData.setUsername(String)",
    "String UserData.toString()",
    "UserData UserData.username(String)"
  })
