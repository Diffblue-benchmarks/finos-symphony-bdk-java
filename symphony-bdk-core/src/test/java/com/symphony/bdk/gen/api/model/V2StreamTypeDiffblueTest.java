...
class V2StreamTypeDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v2StreamType2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2StreamType#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2StreamType.<init>()", "String V2StreamType.getType()", "void V2StreamType.setType(String)",
      "String V2StreamType.toString()", "V2StreamType V2StreamType.type(String)"})
