...
class JwksDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link Jwks} (default constructor) keys {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Jwks#addKeysItem(Map)}
   */
  @Test
  ...
  void testAddKeysItem_givenJwksKeysArrayList() {
    ...
    // Act and Assert
    assertSame(jwks, jwks.addKeysItem(new HashMap<>()));
  }

  /**
   * Test {@link Jwks#addKeysItem(Map)}.
   * <ul>
   *   <li>Given {@link Jwks} (default constructor).</li>
   ...
   */
  @Test
  @DisplayName("Test addKeysItem(Map); given Jwks (default constructor); then return Keys size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Jwks Jwks.addKeysItem(Map)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, jwks2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link Jwks#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Jwks.<init>()", "List Jwks.getKeys()", "Jwks Jwks.keys(List)", "void Jwks.setKeys(List)",
