...
class UserDetailDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserDetail} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addFeaturesItem(Long)}
   */
  @Test
  ...
  void testAddFeaturesItem_givenUserDetail() {
    ...
    // Act and Assert
    assertSame(userDetail, userDetail.addFeaturesItem(1L));
  }

  /**
   * Test {@link UserDetail#addFeaturesItem(Long)}.
   * <ul>
   *   <li>Given {@link UserDetail} (default constructor) features {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addFeaturesItem(Long)}
   */
  @Test
  @DisplayName("Test addFeaturesItem(Long); given UserDetail (default constructor) features ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserDetail UserDetail.addFeaturesItem(Long)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addAppsItem(Long)}
   */
  @Test
  ...
  void testAddAppsItem_givenUserDetail() {
    ...
    // Act and Assert
    assertSame(userDetail, userDetail.addAppsItem(1L));
  }

  /**
   * Test {@link UserDetail#addAppsItem(Long)}.
   * <ul>
   *   <li>Given {@link UserDetail} (default constructor) apps {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addAppsItem(Long)}
   */
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addGroupsItem(Long)}
   */
  @Test
  ...
  void testAddGroupsItem_givenUserDetail() {
    ...
    // Act and Assert
    assertSame(userDetail, userDetail.addGroupsItem(1L));
  }

  /**
   * Test {@link UserDetail#addGroupsItem(Long)}.
   * <ul>
   *   <li>Given {@link UserDetail} (default constructor) groups {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addGroupsItem(Long)}
   */
  @Test
  @DisplayName("Test addGroupsItem(Long); given UserDetail (default constructor) groups ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserDetail UserDetail.addGroupsItem(Long)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addRolesItem(String)}
   */
  @Test
  ...
  void testAddRolesItem_givenUserDetail() {
    ...
    // Act and Assert
    assertSame(userDetail, userDetail.addRolesItem("Roles Item"));
  }

  /**
   * Test {@link UserDetail#addRolesItem(String)}.
   * <ul>
   *   <li>Given {@link UserDetail} (default constructor) roles {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addRolesItem(String)}
   */
  @Test
  @DisplayName("Test addRolesItem(String); given UserDetail (default constructor) roles ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserDetail UserDetail.addRolesItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addDisclaimersItem(Long)}
   */
  @Test
  ...
  void testAddDisclaimersItem_givenUserDetail() {
    ...
    // Act and Assert
    assertSame(userDetail, userDetail.addDisclaimersItem(1L));
  }

  /**
   * Test {@link UserDetail#addDisclaimersItem(Long)}.
   * <ul>
   *   <li>Given {@link UserDetail} (default constructor) disclaimers {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserDetail#addDisclaimersItem(Long)}
   */
  @Test
  @DisplayName("Test addDisclaimersItem(Long); given UserDetail (default constructor) disclaimers ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserDetail UserDetail.addDisclaimersItem(Long)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserDetail.<init>()", "UserDetail UserDetail.apps(List)",
      "UserDetail UserDetail.avatar(Avatar)", "UserDetail UserDetail.disclaimers(List)",
      "UserDetail UserDetail.features(List)", "List UserDetail.getApps()", "Avatar UserDetail.getAvatar()",
      "List UserDetail.getDisclaimers()", "List UserDetail.getFeatures()", "List UserDetail.getGroups()",
      "List UserDetail.getRoles()", "UserAttributes UserDetail.getUserAttributes()",
      "UserSystemInfo UserDetail.getUserSystemInfo()", "UserDetail UserDetail.groups(List)",
      "UserDetail UserDetail.roles(List)", "void UserDetail.setApps(List)", "void UserDetail.setAvatar(Avatar)",
      "void UserDetail.setDisclaimers(List)", "void UserDetail.setFeatures(List)", "void UserDetail.setGroups(List)",
      "void UserDetail.setRoles(List)", "void UserDetail.setUserAttributes(UserAttributes)",
      "void UserDetail.setUserSystemInfo(UserSystemInfo)", "String UserDetail.toString()",
      "UserDetail UserDetail.userAttributes(UserAttributes)", "UserDetail UserDetail.userSystemInfo(UserSystemInfo)"})
