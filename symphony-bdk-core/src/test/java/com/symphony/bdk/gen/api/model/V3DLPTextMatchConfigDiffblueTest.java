...
class V3DLPTextMatchConfigDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPTextMatchConfig#addDictionariesItem(V3DLPDictionaryMeta)}
   */
  @Test
  @DisplayName("Test addDictionariesItem(V3DLPDictionaryMeta)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3DLPTextMatchConfig V3DLPTextMatchConfig.addDictionariesItem(V3DLPDictionaryMeta)"})
  void testAddDictionariesItem() {
    // Arrange
    V3DLPTextMatchConfig v3dlpTextMatchConfig = new V3DLPTextMatchConfig();

    // Act and Assert
    assertSame(v3dlpTextMatchConfig, v3dlpTextMatchConfig.addDictionariesItem(new V3DLPDictionaryMeta()));
  }

  /**
   * Test {@link V3DLPTextMatchConfig#addApplicableFileTypesItem(String)}.
   * <p>
   * Method under test: {@link V3DLPTextMatchConfig#addApplicableFileTypesItem(String)}
   */
  @Test
  @DisplayName("Test addApplicableFileTypesItem(String)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3DLPTextMatchConfig V3DLPTextMatchConfig.addApplicableFileTypesItem(String)"})
  void testAddApplicableFileTypesItem() {
    // Arrange
    V3DLPTextMatchConfig v3dlpTextMatchConfig = new V3DLPTextMatchConfig();

    // Act and Assert
    assertSame(v3dlpTextMatchConfig, v3dlpTextMatchConfig.addApplicableFileTypesItem("Applicable File Types Item"));
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPTextMatchConfig.equals(Object)", "int V3DLPTextMatchConfig.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpTextMatchConfig2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPTextMatchConfig#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPTextMatchConfig.<init>()",
      ...
      "List V3DLPTextMatchConfig.getApplicableFileTypes()", "Integer V3DLPTextMatchConfig.getCountUniqueOccurrences()",
      "List V3DLPTextMatchConfig.getDictionaries()", "void V3DLPTextMatchConfig.setApplicableFileTypes(List)",
      "void V3DLPTextMatchConfig.setCountUniqueOccurrences(Integer)", "void V3DLPTextMatchConfig.setDictionaries(List)",
      "String V3DLPTextMatchConfig.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPTextMatchConfig actualV3dlpTextMatchConfig = new V3DLPTextMatchConfig();
    V3DLPTextMatchConfig actualApplicableFileTypesResult = actualV3dlpTextMatchConfig
        .applicableFileTypes(new ArrayList<>());
    V3DLPTextMatchConfig actualCountUniqueOccurrencesResult = actualV3dlpTextMatchConfig.countUniqueOccurrences(3);
    V3DLPTextMatchConfig actualDictionariesResult = actualV3dlpTextMatchConfig.dictionaries(new ArrayList<>());
    ...
    // Assert
    assertEquals("class V3DLPTextMatchConfig {\n" + "    dictionaries: []\n" + "    countUniqueOccurrences: 3\n"
