...
class AppAuthenticationKeyDiffblueTest {
  ...
  @MethodsUnderTest({"boolean AppAuthenticationKey.equals(Object)", "int AppAuthenticationKey.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, appAuthenticationKey2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AppAuthenticationKey#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AppAuthenticationKey.<init>()", "AppAuthenticationKey AppAuthenticationKey.action(String)",
      "AppAuthenticationKey AppAuthenticationKey.expirationDate(Long)", "String AppAuthenticationKey.getAction()",
      "Long AppAuthenticationKey.getExpirationDate()", "String AppAuthenticationKey.getKey()",
      "AppAuthenticationKey AppAuthenticationKey.key(String)", "void AppAuthenticationKey.setAction(String)",
      "void AppAuthenticationKey.setExpirationDate(Long)", "void AppAuthenticationKey.setKey(String)",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class AppAuthenticationKey {\n    key: Key\n    expirationDate: 1\n    action: Action\n}",
