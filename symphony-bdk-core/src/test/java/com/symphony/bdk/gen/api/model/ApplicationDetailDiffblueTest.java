...
class ApplicationDetailDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test addPermissionsItem(String); given ApplicationDetail (default constructor) permissions ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ApplicationDetail ApplicationDetail.addPermissionsItem(String)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link ApplicationDetail#addPropertiesItem(AppProperty)}
   */
  @Test
  ...
  void testAddPropertiesItem_givenApplicationDetail() {
    ...
    // Act
    ApplicationDetail actualAddPropertiesItemResult =
        applicationDetail.addPropertiesItem(new AppProperty());

    // Assert
    assertSame(applicationDetail, actualAddPropertiesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link ApplicationDetail} (default constructor) properties {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link ApplicationDetail#addPropertiesItem(AppProperty)}
  ...
  @Test
  @DisplayName(
      "Test addPropertiesItem(AppProperty); given ApplicationDetail (default constructor) properties ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"ApplicationDetail ApplicationDetail.addPropertiesItem(AppProperty)"})
  ...
  @MethodsUnderTest({
    ...
    "AppAuthenticationKeys ApplicationDetail.getAuthenticationKeys()",
    "String ApplicationDetail.getCert()",
    "String ApplicationDetail.getDescription()",
    "String ApplicationDetail.getIconUrl()",
    "AppNotification ApplicationDetail.getNotification()",
    "List ApplicationDetail.getPermissions()",
    "List ApplicationDetail.getProperties()",
    ...
    "ApplicationDetail ApplicationDetail.properties(List)",
    "void ApplicationDetail.setAllowOrigins(String)",
    "void ApplicationDetail.setApplicationInfo(ApplicationInfo)",
    "void ApplicationDetail.setAuthenticationKeys(AppAuthenticationKeys)",
    ...
    "void ApplicationDetail.setNotification(AppNotification)",
    "void ApplicationDetail.setPermissions(List)",
    "void ApplicationDetail.setProperties(List)",
  ...
  void testGettersAndSetters() {
    ...
    ApplicationDetail actualAuthenticationKeysResult =
        actualApplicationDetail.authenticationKeys(new AppAuthenticationKeys());
    ...
    ApplicationDetail actualNotificationResult =
        actualApplicationDetail.notification(new AppNotification());
    ApplicationDetail actualPermissionsResult =
        actualApplicationDetail.permissions(new ArrayList<>());
    ApplicationDetail actualPropertiesResult =
        actualApplicationDetail.properties(new ArrayList<>());
    ...
    AppAuthenticationKeys actualAuthenticationKeys =
        actualApplicationDetail.getAuthenticationKeys();
