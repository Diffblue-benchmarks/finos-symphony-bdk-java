...
class AttachmentPreviewDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean AttachmentPreview.equals(Object)",
    "int AttachmentPreview.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(attachmentPreview.hashCode(), attachmentPreview2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link AttachmentPreview#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void AttachmentPreview.<init>()",
    "AttachmentPreview AttachmentPreview.fileId(String)",
    "String AttachmentPreview.getFileId()",
    "Integer AttachmentPreview.getWidth()",
    "void AttachmentPreview.setFileId(String)",
    "void AttachmentPreview.setWidth(Integer)",
    "String AttachmentPreview.toString()",
    "AttachmentPreview AttachmentPreview.width(Integer)"
  })
