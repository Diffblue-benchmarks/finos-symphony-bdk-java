...
class DownloadReceiptCountDiffblueTest {
  ...
  @MethodsUnderTest({"boolean DownloadReceiptCount.equals(Object)", "int DownloadReceiptCount.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link DownloadReceiptCount#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DownloadReceiptCount.<init>()", "DownloadReceiptCount DownloadReceiptCount.fileName(String)",
      "String DownloadReceiptCount.getFileName()", "Long DownloadReceiptCount.getTimestamp()",
      "void DownloadReceiptCount.setFileName(String)", "void DownloadReceiptCount.setTimestamp(Long)",
      "DownloadReceiptCount DownloadReceiptCount.timestamp(Long)", "String DownloadReceiptCount.toString()"})
  void testGettersAndSetters() {
    ...
    // Assert
    assertEquals("class DownloadReceiptCount {\n    fileName: foo.txt\n    timestamp: 10\n}", actualToStringResult);
