...
class StreamAttachmentItemDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link StreamAttachmentItem} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link StreamAttachmentItem#addPreviewsItem(AttachmentPreview)}
   */
  @Test
  @DisplayName(
      "Test addPreviewsItem(AttachmentPreview); given StreamAttachmentItem (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "StreamAttachmentItem StreamAttachmentItem.addPreviewsItem(AttachmentPreview)"
  })
  void testAddPreviewsItem_givenStreamAttachmentItem() {
    ...
    // Act
    StreamAttachmentItem actualAddPreviewsItemResult =
        streamAttachmentItem.addPreviewsItem(new AttachmentPreview());

    // Assert
    assertSame(streamAttachmentItem, actualAddPreviewsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link StreamAttachmentItem} (default constructor) previews {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link StreamAttachmentItem#addPreviewsItem(AttachmentPreview)}
  ...
  @Test
  @DisplayName(
      "Test addPreviewsItem(AttachmentPreview); given StreamAttachmentItem (default constructor) previews ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "StreamAttachmentItem StreamAttachmentItem.addPreviewsItem(AttachmentPreview)"
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean StreamAttachmentItem.equals(Object)",
    "int StreamAttachmentItem.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(streamAttachmentItem.hashCode(), streamAttachmentItem2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link StreamAttachmentItem#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void StreamAttachmentItem.<init>()",
    "StreamAttachmentItem StreamAttachmentItem.contentType(String)",
    "StreamAttachmentItem StreamAttachmentItem.fileId(String)",
    "String StreamAttachmentItem.getContentType()",
    "String StreamAttachmentItem.getFileId()",
    "Long StreamAttachmentItem.getIngestionDate()",
    "String StreamAttachmentItem.getMessageId()",
    "String StreamAttachmentItem.getName()",
    "List StreamAttachmentItem.getPreviews()",
    "Long StreamAttachmentItem.getSize()",
    "Long StreamAttachmentItem.getUserId()",
    "StreamAttachmentItem StreamAttachmentItem.ingestionDate(Long)",
    "StreamAttachmentItem StreamAttachmentItem.messageId(String)",
    "StreamAttachmentItem StreamAttachmentItem.name(String)",
    "StreamAttachmentItem StreamAttachmentItem.previews(List)",
    "void StreamAttachmentItem.setContentType(String)",
    "void StreamAttachmentItem.setFileId(String)",
    "void StreamAttachmentItem.setIngestionDate(Long)",
    "void StreamAttachmentItem.setMessageId(String)",
    "void StreamAttachmentItem.setName(String)",
    "void StreamAttachmentItem.setPreviews(List)",
    "void StreamAttachmentItem.setSize(Long)",
    "void StreamAttachmentItem.setUserId(Long)",
    "StreamAttachmentItem StreamAttachmentItem.size(Long)",
    "String StreamAttachmentItem.toString()",
    "StreamAttachmentItem StreamAttachmentItem.userId(Long)"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    StreamAttachmentItem actualStreamAttachmentItem = new StreamAttachmentItem();
    StreamAttachmentItem actualContentTypeResult =
        actualStreamAttachmentItem.contentType("text/plain");
    ...
    StreamAttachmentItem actualPreviewsResult =
        actualStreamAttachmentItem.previews(new ArrayList<>());
