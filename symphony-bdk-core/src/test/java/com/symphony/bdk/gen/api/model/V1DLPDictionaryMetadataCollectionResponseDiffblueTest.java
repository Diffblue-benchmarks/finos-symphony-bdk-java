...
class V1DLPDictionaryMetadataCollectionResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V1DLPDictionaryMetadataCollectionResponse#addItemsItem(V1DLPDictionaryMetadata)}
   */
  @Test
  ...
  void testAddItemsItem() {
    // Arrange
    V1DLPDictionaryMetadataCollectionResponse v1dlpDictionaryMetadataCollectionResponse = new V1DLPDictionaryMetadataCollectionResponse();

    // Act and Assert
    assertSame(v1dlpDictionaryMetadataCollectionResponse,
        v1dlpDictionaryMetadataCollectionResponse.addItemsItem(new V1DLPDictionaryMetadata()));
  }

  /**
   * Test {@link V1DLPDictionaryMetadataCollectionResponse#equals(Object)}, and {@link V1DLPDictionaryMetadataCollectionResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V1DLPDictionaryMetadataCollectionResponse.equals(Object)",
      "int V1DLPDictionaryMetadataCollectionResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1DLPDictionaryMetadataCollectionResponse v1dlpDictionaryMetadataCollectionResponse = new V1DLPDictionaryMetadataCollectionResponse();
    V1DLPDictionaryMetadataCollectionResponse v1dlpDictionaryMetadataCollectionResponse2 = new V1DLPDictionaryMetadataCollectionResponse();

    // Act and Assert
    assertEquals(v1dlpDictionaryMetadataCollectionResponse, v1dlpDictionaryMetadataCollectionResponse2);
    int expectedHashCodeResult = v1dlpDictionaryMetadataCollectionResponse.hashCode();
    assertEquals(expectedHashCodeResult, v1dlpDictionaryMetadataCollectionResponse2.hashCode());
  }
  ...
  void testEqualsAndHashCode_whenOtherIsSame_thenReturnEqual() {
    ...
    // Act and Assert
    assertEquals(v1dlpDictionaryMetadataCollectionResponse, v1dlpDictionaryMetadataCollectionResponse);
    int expectedHashCodeResult = v1dlpDictionaryMetadataCollectionResponse.hashCode();
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPDictionaryMetadataCollectionResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(v1dlpDictionaryMetadataCollectionResponse, new V1DLPDictionaryMetadataCollectionResponse());
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V1DLPDictionaryMetadataCollectionResponse(),
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPDictionaryMetadataCollectionResponse.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPDictionaryMetadataCollectionResponse actualV1dlpDictionaryMetadataCollectionResponse = new V1DLPDictionaryMetadataCollectionResponse();
    V1DLPDictionaryMetadataCollectionResponse actualItemsResult = actualV1dlpDictionaryMetadataCollectionResponse
        .items(new ArrayList<>());
    V1DLPDictionaryMetadataCollectionResponse actualPageResult = actualV1dlpDictionaryMetadataCollectionResponse
        .page(1);
    V1DLPDictionaryMetadataCollectionResponse actualPageCountResult = actualV1dlpDictionaryMetadataCollectionResponse
        .pageCount(3);
    ...
    List<V1DLPDictionaryMetadata> actualItems = actualV1dlpDictionaryMetadataCollectionResponse.getItems();
    ...
    // Assert
    assertEquals("class V1DLPDictionaryMetadataCollectionResponse {\n    items: []\n    page: 1\n    pageCount: 3\n}",
