...
class V1DLPViolationStreamResponseDiffblueTest {
   ...
   * V1DLPViolationStreamResponse#addViolationsItem(V1DLPViolationStream)}
   */
  @Test
  ...
  void testAddViolationsItem() {
    ...
    // Act
    V1DLPViolationStreamResponse actualAddViolationsItemResult =
        v1dlpViolationStreamResponse.addViolationsItem(new V1DLPViolationStream());

    // Assert
    assertSame(v1dlpViolationStreamResponse, actualAddViolationsItemResult);
  }

  /**
   * Test {@link V1DLPViolationStreamResponse#equals(Object)}, and {@link
   * V1DLPViolationStreamResponse#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPViolationStreamResponse.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpViolationStreamResponse.hashCode(), v1dlpViolationStreamResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPViolationStreamResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new V1DLPViolationStreamResponse(), "Different type to V1DLPViolationStreamResponse");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPViolationStreamResponse.<init>()",
    "String V1DLPViolationStreamResponse.getNextOffset()",
    "List V1DLPViolationStreamResponse.getViolations()",
    ...
    "void V1DLPViolationStreamResponse.setViolations(List)",
    "String V1DLPViolationStreamResponse.toString()",
    "V1DLPViolationStreamResponse V1DLPViolationStreamResponse.violations(List)"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPViolationStreamResponse actualV1dlpViolationStreamResponse =
        new V1DLPViolationStreamResponse();
    V1DLPViolationStreamResponse actualNextOffsetResult =
        actualV1dlpViolationStreamResponse.nextOffset("Next Offset");
    ...
    V1DLPViolationStreamResponse actualViolationsResult =
        actualV1dlpViolationStreamResponse.violations(violations);
    ...
    List<V1DLPViolationStream> actualViolations =
        actualV1dlpViolationStreamResponse.getViolations();

    // Assert
    assertEquals("Next Offset", actualNextOffset);
    assertEquals(
        "class V1DLPViolationStreamResponse {\n    violations: []\n    nextOffset: Next Offset\n}",
