...
class MessageReceiptDetailDiffblueTest {
   ...
   * <p>
   * Method under test: {@link MessageReceiptDetail#addDownloadReceiptCountsItem(DownloadReceiptCount)}
   */
  @Test
  @DisplayName("Test addDownloadReceiptCountsItem(DownloadReceiptCount)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageReceiptDetail MessageReceiptDetail.addDownloadReceiptCountsItem(DownloadReceiptCount)"})
  void testAddDownloadReceiptCountsItem() {
    ...
    // Act and Assert
    assertSame(messageReceiptDetail, messageReceiptDetail.addDownloadReceiptCountsItem(new DownloadReceiptCount()));
  }

  /**
   * Test {@link MessageReceiptDetail#addDownloadReceiptCountsItem(DownloadReceiptCount)}.
   * <ul>
   *   <li>Given {@link MessageReceiptDetail} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageReceiptDetail#addDownloadReceiptCountsItem(DownloadReceiptCount)}
   */
  @Test
  @DisplayName("Test addDownloadReceiptCountsItem(DownloadReceiptCount); given MessageReceiptDetail (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageReceiptDetail MessageReceiptDetail.addDownloadReceiptCountsItem(DownloadReceiptCount)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean MessageReceiptDetail.equals(Object)", "int MessageReceiptDetail.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageReceiptDetail2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageReceiptDetail#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageReceiptDetail.<init>()",
      ...
      "Long MessageReceiptDetail.getDeliveryReceiptTimestamp()", "List MessageReceiptDetail.getDownloadReceiptCounts()",
      "Long MessageReceiptDetail.getEmailNotificationTimestamp()",
      "Long MessageReceiptDetail.getReadReceiptTimestamp()", "UserCompp MessageReceiptDetail.getUser()",
      ...
      "void MessageReceiptDetail.setReadReceiptTimestamp(Long)", "void MessageReceiptDetail.setUser(UserCompp)",
      "String MessageReceiptDetail.toString()", "MessageReceiptDetail MessageReceiptDetail.user(UserCompp)"})
  void testGettersAndSetters() {
    // Arrange and Act
    MessageReceiptDetail actualMessageReceiptDetail = new MessageReceiptDetail();
    MessageReceiptDetail actualDeliveryReceiptTimestampResult = actualMessageReceiptDetail.deliveryReceiptTimestamp(1L);
    MessageReceiptDetail actualDownloadReceiptCountsResult = actualMessageReceiptDetail
        .downloadReceiptCounts(new ArrayList<>());
    MessageReceiptDetail actualEmailNotificationTimestampResult = actualMessageReceiptDetail
        .emailNotificationTimestamp(1L);
    MessageReceiptDetail actualReadReceiptTimestampResult = actualMessageReceiptDetail.readReceiptTimestamp(1L);
    ...
    List<DownloadReceiptCount> actualDownloadReceiptCounts = actualMessageReceiptDetail.getDownloadReceiptCounts();
    Long actualEmailNotificationTimestamp = actualMessageReceiptDetail.getEmailNotificationTimestamp();
    ...
    // Assert
    assertEquals("class MessageReceiptDetail {\n" + "    user: class UserCompp {\n" + "        id: null\n"
        + "        username: null\n" + "        firstName: null\n" + "        lastName: null\n"
