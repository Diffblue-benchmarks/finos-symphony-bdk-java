...
class UserGroupMembershipDataDiffblueTest {
  /**
   * Test {@link UserGroupMembershipData#equals(Object)}, and {@link UserGroupMembershipData#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean UserGroupMembershipData.equals(Object)", "int UserGroupMembershipData.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupMembershipData#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupMembershipData.<init>()",
      "UserGroupMembershipData UserGroupMembershipData.active(Boolean)", "Boolean UserGroupMembershipData.getActive()",
      "UserGroupData UserGroupMembershipData.getGroup()", "String UserGroupMembershipData.getGroupId()",
      "String UserGroupMembershipData.getId()", "Long UserGroupMembershipData.getLastAddedDate()",
      "Long UserGroupMembershipData.getLastRemovedDate()", "MembershipData UserGroupMembershipData.getUser()",
      ...
      "void UserGroupMembershipData.setActive(Boolean)", "void UserGroupMembershipData.setGroup(UserGroupData)",
      "void UserGroupMembershipData.setGroupId(String)", "void UserGroupMembershipData.setId(String)",
      "void UserGroupMembershipData.setLastAddedDate(Long)", "void UserGroupMembershipData.setLastRemovedDate(Long)",
      "void UserGroupMembershipData.setUser(MembershipData)", "void UserGroupMembershipData.setUserId(Long)",
  ...
  void testGettersAndSetters() {
    ...
    UserGroupMembershipData actualGroupResult = actualUserGroupMembershipData.group(new UserGroupData());
    ...
    UserGroupMembershipData actualLastAddedDateResult = actualUserGroupMembershipData.lastAddedDate(1L);
    UserGroupMembershipData actualLastRemovedDateResult = actualUserGroupMembershipData.lastRemovedDate(1L);
    ...
    assertEquals("class UserGroupMembershipData {\n" + "    id: 42\n" + "    groupId: 42\n" + "    userId: 1\n"
