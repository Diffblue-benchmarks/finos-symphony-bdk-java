...
class UserLeftRoomMessageAllOfDiffblueTest {
  /**
   * Test {@link UserLeftRoomMessageAllOf#equals(Object)}, and {@link
   * UserLeftRoomMessageAllOf#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean UserLeftRoomMessageAllOf.equals(Object)",
    "int UserLeftRoomMessageAllOf.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userLeftRoomMessageAllOf.hashCode(), userLeftRoomMessageAllOf2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserLeftRoomMessageAllOf#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserLeftRoomMessageAllOf.<init>()",
    "Boolean UserLeftRoomMessageAllOf.getInformationBarrierRemediation()",
    "Long UserLeftRoomMessageAllOf.getMemberLeftUserId()",
    "Long UserLeftRoomMessageAllOf.getRemovedByUserId()",
    ...
    "void UserLeftRoomMessageAllOf.setRemovedByUserId(Long)",
    "String UserLeftRoomMessageAllOf.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    UserLeftRoomMessageAllOf actualUserLeftRoomMessageAllOf = new UserLeftRoomMessageAllOf();
    UserLeftRoomMessageAllOf actualInformationBarrierRemediationResult =
        actualUserLeftRoomMessageAllOf.informationBarrierRemediation(true);
    UserLeftRoomMessageAllOf actualMemberLeftUserIdResult =
        actualUserLeftRoomMessageAllOf.memberLeftUserId(1L);
    ...
    UserLeftRoomMessageAllOf actualRemovedByUserIdResult =
        actualUserLeftRoomMessageAllOf.removedByUserId(1L);
    String actualToStringResult = actualUserLeftRoomMessageAllOf.toString();
    Boolean actualInformationBarrierRemediation =
        actualUserLeftRoomMessageAllOf.getInformationBarrierRemediation();
