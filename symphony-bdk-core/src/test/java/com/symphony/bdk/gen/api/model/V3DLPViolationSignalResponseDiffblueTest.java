...
class V3DLPViolationSignalResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPViolationSignalResponse#addViolationsItem(V3DLPViolationSignal)}
   */
  @Test
  ...
  void testAddViolationsItem() {
    ...
    // Act and Assert
    assertSame(v3dlpViolationSignalResponse,
        v3dlpViolationSignalResponse.addViolationsItem(new V3DLPViolationSignal()));
  }

  /**
   * Test {@link V3DLPViolationSignalResponse#equals(Object)}, and {@link V3DLPViolationSignalResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPViolationSignalResponse.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPViolationSignalResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V3DLPViolationSignalResponse(), "Different type to V3DLPViolationSignalResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPViolationSignalResponse.<init>()",
      "String V3DLPViolationSignalResponse.getNextOffset()", "List V3DLPViolationSignalResponse.getViolations()",
      ...
      "void V3DLPViolationSignalResponse.setViolations(List)", "String V3DLPViolationSignalResponse.toString()",
      "V3DLPViolationSignalResponse V3DLPViolationSignalResponse.violations(List)"})
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPViolationSignalResponse actualV3dlpViolationSignalResponse = new V3DLPViolationSignalResponse();
    V3DLPViolationSignalResponse actualNextOffsetResult = actualV3dlpViolationSignalResponse.nextOffset("Next Offset");
    ...
    V3DLPViolationSignalResponse actualViolationsResult = actualV3dlpViolationSignalResponse.violations(violations);
    ...
    List<V3DLPViolationSignal> actualViolations = actualV3dlpViolationSignalResponse.getViolations();

    // Assert
    assertEquals("Next Offset", actualNextOffset);
    assertEquals("class V3DLPViolationSignalResponse {\n    violations: []\n    nextOffset: Next Offset\n}",
