...
class UserNameDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserName#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserName.<init>()", "String UserName.getUsername()", "void UserName.setUsername(String)",
      "String UserName.toString()", "UserName UserName.username(String)"})
