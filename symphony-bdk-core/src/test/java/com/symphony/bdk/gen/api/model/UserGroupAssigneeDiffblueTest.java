...
class UserGroupAssigneeDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link UserGroupAssignee} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link UserGroupAssignee#addUserRolesItem(String)}
   */
  @Test
  ...
  void testAddUserRolesItem_givenUserGroupAssignee() {
    ...
    // Act
    UserGroupAssignee actualAddUserRolesItemResult =
        userGroupAssignee.addUserRolesItem("User Roles Item");

    // Assert
    assertSame(userGroupAssignee, actualAddUserRolesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link UserGroupAssignee} (default constructor) userRoles {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link UserGroupAssignee#addUserRolesItem(String)}
  ...
  @Test
  @DisplayName(
      "Test addUserRolesItem(String); given UserGroupAssignee (default constructor) userRoles ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"UserGroupAssignee UserGroupAssignee.addUserRolesItem(String)"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean UserGroupAssignee.equals(Object)",
    "int UserGroupAssignee.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userGroupAssignee.hashCode(), userGroupAssignee2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserGroupAssignee#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserGroupAssignee.<init>()",
    "UserGroupAssignee UserGroupAssignee.active(Boolean)",
    "Boolean UserGroupAssignee.getActive()",
    "GroupRoleScope UserGroupAssignee.getGroup()",
    "String UserGroupAssignee.getGroupId()",
    "String UserGroupAssignee.getId()",
    "Long UserGroupAssignee.getLastAddedDate()",
    "Long UserGroupAssignee.getLastRemovedDate()",
    "UserCompp UserGroupAssignee.getUser()",
    "Long UserGroupAssignee.getUserId()",
    "List UserGroupAssignee.getUserRoles()",
    "UserGroupAssignee UserGroupAssignee.group(GroupRoleScope)",
    "UserGroupAssignee UserGroupAssignee.groupId(String)",
    "UserGroupAssignee UserGroupAssignee.id(String)",
    "UserGroupAssignee UserGroupAssignee.lastAddedDate(Long)",
    "UserGroupAssignee UserGroupAssignee.lastRemovedDate(Long)",
    "void UserGroupAssignee.setActive(Boolean)",
    "void UserGroupAssignee.setGroup(GroupRoleScope)",
    "void UserGroupAssignee.setGroupId(String)",
    "void UserGroupAssignee.setId(String)",
    "void UserGroupAssignee.setLastAddedDate(Long)",
    "void UserGroupAssignee.setLastRemovedDate(Long)",
    "void UserGroupAssignee.setUser(UserCompp)",
    "void UserGroupAssignee.setUserId(Long)",
    "void UserGroupAssignee.setUserRoles(List)",
    "String UserGroupAssignee.toString()",
    "UserGroupAssignee UserGroupAssignee.user(UserCompp)",
    "UserGroupAssignee UserGroupAssignee.userId(Long)",
    "UserGroupAssignee UserGroupAssignee.userRoles(List)"
  })
