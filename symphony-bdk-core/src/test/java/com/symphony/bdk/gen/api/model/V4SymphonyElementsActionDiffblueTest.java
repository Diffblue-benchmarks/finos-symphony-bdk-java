...
class V4SymphonyElementsActionDiffblueTest {
  /**
   * Test {@link V4SymphonyElementsAction#equals(Object)}, and {@link V4SymphonyElementsAction#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean V4SymphonyElementsAction.equals(Object)", "int V4SymphonyElementsAction.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v4SymphonyElementsAction2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V4SymphonyElementsAction#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V4SymphonyElementsAction.<init>()",
      ...
      "String V4SymphonyElementsAction.getFormId()", "String V4SymphonyElementsAction.getFormMessageId()",
      "Object V4SymphonyElementsAction.getFormValues()", "V4Stream V4SymphonyElementsAction.getStream()",
      "void V4SymphonyElementsAction.setFormId(String)", "void V4SymphonyElementsAction.setFormMessageId(String)",
      "void V4SymphonyElementsAction.setFormValues(Object)", "void V4SymphonyElementsAction.setStream(V4Stream)",
  ...
  void testGettersAndSetters() {
    ...
    V4SymphonyElementsAction actualFormMessageIdResult = actualV4SymphonyElementsAction.formMessageId("42");
    V4SymphonyElementsAction actualFormValuesResult = actualV4SymphonyElementsAction.formValues("Form Values");
