...
class V1DLPDictionaryMetadataResponseDiffblueTest {
  /**
   * Test {@link V1DLPDictionaryMetadataResponse#equals(Object)}, and {@link
   * V1DLPDictionaryMetadataResponse#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPDictionaryMetadataResponse.equals(Object)",
    "int V1DLPDictionaryMetadataResponse.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1DLPDictionaryMetadataResponse v1dlpDictionaryMetadataResponse =
        new V1DLPDictionaryMetadataResponse();
    V1DLPDictionaryMetadataResponse v1dlpDictionaryMetadataResponse2 =
        new V1DLPDictionaryMetadataResponse();

    // Act and Assert
    assertEquals(v1dlpDictionaryMetadataResponse, v1dlpDictionaryMetadataResponse2);
    assertEquals(
        v1dlpDictionaryMetadataResponse.hashCode(), v1dlpDictionaryMetadataResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPDictionaryMetadataResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(
        new V1DLPDictionaryMetadataResponse(), "Different type to V1DLPDictionaryMetadataResponse");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPDictionaryMetadataResponse.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPDictionaryMetadataResponse actualV1dlpDictionaryMetadataResponse =
        new V1DLPDictionaryMetadataResponse();
    V1DLPDictionaryMetadataResponse actualDataResult =
        actualV1dlpDictionaryMetadataResponse.data(new V1DLPDictionaryMetadata());
    ...
    // Assert
    assertEquals(
        "class V1DLPDictionaryMetadataResponse {\n"
