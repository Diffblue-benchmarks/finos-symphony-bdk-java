...
class V3DLPFileSizeConfigDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V3DLPFileSizeConfig.equals(Object)", "int V3DLPFileSizeConfig.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPFileSizeConfig#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPFileSizeConfig.<init>()", "Integer V3DLPFileSizeConfig.getSizeLimit()",
      "void V3DLPFileSizeConfig.setSizeLimit(Integer)", "V3DLPFileSizeConfig V3DLPFileSizeConfig.sizeLimit(Integer)",
