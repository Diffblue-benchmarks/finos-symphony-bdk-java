...
class MessageStreamDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageStream2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageStream#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageStream.<init>()", "String MessageStream.getId()", "String MessageStream.getName()",
      "String MessageStream.getStreamType()", "MessageStream MessageStream.id(String)",
      "MessageStream MessageStream.name(String)", "void MessageStream.setId(String)",
      "void MessageStream.setName(String)", "void MessageStream.setStreamType(String)",
      "MessageStream MessageStream.streamType(String)", "String MessageStream.toString()"})
  void testGettersAndSetters() {
    ...
    assertEquals("class MessageStream {\n    id: 42\n    name: Name\n    streamType: Stream Type\n}",
