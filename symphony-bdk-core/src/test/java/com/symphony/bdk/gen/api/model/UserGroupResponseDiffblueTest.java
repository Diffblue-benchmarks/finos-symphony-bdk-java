...
class UserGroupResponseDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean UserGroupResponse.equals(Object)",
    "int UserGroupResponse.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userGroupResponse.hashCode(), userGroupResponse2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserGroupResponse#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserGroupResponse.<init>()",
    "UserGroupResponse UserGroupResponse.active(Boolean)",
    "UserGroupResponse UserGroupResponse.area(String)",
    "UserGroupResponse UserGroupResponse.assigneeCount(Long)",
    "UserGroupResponse UserGroupResponse.createdDate(Long)",
    "UserGroupResponse UserGroupResponse.description(String)",
    "Boolean UserGroupResponse.getActive()",
    "String UserGroupResponse.getArea()",
    "Long UserGroupResponse.getAssigneeCount()",
    "Long UserGroupResponse.getCreatedDate()",
    "String UserGroupResponse.getDescription()",
    "String UserGroupResponse.getId()",
    "Long UserGroupResponse.getMemberCount()",
    "Long UserGroupResponse.getModifiedDate()",
    "String UserGroupResponse.getName()",
    "String UserGroupResponse.getType()",
    "UserGroupResponse UserGroupResponse.id(String)",
    "UserGroupResponse UserGroupResponse.memberCount(Long)",
    "UserGroupResponse UserGroupResponse.modifiedDate(Long)",
    "UserGroupResponse UserGroupResponse.name(String)",
    "void UserGroupResponse.setActive(Boolean)",
    "void UserGroupResponse.setArea(String)",
    "void UserGroupResponse.setAssigneeCount(Long)",
    "void UserGroupResponse.setCreatedDate(Long)",
    "void UserGroupResponse.setDescription(String)",
    "void UserGroupResponse.setId(String)",
    "void UserGroupResponse.setMemberCount(Long)",
    "void UserGroupResponse.setModifiedDate(Long)",
    "void UserGroupResponse.setName(String)",
    "void UserGroupResponse.setType(String)",
    "String UserGroupResponse.toString()",
  ...
  void testGettersAndSetters() {
    ...
    UserGroupResponse actualDescriptionResult =
        actualUserGroupResponse.description("The characteristics of someone or something");
