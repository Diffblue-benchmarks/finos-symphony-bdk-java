...
class V1DLPContentTypeDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPContentType#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPContentType.<init>()", "String V1DLPContentType.getType()",
      "void V1DLPContentType.setType(String)", "String V1DLPContentType.toString()",
