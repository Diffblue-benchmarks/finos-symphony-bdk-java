...
class AgentInfoDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, agentInfo2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AgentInfo#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AgentInfo.<init>()", "AgentInfo AgentInfo.commitId(String)",
      "String AgentInfo.getCommitId()", "String AgentInfo.getHostname()", "String AgentInfo.getIpAddress()",
      "Boolean AgentInfo.getMt()", "Boolean AgentInfo.getOnPrem()", "String AgentInfo.getServerFqdn()",
      "String AgentInfo.getUrl()", "String AgentInfo.getVersion()", "AgentInfo AgentInfo.hostname(String)",
      "AgentInfo AgentInfo.ipAddress(String)", "AgentInfo AgentInfo.mt(Boolean)", "AgentInfo AgentInfo.onPrem(Boolean)",
      "AgentInfo AgentInfo.serverFqdn(String)", "void AgentInfo.setCommitId(String)",
      "void AgentInfo.setHostname(String)", "void AgentInfo.setIpAddress(String)", "void AgentInfo.setMt(Boolean)",
      "void AgentInfo.setOnPrem(Boolean)", "void AgentInfo.setServerFqdn(String)", "void AgentInfo.setUrl(String)",
      "void AgentInfo.setVersion(String)", "String AgentInfo.toString()", "AgentInfo AgentInfo.url(String)",
