...
class V3DLPPolicyRequestDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPPolicyRequest#addScopesItem(String)}
   */
  @Test
  ...
  void testAddScopesItem() {
    ...
    // Act and Assert
    assertSame(v3dlpPolicyRequest, v3dlpPolicyRequest.addScopesItem("Scopes Item"));
  }

  /**
   * Test {@link V3DLPPolicyRequest#addAppliesToItem(V3DLPPolicyAppliesTo)}.
   * <p>
   * Method under test: {@link V3DLPPolicyRequest#addAppliesToItem(V3DLPPolicyAppliesTo)}
   */
  @Test
  @DisplayName("Test addAppliesToItem(V3DLPPolicyAppliesTo)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3DLPPolicyRequest V3DLPPolicyRequest.addAppliesToItem(V3DLPPolicyAppliesTo)"})
  void testAddAppliesToItem() {
    // Arrange
    V3DLPPolicyRequest v3dlpPolicyRequest = new V3DLPPolicyRequest();

    // Act and Assert
    assertSame(v3dlpPolicyRequest, v3dlpPolicyRequest.addAppliesToItem(new V3DLPPolicyAppliesTo()));
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPPolicyRequest.equals(Object)", "int V3DLPPolicyRequest.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpPolicyRequest2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPPolicyRequest#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPPolicyRequest.<init>()", "V3DLPPolicyRequest V3DLPPolicyRequest.appliesTo(List)",
      "List V3DLPPolicyRequest.getAppliesTo()", "String V3DLPPolicyRequest.getName()",
      "List V3DLPPolicyRequest.getScopes()", "V3DLPPolicyRequest V3DLPPolicyRequest.name(String)",
      "V3DLPPolicyRequest V3DLPPolicyRequest.scopes(List)", "void V3DLPPolicyRequest.setAppliesTo(List)",
      "void V3DLPPolicyRequest.setName(String)", "void V3DLPPolicyRequest.setScopes(List)",
      "String V3DLPPolicyRequest.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPPolicyRequest actualV3dlpPolicyRequest = new V3DLPPolicyRequest();
    V3DLPPolicyRequest actualAppliesToResult = actualV3dlpPolicyRequest.appliesTo(new ArrayList<>());
    ...
    assertEquals("class V3DLPPolicyRequest {\n    name: Name\n    scopes: []\n    appliesTo: []\n}",
