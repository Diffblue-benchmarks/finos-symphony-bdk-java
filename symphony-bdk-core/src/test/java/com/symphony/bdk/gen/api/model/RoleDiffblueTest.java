...
class RoleDiffblueTest {
  ...
  @MethodsUnderTest({"void Role.<init>()", "Role Role.description(String)", "String Role.getDescription()",
      "Long Role.getId()", "String Role.getName()", "Role Role.id(Long)", "Role Role.name(String)",
      "void Role.setDescription(String)", "void Role.setId(Long)", "void Role.setName(String)",
