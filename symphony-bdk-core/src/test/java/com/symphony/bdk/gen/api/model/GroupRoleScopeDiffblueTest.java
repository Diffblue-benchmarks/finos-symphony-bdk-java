...
class GroupRoleScopeDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(groupRoleScope.hashCode(), groupRoleScope2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link GroupRoleScope#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void GroupRoleScope.<init>()",
    "GroupRoleScope GroupRoleScope.active(Boolean)",
    "GroupRoleScope GroupRoleScope.area(String)",
    "Boolean GroupRoleScope.getActive()",
    "String GroupRoleScope.getArea()",
    "String GroupRoleScope.getId()",
    "String GroupRoleScope.getName()",
    "String GroupRoleScope.getType()",
    "GroupRoleScope GroupRoleScope.id(String)",
    "GroupRoleScope GroupRoleScope.name(String)",
    "void GroupRoleScope.setActive(Boolean)",
    "void GroupRoleScope.setArea(String)",
    "void GroupRoleScope.setId(String)",
    "void GroupRoleScope.setName(String)",
    "void GroupRoleScope.setType(String)",
    "String GroupRoleScope.toString()",
