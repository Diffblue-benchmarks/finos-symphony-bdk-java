...
class AppAuthenticationKeysDiffblueTest {
  /**
   * Test {@link AppAuthenticationKeys#equals(Object)}, and {@link AppAuthenticationKeys#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean AppAuthenticationKeys.equals(Object)", "int AppAuthenticationKeys.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, appAuthenticationKeys2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AppAuthenticationKeys#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AppAuthenticationKeys.<init>()",
      ...
      "void AppAuthenticationKeys.setPrevious(AppAuthenticationKey)", "String AppAuthenticationKeys.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    AppAuthenticationKeys actualAppAuthenticationKeys = new AppAuthenticationKeys();
    AppAuthenticationKeys actualCurrentResult = actualAppAuthenticationKeys.current(new AppAuthenticationKey());
    AppAuthenticationKeys actualPreviousResult = actualAppAuthenticationKeys.previous(new AppAuthenticationKey());
    ...
    // Assert
    assertEquals("class AppAuthenticationKeys {\n" + "    current: class AppAuthenticationKey {\n"
        + "        key: null\n" + "        expirationDate: null\n" + "        action: null\n" + "    }\n"
