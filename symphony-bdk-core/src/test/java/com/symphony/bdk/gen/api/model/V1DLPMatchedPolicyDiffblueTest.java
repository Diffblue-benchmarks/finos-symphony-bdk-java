...
class V1DLPMatchedPolicyDiffblueTest {
  ...
  @MethodsUnderTest({"boolean V1DLPMatchedPolicy.equals(Object)", "int V1DLPMatchedPolicy.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v1dlpMatchedPolicy2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPMatchedPolicy#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPMatchedPolicy.<init>()", "V1DLPMatchedPolicy V1DLPMatchedPolicy.diagnostic(String)",
      "String V1DLPMatchedPolicy.getDiagnostic()", "String V1DLPMatchedPolicy.getId()",
      "String V1DLPMatchedPolicy.getPolicyName()", "String V1DLPMatchedPolicy.getTerms()",
      "String V1DLPMatchedPolicy.getType()", "String V1DLPMatchedPolicy.getVersion()",
      "V1DLPMatchedPolicy V1DLPMatchedPolicy.id(String)", "V1DLPMatchedPolicy V1DLPMatchedPolicy.policyName(String)",
      "void V1DLPMatchedPolicy.setDiagnostic(String)", "void V1DLPMatchedPolicy.setId(String)",
      "void V1DLPMatchedPolicy.setPolicyName(String)", "void V1DLPMatchedPolicy.setTerms(String)",
      "void V1DLPMatchedPolicy.setType(String)", "void V1DLPMatchedPolicy.setVersion(String)",
      "V1DLPMatchedPolicy V1DLPMatchedPolicy.terms(String)", "String V1DLPMatchedPolicy.toString()",
      "V1DLPMatchedPolicy V1DLPMatchedPolicy.type(String)", "V1DLPMatchedPolicy V1DLPMatchedPolicy.version(String)"})
