...
class UserGroupResponseListDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserGroupResponseList} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupResponseList#addDataItem(UserGroupResponse)}
   */
  @Test
  @DisplayName("Test addDataItem(UserGroupResponse); given UserGroupResponseList (default constructor)")
  ...
  void testAddDataItem_givenUserGroupResponseList() {
    ...
    // Act and Assert
    assertSame(userGroupResponseList, userGroupResponseList.addDataItem(new UserGroupResponse()));
  }

  /**
   * Test {@link UserGroupResponseList#addDataItem(UserGroupResponse)}.
   * <ul>
   *   <li>Given {@link UserGroupResponseList} (default constructor) data {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupResponseList#addDataItem(UserGroupResponse)}
   */
  @Test
  @DisplayName("Test addDataItem(UserGroupResponse); given UserGroupResponseList (default constructor) data ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserGroupResponseList UserGroupResponseList.addDataItem(UserGroupResponse)"})
  ...
  /**
   * Test {@link UserGroupResponseList#equals(Object)}, and {@link UserGroupResponseList#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean UserGroupResponseList.equals(Object)", "int UserGroupResponseList.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, userGroupResponseList2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupResponseList#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupResponseList.<init>()", "UserGroupResponseList UserGroupResponseList.data(List)",
      "List UserGroupResponseList.getData()", "Pagination UserGroupResponseList.getPagination()",
      "UserGroupResponseList UserGroupResponseList.pagination(Pagination)", "void UserGroupResponseList.setData(List)",
      "void UserGroupResponseList.setPagination(Pagination)", "String UserGroupResponseList.toString()"})
  void testGettersAndSetters() {
    ...
    UserGroupResponseList actualPaginationResult = actualUserGroupResponseList.pagination(new Pagination());
