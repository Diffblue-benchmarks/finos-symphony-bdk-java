...
class MessageReceiptDetailResponseDiffblueTest {
  /**
   * Test {@link MessageReceiptDetailResponse#addDownloadReceiptCountsItem(MessageDownloadReceiptCount)}.
   * <p>
   * Method under test: {@link MessageReceiptDetailResponse#addDownloadReceiptCountsItem(MessageDownloadReceiptCount)}
   */
  @Test
  ...
  void testAddDownloadReceiptCountsItem() {
    ...
    // Act and Assert
    assertSame(messageReceiptDetailResponse,
   ...
   * Test {@link MessageReceiptDetailResponse#addDownloadReceiptCountsItem(MessageDownloadReceiptCount)}.
   * <ul>
   *   <li>Given {@link MessageReceiptDetailResponse} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageReceiptDetailResponse#addDownloadReceiptCountsItem(MessageDownloadReceiptCount)}
   */
  @Test
  @DisplayName("Test addDownloadReceiptCountsItem(MessageDownloadReceiptCount); given MessageReceiptDetailResponse (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "MessageReceiptDetailResponse MessageReceiptDetailResponse.addDownloadReceiptCountsItem(MessageDownloadReceiptCount)"})
   ...
   * <p>
   * Method under test: {@link MessageReceiptDetailResponse#addMessageReceiptDetailItem(MessageReceiptDetail)}
   */
  @Test
   ...
   */
  @Test
  @DisplayName("Test addMessageReceiptDetailItem(MessageReceiptDetail); given MessageReceiptDetailResponse (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "MessageReceiptDetailResponse MessageReceiptDetailResponse.addMessageReceiptDetailItem(MessageReceiptDetail)"})
  ...
  /**
   * Test {@link MessageReceiptDetailResponse#equals(Object)}, and {@link MessageReceiptDetailResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean MessageReceiptDetailResponse.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageReceiptDetailResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new MessageReceiptDetailResponse(), "Different type to MessageReceiptDetailResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageReceiptDetailResponse.<init>()",
      ...
      "Long MessageReceiptDetailResponse.getCreationDate()", "MessageUser MessageReceiptDetailResponse.getCreator()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    MessageReceiptDetailResponse actualMessageReceiptDetailResponse = new MessageReceiptDetailResponse();
    MessageReceiptDetailResponse actualCreationDateResult = actualMessageReceiptDetailResponse.creationDate(1L);
    MessageReceiptDetailResponse actualCreatorResult = actualMessageReceiptDetailResponse.creator(new MessageUser());
    MessageReceiptDetailResponse actualDeliveryReceiptCountResult = actualMessageReceiptDetailResponse
        .deliveryReceiptCount(3);
    MessageReceiptDetailResponse actualDownloadReceiptCountsResult = actualMessageReceiptDetailResponse
        .downloadReceiptCounts(new ArrayList<>());
    MessageReceiptDetailResponse actualEmailNotificationCountResult = actualMessageReceiptDetailResponse
        .emailNotificationCount(3);
    MessageReceiptDetailResponse actualMessageReceiptDetailResult = actualMessageReceiptDetailResponse
        .messageReceiptDetail(new ArrayList<>());
    MessageReceiptDetailResponse actualOnBehalfOfUserResult = actualMessageReceiptDetailResponse
        .onBehalfOfUser(new MessageUser());
    MessageReceiptDetailResponse actualPaginationResult = actualMessageReceiptDetailResponse
        .pagination(new Pagination());
    MessageReceiptDetailResponse actualReadReceiptCountResult = actualMessageReceiptDetailResponse.readReceiptCount(3);
    ...
    MessageReceiptDetailResponse actualStreamResult = actualMessageReceiptDetailResponse.stream(stream);
    ...
    Integer actualDeliveryReceiptCount = actualMessageReceiptDetailResponse.getDeliveryReceiptCount();
    List<MessageDownloadReceiptCount> actualDownloadReceiptCounts = actualMessageReceiptDetailResponse
        .getDownloadReceiptCounts();
    Integer actualEmailNotificationCount = actualMessageReceiptDetailResponse.getEmailNotificationCount();
    List<MessageReceiptDetail> actualMessageReceiptDetail = actualMessageReceiptDetailResponse
        .getMessageReceiptDetail();
    ...
    // Assert
    assertEquals("class MessageReceiptDetailResponse {\n" + "    creator: class MessageUser {\n" + "        id: null\n"
