...
class MessageReceiptDetailResponseDiffblueTest {
  ...
  void testAddDownloadReceiptCountsItem() {
    ...
    // Act
    MessageReceiptDetailResponse actualAddDownloadReceiptCountsItemResult =
        messageReceiptDetailResponse.addDownloadReceiptCountsItem(
            new MessageDownloadReceiptCount());

    // Assert
    assertSame(messageReceiptDetailResponse, actualAddDownloadReceiptCountsItemResult);
  }
  ...
  void testAddMessageReceiptDetailItem() {
    ...
    // Act
    MessageReceiptDetailResponse actualAddMessageReceiptDetailItemResult =
        messageReceiptDetailResponse.addMessageReceiptDetailItem(new MessageReceiptDetail());

    // Assert
    assertSame(messageReceiptDetailResponse, actualAddMessageReceiptDetailItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(messageReceiptDetailResponse.hashCode(), messageReceiptDetailResponse2.hashCode());
  }
