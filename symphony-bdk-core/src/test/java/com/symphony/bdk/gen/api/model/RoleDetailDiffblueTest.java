...
class RoleDetailDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test addUserTypesItem(String); given RoleDetail (default constructor) userTypes ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"RoleDetail RoleDetail.addUserTypesItem(String)"})
   ...
   */
  @Test
  @DisplayName("Test addOptionalActionsItem(String); given RoleDetail (default constructor) optionalActions ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"RoleDetail RoleDetail.addOptionalActionsItem(String)"})
