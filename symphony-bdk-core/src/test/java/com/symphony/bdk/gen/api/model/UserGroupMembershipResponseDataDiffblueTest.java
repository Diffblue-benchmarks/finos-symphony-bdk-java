...
class UserGroupMembershipResponseDataDiffblueTest {
  /**
   * Test {@link UserGroupMembershipResponseData#equals(Object)}, and {@link UserGroupMembershipResponseData#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean UserGroupMembershipResponseData.equals(Object)",
      "int UserGroupMembershipResponseData.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    UserGroupMembershipResponseData userGroupMembershipResponseData = new UserGroupMembershipResponseData();
    UserGroupMembershipResponseData userGroupMembershipResponseData2 = new UserGroupMembershipResponseData();
    ...
    assertEquals(expectedHashCodeResult, userGroupMembershipResponseData2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupMembershipResponseData#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new UserGroupMembershipResponseData(), "Different type to UserGroupMembershipResponseData");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupMembershipResponseData.<init>()",
      ...
      "String UserGroupMembershipResponseData.getGroupId()", "String UserGroupMembershipResponseData.getId()",
      "Long UserGroupMembershipResponseData.getLastAddedDate()",
      "Long UserGroupMembershipResponseData.getLastRemovedDate()",
      "UserCompp UserGroupMembershipResponseData.getUser()", "Long UserGroupMembershipResponseData.getUserId()",
      ...
      "void UserGroupMembershipResponseData.setGroupId(String)", "void UserGroupMembershipResponseData.setId(String)",
      "void UserGroupMembershipResponseData.setLastAddedDate(Long)",
      "void UserGroupMembershipResponseData.setLastRemovedDate(Long)",
      "void UserGroupMembershipResponseData.setUser(UserCompp)", "void UserGroupMembershipResponseData.setUserId(Long)",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    UserGroupMembershipResponseData actualUserGroupMembershipResponseData = new UserGroupMembershipResponseData();
    UserGroupMembershipResponseData actualActiveResult = actualUserGroupMembershipResponseData.active(true);
    UserGroupMembershipResponseData actualGroupResult = actualUserGroupMembershipResponseData
        .group(new GroupRoleScope());
    UserGroupMembershipResponseData actualGroupIdResult = actualUserGroupMembershipResponseData.groupId("42");
    UserGroupMembershipResponseData actualIdResult = actualUserGroupMembershipResponseData.id("42");
    UserGroupMembershipResponseData actualLastAddedDateResult = actualUserGroupMembershipResponseData.lastAddedDate(1L);
    UserGroupMembershipResponseData actualLastRemovedDateResult = actualUserGroupMembershipResponseData
        .lastRemovedDate(1L);
    ...
    UserGroupMembershipResponseData actualUserResult = actualUserGroupMembershipResponseData.user(user);
    UserGroupMembershipResponseData actualUserIdResult = actualUserGroupMembershipResponseData.userId(1L);
    ...
    assertEquals("class UserGroupMembershipResponseData {\n" + "    id: 42\n" + "    groupId: 42\n"
