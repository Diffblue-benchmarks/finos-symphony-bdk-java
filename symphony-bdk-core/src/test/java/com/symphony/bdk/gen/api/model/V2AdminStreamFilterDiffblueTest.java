...
class V2AdminStreamFilterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V2AdminStreamFilter} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link V2AdminStreamFilter#addStreamTypesItem(V2AdminStreamType)}
   */
  @Test
  @DisplayName(
      "Test addStreamTypesItem(V2AdminStreamType); given V2AdminStreamFilter (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V2AdminStreamFilter V2AdminStreamFilter.addStreamTypesItem(V2AdminStreamType)"
  })
  void testAddStreamTypesItem_givenV2AdminStreamFilter() {
    ...
    // Act
    V2AdminStreamFilter actualAddStreamTypesItemResult =
        v2AdminStreamFilter.addStreamTypesItem(new V2AdminStreamType());

    // Assert
    assertSame(v2AdminStreamFilter, actualAddStreamTypesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2AdminStreamFilter} (default constructor) streamTypes {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2AdminStreamFilter#addStreamTypesItem(V2AdminStreamType)}
  ...
  @Test
  @DisplayName(
      "Test addStreamTypesItem(V2AdminStreamType); given V2AdminStreamFilter (default constructor) streamTypes ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "V2AdminStreamFilter V2AdminStreamFilter.addStreamTypesItem(V2AdminStreamType)"
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V2AdminStreamFilter.equals(Object)",
    "int V2AdminStreamFilter.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2AdminStreamFilter.hashCode(), v2AdminStreamFilter2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2AdminStreamFilter#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2AdminStreamFilter.<init>()",
    "V2AdminStreamFilter V2AdminStreamFilter.endDate(Long)",
    "Long V2AdminStreamFilter.getEndDate()",
    "String V2AdminStreamFilter.getOrigin()",
    "String V2AdminStreamFilter.getPrivacy()",
    "String V2AdminStreamFilter.getScope()",
    "Long V2AdminStreamFilter.getStartDate()",
    "String V2AdminStreamFilter.getStatus()",
    "List V2AdminStreamFilter.getStreamTypes()",
    "V2AdminStreamFilter V2AdminStreamFilter.origin(String)",
    "V2AdminStreamFilter V2AdminStreamFilter.privacy(String)",
    "V2AdminStreamFilter V2AdminStreamFilter.scope(String)",
    "void V2AdminStreamFilter.setEndDate(Long)",
    "void V2AdminStreamFilter.setOrigin(String)",
    "void V2AdminStreamFilter.setPrivacy(String)",
    "void V2AdminStreamFilter.setScope(String)",
    "void V2AdminStreamFilter.setStartDate(Long)",
    "void V2AdminStreamFilter.setStatus(String)",
    "void V2AdminStreamFilter.setStreamTypes(List)",
    "V2AdminStreamFilter V2AdminStreamFilter.startDate(Long)",
    "V2AdminStreamFilter V2AdminStreamFilter.status(String)",
    "V2AdminStreamFilter V2AdminStreamFilter.streamTypes(List)",
    "String V2AdminStreamFilter.toString()"
  })
  void testGettersAndSetters() {
    ...
    V2AdminStreamFilter actualStreamTypesResult =
        actualV2AdminStreamFilter.streamTypes(streamTypes);
