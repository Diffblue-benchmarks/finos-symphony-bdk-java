...
class RoomSearchResultsDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test addRoomsItem(V2RoomDetail); given RoomSearchResults (default constructor) rooms ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"RoomSearchResults RoomSearchResults.addRoomsItem(V2RoomDetail)"})
  ...
  @Test
  @DisplayName(
      "Test addFacetedMatchCountItem(FacetedMatchCount); given RoomSearchResults (default constructor)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
  ...
  void testAddFacetedMatchCountItem_givenRoomSearchResults() {
    ...
    // Act and Assert
    assertSame(
        roomSearchResults, roomSearchResults.addFacetedMatchCountItem(new FacetedMatchCount()));
  }
  ...
  @Test
  @DisplayName(
      "Test addFacetedMatchCountItem(FacetedMatchCount); given RoomSearchResults (default constructor) facetedMatchCount ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "RoomSearchResults RoomSearchResults.addFacetedMatchCountItem(FacetedMatchCount)"
