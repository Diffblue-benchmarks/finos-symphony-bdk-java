...
class V3DLPViolationMessageDiffblueTest {
  /**
   * Test {@link V3DLPViolationMessage#equals(Object)}, and {@link
   * V3DLPViolationMessage#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V3DLPViolationMessage.equals(Object)",
    "int V3DLPViolationMessage.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v3dlpViolationMessage.hashCode(), v3dlpViolationMessage2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V3DLPViolationMessage#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V3DLPViolationMessage.<init>()",
    "V3DLPViolationMessage V3DLPViolationMessage.diagnostic(String)",
    "String V3DLPViolationMessage.getDiagnostic()",
    "V4Message V3DLPViolationMessage.getMessage()",
    "V4Message V3DLPViolationMessage.getSharedMessage()",
    "V3DLPViolation V3DLPViolationMessage.getViolation()",
    "V3DLPViolationMessage V3DLPViolationMessage.message(V4Message)",
    "void V3DLPViolationMessage.setDiagnostic(String)",
    "void V3DLPViolationMessage.setMessage(V4Message)",
    "void V3DLPViolationMessage.setSharedMessage(V4Message)",
    "void V3DLPViolationMessage.setViolation(V3DLPViolation)",
    "V3DLPViolationMessage V3DLPViolationMessage.sharedMessage(V4Message)",
    "String V3DLPViolationMessage.toString()",
  ...
  void testGettersAndSetters() {
    ...
    V3DLPViolationMessage actualDiagnosticResult =
        actualV3dlpViolationMessage.diagnostic("Diagnostic");
    V3DLPViolationMessage actualMessageResult =
        actualV3dlpViolationMessage.message(new V4Message());
    ...
    V3DLPViolationMessage actualSharedMessageResult =
        actualV3dlpViolationMessage.sharedMessage(sharedMessage);
