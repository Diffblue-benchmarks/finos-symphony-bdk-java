...
class ProtocolDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, protocol2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link Protocol#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Protocol.<init>()", "String Protocol.getScheme()", "Protocol Protocol.scheme(String)",
      "void Protocol.setScheme(String)", "String Protocol.toString()"})
