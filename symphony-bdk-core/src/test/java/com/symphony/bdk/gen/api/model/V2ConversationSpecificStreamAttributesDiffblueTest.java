...
class V2ConversationSpecificStreamAttributesDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V2ConversationSpecificStreamAttributes} (default constructor) members {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V2ConversationSpecificStreamAttributes#addMembersItem(Long)}
   */
  @Test
  @DisplayName("Test addMembersItem(Long); given V2ConversationSpecificStreamAttributes (default constructor) members ArrayList()")
  ...
  void testAddMembersItem_givenV2ConversationSpecificStreamAttributesMembersArrayList() {
    // Arrange
    V2ConversationSpecificStreamAttributes v2ConversationSpecificStreamAttributes = new V2ConversationSpecificStreamAttributes();
    v2ConversationSpecificStreamAttributes.members(new ArrayList<>());

    // Act and Assert
    assertSame(v2ConversationSpecificStreamAttributes, v2ConversationSpecificStreamAttributes.addMembersItem(1L));
  }
  ...
  void testAddMembersItem_thenReturnMembersSizeIsOne() {
    ...
    // Act
    V2ConversationSpecificStreamAttributes actualAddMembersItemResult = v2ConversationSpecificStreamAttributes
        .addMembersItem(1L);
  ...
  /**
   * Test {@link V2ConversationSpecificStreamAttributes#equals(Object)}, and {@link V2ConversationSpecificStreamAttributes#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V2ConversationSpecificStreamAttributes.equals(Object)",
      "int V2ConversationSpecificStreamAttributes.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V2ConversationSpecificStreamAttributes v2ConversationSpecificStreamAttributes = new V2ConversationSpecificStreamAttributes();
    V2ConversationSpecificStreamAttributes v2ConversationSpecificStreamAttributes2 = new V2ConversationSpecificStreamAttributes();
    ...
    assertEquals(expectedHashCodeResult, v2ConversationSpecificStreamAttributes2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2ConversationSpecificStreamAttributes#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(v2ConversationSpecificStreamAttributes, new V2ConversationSpecificStreamAttributes());
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V2ConversationSpecificStreamAttributes(),
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2ConversationSpecificStreamAttributes.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V2ConversationSpecificStreamAttributes actualV2ConversationSpecificStreamAttributes = new V2ConversationSpecificStreamAttributes();
    V2ConversationSpecificStreamAttributes actualMembersResult = actualV2ConversationSpecificStreamAttributes
    ...
    // Assert
    assertEquals("class V2ConversationSpecificStreamAttributes {\n    members: []\n}", actualToStringResult);
