...
class V1DLPViolationMessageDiffblueTest {
  /**
   * Test {@link V1DLPViolationMessage#equals(Object)}, and {@link
   * V1DLPViolationMessage#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPViolationMessage.equals(Object)",
    "int V1DLPViolationMessage.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpViolationMessage.hashCode(), v1dlpViolationMessage2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPViolationMessage#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPViolationMessage.<init>()",
    "V1DLPViolationMessage V1DLPViolationMessage.diagnostic(String)",
    "String V1DLPViolationMessage.getDiagnostic()",
    "V4Message V1DLPViolationMessage.getMessage()",
    "V1DLPViolation V1DLPViolationMessage.getViolation()",
    "V1DLPViolationMessage V1DLPViolationMessage.message(V4Message)",
    "void V1DLPViolationMessage.setDiagnostic(String)",
    "void V1DLPViolationMessage.setMessage(V4Message)",
    "void V1DLPViolationMessage.setViolation(V1DLPViolation)",
    "String V1DLPViolationMessage.toString()",
  ...
  void testGettersAndSetters() {
    ...
    V1DLPViolationMessage actualDiagnosticResult =
        actualV1dlpViolationMessage.diagnostic("Diagnostic");
    V1DLPViolationMessage actualMessageResult =
        actualV1dlpViolationMessage.message(new V4Message());
