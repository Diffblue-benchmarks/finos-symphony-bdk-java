...
class RoomMemberDemotedFromOwnerMessageAllOfDiffblueTest {
  /**
   * Test {@link RoomMemberDemotedFromOwnerMessageAllOf#equals(Object)}, and {@link RoomMemberDemotedFromOwnerMessageAllOf#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean RoomMemberDemotedFromOwnerMessageAllOf.equals(Object)",
      "int RoomMemberDemotedFromOwnerMessageAllOf.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    RoomMemberDemotedFromOwnerMessageAllOf roomMemberDemotedFromOwnerMessageAllOf = new RoomMemberDemotedFromOwnerMessageAllOf();
    RoomMemberDemotedFromOwnerMessageAllOf roomMemberDemotedFromOwnerMessageAllOf2 = new RoomMemberDemotedFromOwnerMessageAllOf();
   ...
   * </ul>
   * <p>
   * Method under test: {@link RoomMemberDemotedFromOwnerMessageAllOf#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsDifferent_thenReturnNotEqual2() {
    ...
    // Act and Assert
    assertNotEquals(roomMemberDemotedFromOwnerMessageAllOf, new RoomMemberDemotedFromOwnerMessageAllOf());
  }
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new RoomMemberDemotedFromOwnerMessageAllOf(),
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RoomMemberDemotedFromOwnerMessageAllOf.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    RoomMemberDemotedFromOwnerMessageAllOf actualRoomMemberDemotedFromOwnerMessageAllOf = new RoomMemberDemotedFromOwnerMessageAllOf();
    RoomMemberDemotedFromOwnerMessageAllOf actualDemotedByUserIdResult = actualRoomMemberDemotedFromOwnerMessageAllOf
        .demotedByUserId(1L);
    RoomMemberDemotedFromOwnerMessageAllOf actualDemotedUserIdResult = actualRoomMemberDemotedFromOwnerMessageAllOf
        .demotedUserId(1L);
    ...
    // Assert
    assertEquals("class RoomMemberDemotedFromOwnerMessageAllOf {\n    demotedByUserId: 1\n    demotedUserId: 1\n}",
