...
class UserGroupAssigneeResponseDiffblueTest {
  ...
  void testAddDataItem_givenUserGroupAssigneeResponse() {
    ...
    // Act
    UserGroupAssigneeResponse actualAddDataItemResult =
        userGroupAssigneeResponse.addDataItem(new UserGroupAssignee());

    // Assert
    assertSame(userGroupAssigneeResponse, actualAddDataItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userGroupAssigneeResponse.hashCode(), userGroupAssigneeResponse2.hashCode());
  }
