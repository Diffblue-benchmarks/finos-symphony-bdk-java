...
class UserGroupAssigneeResponseDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserGroupAssigneeResponse} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssigneeResponse#addDataItem(UserGroupAssignee)}
   */
  @Test
  @DisplayName("Test addDataItem(UserGroupAssignee); given UserGroupAssigneeResponse (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserGroupAssigneeResponse UserGroupAssigneeResponse.addDataItem(UserGroupAssignee)"})
  void testAddDataItem_givenUserGroupAssigneeResponse() {
    ...
    // Act and Assert
    assertSame(userGroupAssigneeResponse, userGroupAssigneeResponse.addDataItem(new UserGroupAssignee()));
  }

  /**
   * Test {@link UserGroupAssigneeResponse#addDataItem(UserGroupAssignee)}.
   * <ul>
   *   <li>Given {@link UserGroupAssigneeResponse} (default constructor) data {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssigneeResponse#addDataItem(UserGroupAssignee)}
   */
  @Test
  @DisplayName("Test addDataItem(UserGroupAssignee); given UserGroupAssigneeResponse (default constructor) data ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserGroupAssigneeResponse UserGroupAssigneeResponse.addDataItem(UserGroupAssignee)"})
  ...
  /**
   * Test {@link UserGroupAssigneeResponse#equals(Object)}, and {@link UserGroupAssigneeResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean UserGroupAssigneeResponse.equals(Object)", "int UserGroupAssigneeResponse.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssigneeResponse#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupAssigneeResponse.<init>()",
      "UserGroupAssigneeResponse UserGroupAssigneeResponse.data(List)", "List UserGroupAssigneeResponse.getData()",
      ...
      "void UserGroupAssigneeResponse.setData(List)", "void UserGroupAssigneeResponse.setPagination(Pagination)",
  ...
  void testGettersAndSetters() {
    ...
    UserGroupAssigneeResponse actualDataResult = actualUserGroupAssigneeResponse.data(new ArrayList<>());
    UserGroupAssigneeResponse actualPaginationResult = actualUserGroupAssigneeResponse.pagination(new Pagination());
