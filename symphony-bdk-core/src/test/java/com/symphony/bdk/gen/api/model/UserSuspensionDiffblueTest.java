...
class UserSuspensionDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userSuspension.hashCode(), userSuspension2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserSuspension#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserSuspension.<init>()",
    "Boolean UserSuspension.getSuspended()",
    "Long UserSuspension.getSuspendedUntil()",
    "String UserSuspension.getSuspensionReason()",
    "void UserSuspension.setSuspended(Boolean)",
    "void UserSuspension.setSuspendedUntil(Long)",
    "void UserSuspension.setSuspensionReason(String)",
    "UserSuspension UserSuspension.suspended(Boolean)",
    "UserSuspension UserSuspension.suspendedUntil(Long)",
    "UserSuspension UserSuspension.suspensionReason(String)",
  ...
  void testGettersAndSetters() {
    ...
    UserSuspension actualSuspensionReasonResult =
        actualUserSuspension.suspensionReason("Just cause");
