...
class MessageUserDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageUser#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageUser.<init>()", "Long MessageUser.getId()", "String MessageUser.getName()",
      "MessageUser MessageUser.id(Long)", "MessageUser MessageUser.name(String)", "void MessageUser.setId(Long)",
      "void MessageUser.setName(String)", "String MessageUser.toString()"})
