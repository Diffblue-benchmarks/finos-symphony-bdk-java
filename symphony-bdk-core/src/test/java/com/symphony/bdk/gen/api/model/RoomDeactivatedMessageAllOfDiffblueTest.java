...
class RoomDeactivatedMessageAllOfDiffblueTest {
  /**
   * Test {@link RoomDeactivatedMessageAllOf#equals(Object)}, and {@link RoomDeactivatedMessageAllOf#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean RoomDeactivatedMessageAllOf.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, roomDeactivatedMessageAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link RoomDeactivatedMessageAllOf#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new RoomDeactivatedMessageAllOf(), "Different type to RoomDeactivatedMessageAllOf");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RoomDeactivatedMessageAllOf.<init>()",
      ...
      "void RoomDeactivatedMessageAllOf.setDeactivatedByUserId(Long)", "String RoomDeactivatedMessageAllOf.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    RoomDeactivatedMessageAllOf actualRoomDeactivatedMessageAllOf = new RoomDeactivatedMessageAllOf();
    RoomDeactivatedMessageAllOf actualDeactivatedByUserIdResult = actualRoomDeactivatedMessageAllOf
        .deactivatedByUserId(1L);
    ...
    // Assert
    assertEquals("class RoomDeactivatedMessageAllOf {\n    deactivatedByUserId: 1\n}", actualToStringResult);
