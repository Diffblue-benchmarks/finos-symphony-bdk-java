...
class V1DLPPolicyRequestDiffblueTest {
   ...
   *
   * <p>Method under test: {@link V1DLPPolicyRequest#addContentTypesItem(String)}
   */
  @Test
  ...
  void testAddContentTypesItem() {
    ...
    // Act
    V1DLPPolicyRequest actualAddContentTypesItemResult =
        v1dlpPolicyRequest.addContentTypesItem("text/plain");

    // Assert
    assertSame(v1dlpPolicyRequest, actualAddContentTypesItemResult);
  }

  /**
   * Test {@link V1DLPPolicyRequest#addDictionaryIdsItem(String)}.
   *
   * <p>Method under test: {@link V1DLPPolicyRequest#addDictionaryIdsItem(String)}
   */
  @Test
  ...
  void testAddDictionaryIdsItem() {
    ...
    // Act
    V1DLPPolicyRequest actualAddDictionaryIdsItemResult =
        v1dlpPolicyRequest.addDictionaryIdsItem("Dictionary Ids Item");

    // Assert
    assertSame(v1dlpPolicyRequest, actualAddDictionaryIdsItemResult);
  }

  /**
   * Test {@link V1DLPPolicyRequest#addScopesItem(String)}.
   *
   * <p>Method under test: {@link V1DLPPolicyRequest#addScopesItem(String)}
   */
  @Test
  ...
  void testAddScopesItem() {
    ...
    // Act
    V1DLPPolicyRequest actualAddScopesItemResult = v1dlpPolicyRequest.addScopesItem("Scopes Item");

    // Assert
    assertSame(v1dlpPolicyRequest, actualAddScopesItemResult);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPPolicyRequest.equals(Object)",
    "int V1DLPPolicyRequest.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpPolicyRequest.hashCode(), v1dlpPolicyRequest2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPPolicyRequest#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPPolicyRequest.<init>()",
    "V1DLPPolicyRequest V1DLPPolicyRequest.contentTypes(List)",
    "V1DLPPolicyRequest V1DLPPolicyRequest.dictionaryIds(List)",
    "List V1DLPPolicyRequest.getContentTypes()",
    "List V1DLPPolicyRequest.getDictionaryIds()",
    "String V1DLPPolicyRequest.getName()",
    "List V1DLPPolicyRequest.getScopes()",
    "String V1DLPPolicyRequest.getType()",
    "V1DLPPolicyRequest V1DLPPolicyRequest.name(String)",
    "V1DLPPolicyRequest V1DLPPolicyRequest.scopes(List)",
    "void V1DLPPolicyRequest.setContentTypes(List)",
    "void V1DLPPolicyRequest.setDictionaryIds(List)",
    "void V1DLPPolicyRequest.setName(String)",
    "void V1DLPPolicyRequest.setScopes(List)",
    "void V1DLPPolicyRequest.setType(String)",
    "String V1DLPPolicyRequest.toString()",
    "V1DLPPolicyRequest V1DLPPolicyRequest.type(String)"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPPolicyRequest actualV1dlpPolicyRequest = new V1DLPPolicyRequest();
    V1DLPPolicyRequest actualContentTypesResult =
        actualV1dlpPolicyRequest.contentTypes(new ArrayList<>());
    V1DLPPolicyRequest actualDictionaryIdsResult =
        actualV1dlpPolicyRequest.dictionaryIds(new ArrayList<>());
