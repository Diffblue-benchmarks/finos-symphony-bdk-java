...
class V4GenericSystemEventDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V4GenericSystemEvent} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link V4GenericSystemEvent#putParametersItem(String, Object)}
   */
  @Test
  @DisplayName(
      "Test putParametersItem(String, Object); given V4GenericSystemEvent (default constructor)")
  ...
  void testPutParametersItem_givenV4GenericSystemEvent() {
    ...
    // Act
    V4GenericSystemEvent actualPutParametersItemResult =
        v4GenericSystemEvent.putParametersItem("Key", "Parameters Item");

    // Assert
    assertSame(v4GenericSystemEvent, actualPutParametersItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V4GenericSystemEvent} (default constructor) parameters {@link
   *       HashMap#HashMap()}.
   * </ul>
   *
   * <p>Method under test: {@link V4GenericSystemEvent#putParametersItem(String, Object)}
  ...
  @Test
  @DisplayName(
      "Test putParametersItem(String, Object); given V4GenericSystemEvent (default constructor) parameters HashMap()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V4GenericSystemEvent V4GenericSystemEvent.putParametersItem(String, Object)"})
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V4GenericSystemEvent.equals(Object)",
    "int V4GenericSystemEvent.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v4GenericSystemEvent.hashCode(), v4GenericSystemEvent2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V4GenericSystemEvent#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V4GenericSystemEvent.<init>()",
    "V4GenericSystemEvent V4GenericSystemEvent.eventSubtype(String)",
    "V4GenericSystemEvent V4GenericSystemEvent.eventTimestamp(Long)",
    "String V4GenericSystemEvent.getEventSubtype()",
    "Long V4GenericSystemEvent.getEventTimestamp()",
    "Map V4GenericSystemEvent.getParameters()",
    "String V4GenericSystemEvent.getSourceSystem()",
    "V4Stream V4GenericSystemEvent.getStream()",
    "V4GenericSystemEvent V4GenericSystemEvent.parameters(Map)",
    "void V4GenericSystemEvent.setEventSubtype(String)",
    "void V4GenericSystemEvent.setEventTimestamp(Long)",
    "void V4GenericSystemEvent.setParameters(Map)",
    "void V4GenericSystemEvent.setSourceSystem(String)",
    "void V4GenericSystemEvent.setStream(V4Stream)",
    "V4GenericSystemEvent V4GenericSystemEvent.sourceSystem(String)",
    "V4GenericSystemEvent V4GenericSystemEvent.stream(V4Stream)",
    "String V4GenericSystemEvent.toString()"
  })
  void testGettersAndSetters() {
    // Arrange and Act
    V4GenericSystemEvent actualV4GenericSystemEvent = new V4GenericSystemEvent();
    V4GenericSystemEvent actualEventSubtypeResult =
        actualV4GenericSystemEvent.eventSubtype("Event Subtype");
    V4GenericSystemEvent actualEventTimestampResult = actualV4GenericSystemEvent.eventTimestamp(1L);
    V4GenericSystemEvent actualParametersResult =
        actualV4GenericSystemEvent.parameters(new HashMap<>());
    ...
    V4GenericSystemEvent actualSourceSystemResult =
        actualV4GenericSystemEvent.sourceSystem("Source System");
