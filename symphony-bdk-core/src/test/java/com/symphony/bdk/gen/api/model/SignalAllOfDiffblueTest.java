...
class SignalAllOfDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, signalAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link SignalAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void SignalAllOf.<init>()", "String SignalAllOf.getId()", "Long SignalAllOf.getTimestamp()",
      "SignalAllOf SignalAllOf.id(String)", "void SignalAllOf.setId(String)", "void SignalAllOf.setTimestamp(Long)",
      "SignalAllOf SignalAllOf.timestamp(Long)", "String SignalAllOf.toString()"})
