...
class ConnectionRequestMessageAllOfDiffblueTest {
  /**
   * Test {@link ConnectionRequestMessageAllOf#equals(Object)}, and {@link ConnectionRequestMessageAllOf#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean ConnectionRequestMessageAllOf.equals(Object)",
      "int ConnectionRequestMessageAllOf.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    ConnectionRequestMessageAllOf connectionRequestMessageAllOf = new ConnectionRequestMessageAllOf();
    ConnectionRequestMessageAllOf connectionRequestMessageAllOf2 = new ConnectionRequestMessageAllOf();
    ...
    assertEquals(expectedHashCodeResult, connectionRequestMessageAllOf2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link ConnectionRequestMessageAllOf#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new ConnectionRequestMessageAllOf(), "Different type to ConnectionRequestMessageAllOf");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ConnectionRequestMessageAllOf.<init>()",
      ...
      "Long ConnectionRequestMessageAllOf.getRequestingUserId()", "String ConnectionRequestMessageAllOf.getStatus()",
      "Long ConnectionRequestMessageAllOf.getTargetUserId()", "Long ConnectionRequestMessageAllOf.getUpdatedAt()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    ConnectionRequestMessageAllOf actualConnectionRequestMessageAllOf = new ConnectionRequestMessageAllOf();
    ConnectionRequestMessageAllOf actualFirstRequestedAtResult = actualConnectionRequestMessageAllOf
        .firstRequestedAt(1L);
    ConnectionRequestMessageAllOf actualRequestCounterResult = actualConnectionRequestMessageAllOf.requestCounter(3);
    ConnectionRequestMessageAllOf actualRequestingUserIdResult = actualConnectionRequestMessageAllOf
        .requestingUserId(1L);
    ...
    ConnectionRequestMessageAllOf actualStatusResult = actualConnectionRequestMessageAllOf.status("Status");
    ConnectionRequestMessageAllOf actualTargetUserIdResult = actualConnectionRequestMessageAllOf.targetUserId(1L);
    ConnectionRequestMessageAllOf actualUpdatedAtResult = actualConnectionRequestMessageAllOf.updatedAt(1L);
    ...
    assertEquals("class ConnectionRequestMessageAllOf {\n" + "    requestingUserId: 1\n" + "    targetUserId: 1\n"
        + "    firstRequestedAt: 1\n" + "    updatedAt: 1\n" + "    requestCounter: 3\n" + "    status: Status\n" + "}",
