...
class RoomReactivatedMessageAllOfDiffblueTest {
  /**
   * Test {@link RoomReactivatedMessageAllOf#equals(Object)}, and {@link RoomReactivatedMessageAllOf#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean RoomReactivatedMessageAllOf.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link RoomReactivatedMessageAllOf#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new RoomReactivatedMessageAllOf(), "Different type to RoomReactivatedMessageAllOf");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RoomReactivatedMessageAllOf.<init>()",
      ...
      "void RoomReactivatedMessageAllOf.setReactivatedByUserId(Long)", "String RoomReactivatedMessageAllOf.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    RoomReactivatedMessageAllOf actualRoomReactivatedMessageAllOf = new RoomReactivatedMessageAllOf();
    RoomReactivatedMessageAllOf actualReactivatedByUserIdResult = actualRoomReactivatedMessageAllOf
        .reactivatedByUserId(1L);
    ...
    // Assert
    assertEquals("class RoomReactivatedMessageAllOf {\n    reactivatedByUserId: 1\n}", actualToStringResult);
