...
class UserGroupAssigneeUpdateDiffblueTest {
  /**
   * Test {@link UserGroupAssigneeUpdate#equals(Object)}, and {@link UserGroupAssigneeUpdate#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean UserGroupAssigneeUpdate.equals(Object)", "int UserGroupAssigneeUpdate.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, userGroupAssigneeUpdate2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssigneeUpdate#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupAssigneeUpdate.<init>()",
      "UserGroupAssigneeUpdate UserGroupAssigneeUpdate.current(Boolean)",
      "Boolean UserGroupAssigneeUpdate.getCurrent()", "void UserGroupAssigneeUpdate.setCurrent(Boolean)",
