...
class MessageDownloadReceiptCountDiffblueTest {
  /**
   * Test {@link MessageDownloadReceiptCount#equals(Object)}, and {@link MessageDownloadReceiptCount#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean MessageDownloadReceiptCount.equals(Object)",
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageDownloadReceiptCount2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageDownloadReceiptCount#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new MessageDownloadReceiptCount(), "Different type to MessageDownloadReceiptCount");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageDownloadReceiptCount.<init>()",
      ...
      "Long MessageDownloadReceiptCount.getCount()", "String MessageDownloadReceiptCount.getFileName()",
      "void MessageDownloadReceiptCount.setCount(Long)", "void MessageDownloadReceiptCount.setFileName(String)",
      "String MessageDownloadReceiptCount.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    MessageDownloadReceiptCount actualMessageDownloadReceiptCount = new MessageDownloadReceiptCount();
    MessageDownloadReceiptCount actualCountResult = actualMessageDownloadReceiptCount.count(3L);
    MessageDownloadReceiptCount actualFileNameResult = actualMessageDownloadReceiptCount.fileName("foo.txt");
    ...
    // Assert
    assertEquals("class MessageDownloadReceiptCount {\n    fileName: foo.txt\n    count: 3\n}", actualToStringResult);
