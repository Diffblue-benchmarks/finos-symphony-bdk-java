...
class TokenDiffblueTest {
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void Token.<init>()", "Token Token.authorizationToken(String)",
      "String Token.getAuthorizationToken()", "String Token.getName()", "String Token.getToken()",
      "Token Token.name(String)", "void Token.setAuthorizationToken(String)", "void Token.setName(String)",
      "void Token.setToken(String)", "String Token.toString()", "Token Token.token(String)"})
