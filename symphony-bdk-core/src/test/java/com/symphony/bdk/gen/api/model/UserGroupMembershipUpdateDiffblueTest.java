...
class UserGroupMembershipUpdateDiffblueTest {
  /**
   * Test {@link UserGroupMembershipUpdate#equals(Object)}, and {@link
   * UserGroupMembershipUpdate#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean UserGroupMembershipUpdate.equals(Object)",
    "int UserGroupMembershipUpdate.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userGroupMembershipUpdate.hashCode(), userGroupMembershipUpdate2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link UserGroupMembershipUpdate#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void UserGroupMembershipUpdate.<init>()",
    "UserGroupMembershipUpdate UserGroupMembershipUpdate.active(Boolean)",
    "Boolean UserGroupMembershipUpdate.getActive()",
    "void UserGroupMembershipUpdate.setActive(Boolean)",
