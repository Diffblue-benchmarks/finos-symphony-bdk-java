...
class V2RoomSearchCriteriaAllOfDiffblueTest {
  /**
   * Test {@link V2RoomSearchCriteriaAllOf#equals(Object)}, and {@link
   * V2RoomSearchCriteriaAllOf#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V2RoomSearchCriteriaAllOf.equals(Object)",
    "int V2RoomSearchCriteriaAllOf.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2RoomSearchCriteriaAllOf.hashCode(), v2RoomSearchCriteriaAllOf2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V2RoomSearchCriteriaAllOf#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V2RoomSearchCriteriaAllOf.<init>()",
    "String V2RoomSearchCriteriaAllOf.getSubType()",
  ...
  void testGettersAndSetters() {
    ...
    V2RoomSearchCriteriaAllOf actualSubTypeResult =
        actualV2RoomSearchCriteriaAllOf.subType("Sub Type");
