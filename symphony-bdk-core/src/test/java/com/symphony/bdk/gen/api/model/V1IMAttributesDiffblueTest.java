...
class V1IMAttributesDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1imAttributes.hashCode(), v1imAttributes2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1IMAttributes#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1IMAttributes.<init>()",
    "String V1IMAttributes.getPinnedMessageId()",
    "V1IMAttributes V1IMAttributes.pinnedMessageId(String)",
    "void V1IMAttributes.setPinnedMessageId(String)",
