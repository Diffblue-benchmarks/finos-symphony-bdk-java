...
class V2UserListDiffblueTest {
   ...
   */
  @Test
  @DisplayName("Test addUsersItem(UserV2); given V2UserList (default constructor) users ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2UserList V2UserList.addUsersItem(UserV2)"})
   ...
   */
  @Test
  @DisplayName("Test addErrorsItem(UserError); given V2UserList (default constructor) errors ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2UserList V2UserList.addErrorsItem(UserError)"})
