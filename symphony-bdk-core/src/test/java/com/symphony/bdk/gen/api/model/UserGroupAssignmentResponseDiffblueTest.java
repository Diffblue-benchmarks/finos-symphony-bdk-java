...
class UserGroupAssignmentResponseDiffblueTest {
  ...
  void testAddUserRolesItem_givenUserGroupAssignmentResponse() {
    ...
    // Act
    UserGroupAssignmentResponse actualAddUserRolesItemResult =
        userGroupAssignmentResponse.addUserRolesItem("User Roles Item");

    // Assert
    assertSame(userGroupAssignmentResponse, actualAddUserRolesItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(userGroupAssignmentResponse.hashCode(), userGroupAssignmentResponse2.hashCode());
  }
