...
class UserGroupAssignmentResponseDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserGroupAssignmentResponse} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssignmentResponse#addUserRolesItem(String)}
   */
  @Test
  @DisplayName("Test addUserRolesItem(String); given UserGroupAssignmentResponse (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserGroupAssignmentResponse UserGroupAssignmentResponse.addUserRolesItem(String)"})
  void testAddUserRolesItem_givenUserGroupAssignmentResponse() {
    ...
    // Act and Assert
    assertSame(userGroupAssignmentResponse, userGroupAssignmentResponse.addUserRolesItem("User Roles Item"));
  }

  /**
   * Test {@link UserGroupAssignmentResponse#addUserRolesItem(String)}.
   * <ul>
   *   <li>Given {@link UserGroupAssignmentResponse} (default constructor) userRoles {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssignmentResponse#addUserRolesItem(String)}
   */
  @Test
  @DisplayName("Test addUserRolesItem(String); given UserGroupAssignmentResponse (default constructor) userRoles ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserGroupAssignmentResponse UserGroupAssignmentResponse.addUserRolesItem(String)"})
  ...
  /**
   * Test {@link UserGroupAssignmentResponse#equals(Object)}, and {@link UserGroupAssignmentResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean UserGroupAssignmentResponse.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserGroupAssignmentResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new UserGroupAssignmentResponse(), "Different type to UserGroupAssignmentResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserGroupAssignmentResponse.<init>()",
      "UserGroupAssignmentResponse UserGroupAssignmentResponse.active(Boolean)",
      "Boolean UserGroupAssignmentResponse.getActive()", "GroupRoleScope UserGroupAssignmentResponse.getGroup()",
      "String UserGroupAssignmentResponse.getGroupId()", "String UserGroupAssignmentResponse.getId()",
      "Long UserGroupAssignmentResponse.getLastAddedDate()", "Long UserGroupAssignmentResponse.getLastRemovedDate()",
      "UserCompp UserGroupAssignmentResponse.getUser()", "Long UserGroupAssignmentResponse.getUserId()",
      ...
      "void UserGroupAssignmentResponse.setGroupId(String)", "void UserGroupAssignmentResponse.setId(String)",
      "void UserGroupAssignmentResponse.setLastAddedDate(Long)",
      "void UserGroupAssignmentResponse.setLastRemovedDate(Long)",
      "void UserGroupAssignmentResponse.setUser(UserCompp)", "void UserGroupAssignmentResponse.setUserId(Long)",
      "void UserGroupAssignmentResponse.setUserRoles(List)", "String UserGroupAssignmentResponse.toString()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    UserGroupAssignmentResponse actualUserGroupAssignmentResponse = new UserGroupAssignmentResponse();
    UserGroupAssignmentResponse actualActiveResult = actualUserGroupAssignmentResponse.active(true);
    UserGroupAssignmentResponse actualGroupResult = actualUserGroupAssignmentResponse.group(new GroupRoleScope());
    UserGroupAssignmentResponse actualGroupIdResult = actualUserGroupAssignmentResponse.groupId("42");
    UserGroupAssignmentResponse actualIdResult = actualUserGroupAssignmentResponse.id("42");
    UserGroupAssignmentResponse actualLastAddedDateResult = actualUserGroupAssignmentResponse.lastAddedDate(1L);
    UserGroupAssignmentResponse actualLastRemovedDateResult = actualUserGroupAssignmentResponse.lastRemovedDate(1L);
    ...
    UserGroupAssignmentResponse actualUserRolesResult = actualUserGroupAssignmentResponse.userRoles(userRoles);
    ...
    assertEquals("class UserGroupAssignmentResponse {\n" + "    id: 42\n" + "    groupId: 42\n"
