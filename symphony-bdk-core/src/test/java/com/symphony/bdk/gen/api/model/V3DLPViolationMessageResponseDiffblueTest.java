...
class V3DLPViolationMessageResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPViolationMessageResponse#addViolationsItem(V3DLPViolationMessage)}
   */
  @Test
  ...
  void testAddViolationsItem() {
    // Arrange
    V3DLPViolationMessageResponse v3dlpViolationMessageResponse = new V3DLPViolationMessageResponse();

    // Act and Assert
    assertSame(v3dlpViolationMessageResponse,
        v3dlpViolationMessageResponse.addViolationsItem(new V3DLPViolationMessage()));
  }

  /**
   * Test {@link V3DLPViolationMessageResponse#equals(Object)}, and {@link V3DLPViolationMessageResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPViolationMessageResponse.equals(Object)",
      "int V3DLPViolationMessageResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V3DLPViolationMessageResponse v3dlpViolationMessageResponse = new V3DLPViolationMessageResponse();
    V3DLPViolationMessageResponse v3dlpViolationMessageResponse2 = new V3DLPViolationMessageResponse();
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPViolationMessageResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V3DLPViolationMessageResponse(), "Different type to V3DLPViolationMessageResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPViolationMessageResponse.<init>()",
      "String V3DLPViolationMessageResponse.getNextOffset()", "List V3DLPViolationMessageResponse.getViolations()",
      ...
      "void V3DLPViolationMessageResponse.setViolations(List)", "String V3DLPViolationMessageResponse.toString()",
      "V3DLPViolationMessageResponse V3DLPViolationMessageResponse.violations(List)"})
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPViolationMessageResponse actualV3dlpViolationMessageResponse = new V3DLPViolationMessageResponse();
    V3DLPViolationMessageResponse actualNextOffsetResult = actualV3dlpViolationMessageResponse
    ...
    V3DLPViolationMessageResponse actualViolationsResult = actualV3dlpViolationMessageResponse.violations(violations);
    ...
    List<V3DLPViolationMessage> actualViolations = actualV3dlpViolationMessageResponse.getViolations();

    // Assert
    assertEquals("Next Offset", actualNextOffset);
    assertEquals("class V3DLPViolationMessageResponse {\n    violations: []\n    nextOffset: Next Offset\n}",
