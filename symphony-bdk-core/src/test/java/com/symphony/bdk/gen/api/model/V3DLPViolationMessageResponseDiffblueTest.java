...
class V3DLPViolationMessageResponseDiffblueTest {
  ...
  void testAddViolationsItem() {
    ...
    // Act
    V3DLPViolationMessageResponse actualAddViolationsItemResult =
        v3dlpViolationMessageResponse.addViolationsItem(new V3DLPViolationMessage());

    // Assert
    assertSame(v3dlpViolationMessageResponse, actualAddViolationsItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(
        v3dlpViolationMessageResponse.hashCode(), v3dlpViolationMessageResponse2.hashCode());
  }
