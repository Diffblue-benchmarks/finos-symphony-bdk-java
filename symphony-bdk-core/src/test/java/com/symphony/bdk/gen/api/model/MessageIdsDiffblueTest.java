...
class MessageIdsDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MessageIds} (default constructor) messageIds {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageIds#addMessageIdsItem(String)}
   */
  @Test
  @DisplayName("Test addMessageIdsItem(String); given MessageIds (default constructor) messageIds ArrayList()")
  ...
  void testAddMessageIdsItem_givenMessageIdsMessageIdsArrayList() {
    ...
    // Act and Assert
    assertSame(messageIds, messageIds.addMessageIdsItem("Message Ids Item"));
  }

  /**
   * Test {@link MessageIds#addMessageIdsItem(String)}.
   * <ul>
   *   <li>Given {@link MessageIds} (default constructor).</li>
   *   <li>Then return MessageIds size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link MessageIds#addMessageIdsItem(String)}
   */
  @Test
  @DisplayName("Test addMessageIdsItem(String); given MessageIds (default constructor); then return MessageIds size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MessageIds MessageIds.addMessageIdsItem(String)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, messageIds2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link MessageIds#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MessageIds.<init>()", "List MessageIds.getMessageIds()",
      "MessageIds MessageIds.messageIds(List)", "void MessageIds.setMessageIds(List)", "String MessageIds.toString()"})
