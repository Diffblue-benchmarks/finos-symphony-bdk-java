...
class V1DLPDictionaryMetadataUpdateRequestDiffblueTest {
  /**
   * Test {@link V1DLPDictionaryMetadataUpdateRequest#equals(Object)}, and {@link
   * V1DLPDictionaryMetadataUpdateRequest#hashCode()}.
   *
   * <ul>
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V1DLPDictionaryMetadataUpdateRequest.equals(Object)",
    "int V1DLPDictionaryMetadataUpdateRequest.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1DLPDictionaryMetadataUpdateRequest v1dlpDictionaryMetadataUpdateRequest =
        new V1DLPDictionaryMetadataUpdateRequest();
    V1DLPDictionaryMetadataUpdateRequest v1dlpDictionaryMetadataUpdateRequest2 =
        new V1DLPDictionaryMetadataUpdateRequest();
    ...
    assertEquals(
        v1dlpDictionaryMetadataUpdateRequest.hashCode(),
        v1dlpDictionaryMetadataUpdateRequest2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPDictionaryMetadataUpdateRequest#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPDictionaryMetadataUpdateRequest.<init>()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPDictionaryMetadataUpdateRequest actualV1dlpDictionaryMetadataUpdateRequest =
        new V1DLPDictionaryMetadataUpdateRequest();
    V1DLPDictionaryMetadataUpdateRequest actualNameResult =
        actualV1dlpDictionaryMetadataUpdateRequest.name("Name");
    ...
    assertEquals(
        "class V1DLPDictionaryMetadataUpdateRequest {\n    name: Name\n}", actualToStringResult);
