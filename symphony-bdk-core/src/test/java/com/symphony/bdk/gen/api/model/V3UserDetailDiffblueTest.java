...
class V3UserDetailDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V3UserDetail} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link V3UserDetail#addFeaturesItem(Feature)}
   */
  @Test
  ...
  void testAddFeaturesItem_givenV3UserDetail() {
    ...
    // Act
    V3UserDetail actualAddFeaturesItemResult = v3UserDetail.addFeaturesItem(new Feature());

    // Assert
    assertSame(v3UserDetail, actualAddFeaturesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V3UserDetail} (default constructor) features {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V3UserDetail#addFeaturesItem(Feature)}
   */
  @Test
  @DisplayName(
      "Test addFeaturesItem(Feature); given V3UserDetail (default constructor) features ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V3UserDetail V3UserDetail.addFeaturesItem(Feature)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link V3UserDetail#addRolesItem(String)}
   */
  @Test
  ...
  void testAddRolesItem_givenV3UserDetail() {
    ...
    // Act
    V3UserDetail actualAddRolesItemResult = v3UserDetail.addRolesItem("Roles Item");

    // Assert
    assertSame(v3UserDetail, actualAddRolesItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V3UserDetail} (default constructor) roles {@link ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V3UserDetail#addRolesItem(String)}
   */
  @Test
  @DisplayName(
      "Test addRolesItem(String); given V3UserDetail (default constructor) roles ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V3UserDetail V3UserDetail.addRolesItem(String)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v3UserDetail.hashCode(), v3UserDetail2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V3UserDetail#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V3UserDetail.<init>()",
    "V3UserDetail V3UserDetail.avatar(Avatar)",
    "V3UserDetail V3UserDetail.features(List)",
    "Avatar V3UserDetail.getAvatar()",
    "List V3UserDetail.getFeatures()",
    "List V3UserDetail.getRoles()",
    "V2UserAttributes V3UserDetail.getUserAttributes()",
    "UserSystemInfo V3UserDetail.getUserSystemInfo()",
    "V3UserDetail V3UserDetail.roles(List)",
    "void V3UserDetail.setAvatar(Avatar)",
    "void V3UserDetail.setFeatures(List)",
    "void V3UserDetail.setRoles(List)",
    "void V3UserDetail.setUserAttributes(V2UserAttributes)",
    "void V3UserDetail.setUserSystemInfo(UserSystemInfo)",
    "String V3UserDetail.toString()",
    "V3UserDetail V3UserDetail.userAttributes(V2UserAttributes)",
