...
class UserSearchFilterDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link UserSearchFilter} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link UserSearchFilter#addAccountTypesItem(String)}
   */
  @Test
   ...
   * Test {@link UserSearchFilter#addAccountTypesItem(String)}.
   * <ul>
   *   <li>Given {@link UserSearchFilter} (default constructor) accountTypes {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link UserSearchFilter#addAccountTypesItem(String)}
   */
  @Test
  @DisplayName("Test addAccountTypesItem(String); given UserSearchFilter (default constructor) accountTypes ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"UserSearchFilter UserSearchFilter.addAccountTypesItem(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void UserSearchFilter.<init>()", "UserSearchFilter UserSearchFilter.accountTypes(List)",
      "UserSearchFilter UserSearchFilter.company(String)", "UserSearchFilter UserSearchFilter.function(String)",
      "List UserSearchFilter.getAccountTypes()", "String UserSearchFilter.getCompany()",
      "String UserSearchFilter.getFunction()", "String UserSearchFilter.getInstrument()",
      "String UserSearchFilter.getLocation()", "String UserSearchFilter.getMarketCoverage()",
      "String UserSearchFilter.getResponsibility()", "String UserSearchFilter.getTitle()",
      "UserSearchFilter UserSearchFilter.instrument(String)", "UserSearchFilter UserSearchFilter.location(String)",
      "UserSearchFilter UserSearchFilter.marketCoverage(String)",
      "UserSearchFilter UserSearchFilter.responsibility(String)", "void UserSearchFilter.setAccountTypes(List)",
      "void UserSearchFilter.setCompany(String)", "void UserSearchFilter.setFunction(String)",
      "void UserSearchFilter.setInstrument(String)", "void UserSearchFilter.setLocation(String)",
      "void UserSearchFilter.setMarketCoverage(String)", "void UserSearchFilter.setResponsibility(String)",
  ...
  void testGettersAndSetters() {
    ...
    UserSearchFilter actualAccountTypesResult = actualUserSearchFilter.accountTypes(new ArrayList<>());
    ...
    UserSearchFilter actualMarketCoverageResult = actualUserSearchFilter.marketCoverage("Market Coverage");
    UserSearchFilter actualResponsibilityResult = actualUserSearchFilter.responsibility("Responsibility");
