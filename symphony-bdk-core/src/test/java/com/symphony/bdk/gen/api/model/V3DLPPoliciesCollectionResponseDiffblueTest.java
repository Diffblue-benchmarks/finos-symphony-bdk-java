...
class V3DLPPoliciesCollectionResponseDiffblueTest {
  ...
  void testAddPoliciesItem() {
    ...
    // Act
    V3DLPPoliciesCollectionResponse actualAddPoliciesItemResult =
        v3dlpPoliciesCollectionResponse.addPoliciesItem(new V3DLPPolicy());

    // Assert
    assertSame(v3dlpPoliciesCollectionResponse, actualAddPoliciesItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(
        v3dlpPoliciesCollectionResponse.hashCode(), v3dlpPoliciesCollectionResponse2.hashCode());
  }
