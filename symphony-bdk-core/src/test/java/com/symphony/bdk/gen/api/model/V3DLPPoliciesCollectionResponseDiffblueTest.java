...
class V3DLPPoliciesCollectionResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPPoliciesCollectionResponse#addPoliciesItem(V3DLPPolicy)}
   */
  @Test
  @DisplayName("Test addPoliciesItem(V3DLPPolicy)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V3DLPPoliciesCollectionResponse V3DLPPoliciesCollectionResponse.addPoliciesItem(V3DLPPolicy)"})
  void testAddPoliciesItem() {
    // Arrange
    V3DLPPoliciesCollectionResponse v3dlpPoliciesCollectionResponse = new V3DLPPoliciesCollectionResponse();

    // Act and Assert
    assertSame(v3dlpPoliciesCollectionResponse, v3dlpPoliciesCollectionResponse.addPoliciesItem(new V3DLPPolicy()));
  }

  /**
   * Test {@link V3DLPPoliciesCollectionResponse#equals(Object)}, and {@link V3DLPPoliciesCollectionResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPPoliciesCollectionResponse.equals(Object)",
      "int V3DLPPoliciesCollectionResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V3DLPPoliciesCollectionResponse v3dlpPoliciesCollectionResponse = new V3DLPPoliciesCollectionResponse();
    V3DLPPoliciesCollectionResponse v3dlpPoliciesCollectionResponse2 = new V3DLPPoliciesCollectionResponse();
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPPoliciesCollectionResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V3DLPPoliciesCollectionResponse(), "Different type to V3DLPPoliciesCollectionResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPPoliciesCollectionResponse.<init>()",
      "Integer V3DLPPoliciesCollectionResponse.getPage()", "Integer V3DLPPoliciesCollectionResponse.getPageCount()",
      "List V3DLPPoliciesCollectionResponse.getPolicies()", "Integer V3DLPPoliciesCollectionResponse.getSize()",
      ...
      "void V3DLPPoliciesCollectionResponse.setPolicies(List)", "void V3DLPPoliciesCollectionResponse.setSize(Integer)",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V3DLPPoliciesCollectionResponse actualV3dlpPoliciesCollectionResponse = new V3DLPPoliciesCollectionResponse();
    V3DLPPoliciesCollectionResponse actualPageResult = actualV3dlpPoliciesCollectionResponse.page(1);
    V3DLPPoliciesCollectionResponse actualPageCountResult = actualV3dlpPoliciesCollectionResponse.pageCount(3);
    V3DLPPoliciesCollectionResponse actualPoliciesResult = actualV3dlpPoliciesCollectionResponse
    ...
    V3DLPPoliciesCollectionResponse actualSizeResult = actualV3dlpPoliciesCollectionResponse.size(3);
