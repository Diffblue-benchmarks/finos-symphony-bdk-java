...
class V4StreamDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test addMembersItem(V4User); given V4Stream (default constructor) members ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V4Stream V4Stream.addMembersItem(V4User)"})
   ...
   * </ul>
   *
   * <p>Method under test: {@link V4Stream#addRecipientTenantIdsItem(Integer)}
   */
  @Test
  ...
  void testAddRecipientTenantIdsItem_givenV4Stream() {
    ...
    // Act
    V4Stream actualAddRecipientTenantIdsItemResult = v4Stream.addRecipientTenantIdsItem(1);

    // Assert
    assertSame(v4Stream, actualAddRecipientTenantIdsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V4Stream} (default constructor) recipientTenantIds {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V4Stream#addRecipientTenantIdsItem(Integer)}
  ...
  @Test
  @DisplayName(
      "Test addRecipientTenantIdsItem(Integer); given V4Stream (default constructor) recipientTenantIds ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V4Stream V4Stream.addRecipientTenantIdsItem(Integer)"})
  ...
  @MethodsUnderTest({
    ...
    "void V4Stream.setRecipientTenantIds(List)",
