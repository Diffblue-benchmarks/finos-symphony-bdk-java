...
class V3DLPFileExtensionConfigDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V3DLPFileExtensionConfig#addAllowListsItem(String)}
   */
  @Test
  ...
  void testAddAllowListsItem() {
    ...
    // Act and Assert
    assertSame(v3dlpFileExtensionConfig, v3dlpFileExtensionConfig.addAllowListsItem("Allow Lists Item"));
  }

  /**
   * Test {@link V3DLPFileExtensionConfig#addBlockListsItem(String)}.
   * <p>
   * Method under test: {@link V3DLPFileExtensionConfig#addBlockListsItem(String)}
   */
  @Test
  ...
  void testAddBlockListsItem() {
    ...
    // Act and Assert
    assertSame(v3dlpFileExtensionConfig, v3dlpFileExtensionConfig.addBlockListsItem("Block Lists Item"));
  }

  /**
   * Test {@link V3DLPFileExtensionConfig#equals(Object)}, and {@link V3DLPFileExtensionConfig#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V3DLPFileExtensionConfig.equals(Object)", "int V3DLPFileExtensionConfig.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v3dlpFileExtensionConfig2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V3DLPFileExtensionConfig#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V3DLPFileExtensionConfig.<init>()",
      ...
      "List V3DLPFileExtensionConfig.getAllowLists()", "List V3DLPFileExtensionConfig.getBlockLists()",
      "void V3DLPFileExtensionConfig.setAllowLists(List)", "void V3DLPFileExtensionConfig.setBlockLists(List)",
  ...
  void testGettersAndSetters() {
    ...
    V3DLPFileExtensionConfig actualAllowListsResult = actualV3dlpFileExtensionConfig.allowLists(new ArrayList<>());
    V3DLPFileExtensionConfig actualBlockListsResult = actualV3dlpFileExtensionConfig.blockLists(new ArrayList<>());
    ...
    // Assert
    assertEquals("class V3DLPFileExtensionConfig {\n    allowLists: []\n    blockLists: []\n}", actualToStringResult);
