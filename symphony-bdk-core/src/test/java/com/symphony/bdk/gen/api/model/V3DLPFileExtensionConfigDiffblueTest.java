...
class V3DLPFileExtensionConfigDiffblueTest {
  ...
  void testAddAllowListsItem() {
    ...
    // Act and Assert
    assertSame(
        v3dlpFileExtensionConfig, v3dlpFileExtensionConfig.addAllowListsItem("Allow Lists Item"));
  }
  ...
  void testAddBlockListsItem() {
    ...
    // Act and Assert
    assertSame(
        v3dlpFileExtensionConfig, v3dlpFileExtensionConfig.addBlockListsItem("Block Lists Item"));
  }
