...
class AuthenticateExtensionAppRequestDiffblueTest {
  /**
   * Test {@link AuthenticateExtensionAppRequest#equals(Object)}, and {@link AuthenticateExtensionAppRequest#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean AuthenticateExtensionAppRequest.equals(Object)",
      "int AuthenticateExtensionAppRequest.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    AuthenticateExtensionAppRequest authenticateExtensionAppRequest = new AuthenticateExtensionAppRequest();
    AuthenticateExtensionAppRequest authenticateExtensionAppRequest2 = new AuthenticateExtensionAppRequest();
    ...
    assertEquals(expectedHashCodeResult, authenticateExtensionAppRequest2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AuthenticateExtensionAppRequest#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new AuthenticateExtensionAppRequest(), "Different type to AuthenticateExtensionAppRequest");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AuthenticateExtensionAppRequest.<init>()",
      ...
      "String AuthenticateExtensionAppRequest.getAppToken()", "String AuthenticateExtensionAppRequest.getAuthToken()",
      "void AuthenticateExtensionAppRequest.setAppToken(String)",
      "void AuthenticateExtensionAppRequest.setAuthToken(String)", "String AuthenticateExtensionAppRequest.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    AuthenticateExtensionAppRequest actualAuthenticateExtensionAppRequest = new AuthenticateExtensionAppRequest();
    AuthenticateExtensionAppRequest actualAppTokenResult = actualAuthenticateExtensionAppRequest.appToken("ABC123");
    AuthenticateExtensionAppRequest actualAuthTokenResult = actualAuthenticateExtensionAppRequest.authToken("ABC123");
    ...
    assertEquals("class AuthenticateExtensionAppRequest {\n    appToken: ABC123\n    authToken: ABC123\n}",
