...
class AdminStreamListDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AdminStreamList} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link AdminStreamList#addStreamsItem(AdminStreamInfo)}
   */
  @Test
   ...
   * Test {@link AdminStreamList#addStreamsItem(AdminStreamInfo)}.
   * <ul>
   *   <li>Given {@link AdminStreamList} (default constructor) streams {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AdminStreamList#addStreamsItem(AdminStreamInfo)}
   */
  @Test
  @DisplayName("Test addStreamsItem(AdminStreamInfo); given AdminStreamList (default constructor) streams ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"AdminStreamList AdminStreamList.addStreamsItem(AdminStreamInfo)"})
  ...
  @MethodsUnderTest({"void AdminStreamList.<init>()", "AdminStreamList AdminStreamList.count(Long)",
      ...
      "Integer AdminStreamList.getSkip()", "List AdminStreamList.getStreams()",
      ...
      "void AdminStreamList.setSkip(Integer)", "void AdminStreamList.setStreams(List)",
      "AdminStreamList AdminStreamList.skip(Integer)", "AdminStreamList AdminStreamList.streams(List)",
