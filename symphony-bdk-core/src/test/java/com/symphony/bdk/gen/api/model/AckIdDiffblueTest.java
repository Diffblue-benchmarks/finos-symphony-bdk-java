...
class AckIdDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, ackId2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AckId#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AckId.<init>()", "AckId AckId.ackId(String)", "String AckId.getAckId()",
      "Boolean AckId.getUpdatePresence()", "void AckId.setAckId(String)", "void AckId.setUpdatePresence(Boolean)",
      "String AckId.toString()", "AckId AckId.updatePresence(Boolean)"})
