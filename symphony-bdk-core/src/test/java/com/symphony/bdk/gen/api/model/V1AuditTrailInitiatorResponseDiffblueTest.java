...
class V1AuditTrailInitiatorResponseDiffblueTest {
  /**
   * Test {@link V1AuditTrailInitiatorResponse#equals(Object)}, and {@link V1AuditTrailInitiatorResponse#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean V1AuditTrailInitiatorResponse.equals(Object)",
      "int V1AuditTrailInitiatorResponse.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V1AuditTrailInitiatorResponse v1AuditTrailInitiatorResponse = new V1AuditTrailInitiatorResponse();
    V1AuditTrailInitiatorResponse v1AuditTrailInitiatorResponse2 = new V1AuditTrailInitiatorResponse();
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1AuditTrailInitiatorResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V1AuditTrailInitiatorResponse(), "Different type to V1AuditTrailInitiatorResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1AuditTrailInitiatorResponse.<init>()",
      ...
      "String V1AuditTrailInitiatorResponse.getAction()", "String V1AuditTrailInitiatorResponse.getActionName()",
  ...
  void testGettersAndSetters() {
    // Arrange and Act
    V1AuditTrailInitiatorResponse actualV1AuditTrailInitiatorResponse = new V1AuditTrailInitiatorResponse();
    V1AuditTrailInitiatorResponse actualActionResult = actualV1AuditTrailInitiatorResponse.action("Action");
    V1AuditTrailInitiatorResponse actualActionNameResult = actualV1AuditTrailInitiatorResponse
        .actionName("Action Name");
    V1AuditTrailInitiatorResponse actualInitiatorEmailAddressResult = actualV1AuditTrailInitiatorResponse
        .initiatorEmailAddress("42 Main St");
    V1AuditTrailInitiatorResponse actualInitiatorIdResult = actualV1AuditTrailInitiatorResponse.initiatorId("42");
    V1AuditTrailInitiatorResponse actualInitiatorUsernameResult = actualV1AuditTrailInitiatorResponse
    ...
    V1AuditTrailInitiatorResponse actualTimestampResult = actualV1AuditTrailInitiatorResponse.timestamp("Timestamp");
    ...
    String actualInitiatorEmailAddress = actualV1AuditTrailInitiatorResponse.getInitiatorEmailAddress();
    ...
    assertEquals("class V1AuditTrailInitiatorResponse {\n" + "    action: Action\n" + "    actionName: Action Name\n"
        + "    timestamp: Timestamp\n" + "    initiatorId: 42\n" + "    initiatorUsername: janedoe\n"
