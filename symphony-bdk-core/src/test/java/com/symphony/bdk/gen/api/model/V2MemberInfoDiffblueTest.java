...
class V2MemberInfoDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link V2MemberInfo} (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link V2MemberInfo#addAddedThroughGroupsItem(Long)}
   */
  @Test
  ...
  void testAddAddedThroughGroupsItem_givenV2MemberInfo() {
    ...
    // Act
    V2MemberInfo actualAddAddedThroughGroupsItemResult = v2MemberInfo.addAddedThroughGroupsItem(1L);

    // Assert
    assertSame(v2MemberInfo, actualAddAddedThroughGroupsItemResult);
  }
   ...
   *
   * <ul>
   *   <li>Given {@link V2MemberInfo} (default constructor) AddedThroughGroups is {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link V2MemberInfo#addAddedThroughGroupsItem(Long)}
  ...
  @Test
  @DisplayName(
      "Test addAddedThroughGroupsItem(Long); given V2MemberInfo (default constructor) AddedThroughGroups is ArrayList()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"V2MemberInfo V2MemberInfo.addAddedThroughGroupsItem(Long)"})
  ...
  @MethodsUnderTest({
    ...
    "V2MemberInfo V2MemberInfo.addedThroughGroups(List)",
    "List V2MemberInfo.getAddedThroughGroups()",
    ...
    "void V2MemberInfo.setAddedThroughGroups(List)",
  ...
  void testGettersAndSetters() {
    ...
    V2MemberInfo actualAddedThroughGroupsResult =
        actualV2MemberInfo.addedThroughGroups(addedThroughGroups);
