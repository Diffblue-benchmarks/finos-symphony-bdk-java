...
class AssigneeCandidateDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link AssigneeCandidate} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link AssigneeCandidate#addRolesItem(String)}
   */
  @Test
  ...
  void testAddRolesItem_givenAssigneeCandidate() {
    ...
    // Act and Assert
    assertSame(assigneeCandidate, assigneeCandidate.addRolesItem("Roles Item"));
  }

  /**
   * Test {@link AssigneeCandidate#addRolesItem(String)}.
   * <ul>
   *   <li>Given {@link AssigneeCandidate} (default constructor) roles {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link AssigneeCandidate#addRolesItem(String)}
   */
  @Test
  @DisplayName("Test addRolesItem(String); given AssigneeCandidate (default constructor) roles ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"AssigneeCandidate AssigneeCandidate.addRolesItem(String)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean AssigneeCandidate.equals(Object)", "int AssigneeCandidate.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, assigneeCandidate2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AssigneeCandidate#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AssigneeCandidate.<init>()", "AssigneeCandidate AssigneeCandidate.canBeAssigned(Boolean)",
      "AssigneeCandidate AssigneeCandidate.emailAddress(String)",
      "AssigneeCandidate AssigneeCandidate.firstName(String)", "Boolean AssigneeCandidate.getCanBeAssigned()",
      "String AssigneeCandidate.getEmailAddress()", "String AssigneeCandidate.getFirstName()",
      "List AssigneeCandidate.getRoles()", "String AssigneeCandidate.getSurname()",
      "Long AssigneeCandidate.getUserId()", "String AssigneeCandidate.getUsername()",
      "AssigneeCandidate AssigneeCandidate.roles(List)", "void AssigneeCandidate.setCanBeAssigned(Boolean)",
      "void AssigneeCandidate.setEmailAddress(String)", "void AssigneeCandidate.setFirstName(String)",
      "void AssigneeCandidate.setRoles(List)", "void AssigneeCandidate.setSurname(String)",
      "void AssigneeCandidate.setUserId(Long)", "void AssigneeCandidate.setUsername(String)",
      "AssigneeCandidate AssigneeCandidate.surname(String)", "String AssigneeCandidate.toString()",
      "AssigneeCandidate AssigneeCandidate.userId(Long)", "AssigneeCandidate AssigneeCandidate.username(String)"})
  void testGettersAndSetters() {
    ...
    assertEquals("class AssigneeCandidate {\n" + "    userId: 1\n" + "    username: janedoe\n" + "    firstName: Jane\n"
