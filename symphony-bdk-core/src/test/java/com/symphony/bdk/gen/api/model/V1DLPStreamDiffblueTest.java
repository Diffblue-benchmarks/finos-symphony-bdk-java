...
class V1DLPStreamDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpStream.hashCode(), v1dlpStream2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPStream#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPStream.<init>()",
    "V1DLPStream V1DLPStream.active(Boolean)",
    "V1DLPStream V1DLPStream.allowExternal(Boolean)",
    "V1DLPStream V1DLPStream.copyDisabled(Boolean)",
    "V1DLPStream V1DLPStream.creatorId(String)",
    "V1DLPStream V1DLPStream.creatorPrettyName(String)",
    "V1DLPStream V1DLPStream.crossPod(Boolean)",
    "V1DLPStream V1DLPStream.diagnostic(String)",
    "V1DLPStream V1DLPStream.discoverable(Boolean)",
    "V1DLPStream V1DLPStream.externalOwned(Boolean)",
    "Boolean V1DLPStream.getActive()",
    "Boolean V1DLPStream.getAllowExternal()",
    "Boolean V1DLPStream.getCopyDisabled()",
    "String V1DLPStream.getCreatorId()",
    "String V1DLPStream.getCreatorPrettyName()",
    "Boolean V1DLPStream.getCrossPod()",
    "String V1DLPStream.getDiagnostic()",
    "Boolean V1DLPStream.getDiscoverable()",
    "Boolean V1DLPStream.getExternalOwned()",
    "Long V1DLPStream.getLastDisabled()",
    "Boolean V1DLPStream.getMemberAddUserEnabled()",
    "Boolean V1DLPStream.getModerated()",
    "String V1DLPStream.getName()",
    "Boolean V1DLPStream.getPublicRoom()",
    "Boolean V1DLPStream.getReadOnly()",
    "String V1DLPStream.getRoomDescription()",
    "Boolean V1DLPStream.getSendMessageDisabled()",
    "Boolean V1DLPStream.getShareHistoryEnabled()",
    "String V1DLPStream.getState()",
    "String V1DLPStream.getStreamId()",
    "String V1DLPStream.getType()",
    "V1DLPStream V1DLPStream.lastDisabled(Long)",
    "V1DLPStream V1DLPStream.memberAddUserEnabled(Boolean)",
    "V1DLPStream V1DLPStream.moderated(Boolean)",
    "V1DLPStream V1DLPStream.name(String)",
    "V1DLPStream V1DLPStream.publicRoom(Boolean)",
    "V1DLPStream V1DLPStream.readOnly(Boolean)",
    "V1DLPStream V1DLPStream.roomDescription(String)",
    "V1DLPStream V1DLPStream.sendMessageDisabled(Boolean)",
    "void V1DLPStream.setActive(Boolean)",
    "void V1DLPStream.setAllowExternal(Boolean)",
    "void V1DLPStream.setCopyDisabled(Boolean)",
    "void V1DLPStream.setCreatorId(String)",
    "void V1DLPStream.setCreatorPrettyName(String)",
    "void V1DLPStream.setCrossPod(Boolean)",
    "void V1DLPStream.setDiagnostic(String)",
    "void V1DLPStream.setDiscoverable(Boolean)",
    "void V1DLPStream.setExternalOwned(Boolean)",
    "void V1DLPStream.setLastDisabled(Long)",
    "void V1DLPStream.setMemberAddUserEnabled(Boolean)",
    "void V1DLPStream.setModerated(Boolean)",
    "void V1DLPStream.setName(String)",
    "void V1DLPStream.setPublicRoom(Boolean)",
    "void V1DLPStream.setReadOnly(Boolean)",
    "void V1DLPStream.setRoomDescription(String)",
    "void V1DLPStream.setSendMessageDisabled(Boolean)",
    "void V1DLPStream.setShareHistoryEnabled(Boolean)",
    "void V1DLPStream.setState(String)",
    "void V1DLPStream.setStreamId(String)",
    "void V1DLPStream.setType(String)",
    "V1DLPStream V1DLPStream.shareHistoryEnabled(Boolean)",
    "V1DLPStream V1DLPStream.state(String)",
    "V1DLPStream V1DLPStream.streamId(String)",
    "String V1DLPStream.toString()",
  ...
  void testGettersAndSetters() {
    ...
    V1DLPStream actualCreatorPrettyNameResult =
        actualV1dlpStream.creatorPrettyName("Creator Pretty Name");
