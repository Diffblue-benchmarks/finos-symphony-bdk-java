...
class AppNotificationDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, appNotification2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AppNotification#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AppNotification.<init>()", "AppNotification AppNotification.apiKey(String)",
      "String AppNotification.getApiKey()", "String AppNotification.getUrl()", "void AppNotification.setApiKey(String)",
      "void AppNotification.setUrl(String)", "String AppNotification.toString()",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class AppNotification {\n    url: https://example.org/example\n    apiKey: Api Key\n}",
