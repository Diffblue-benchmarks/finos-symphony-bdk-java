...
class FollowersListDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link FollowersList} (default constructor) followers {@link
   *       ArrayList#ArrayList()}.
   * </ul>
   *
   * <p>Method under test: {@link FollowersList#addFollowersItem(Long)}
   */
  @Test
  @DisplayName(
      "Test addFollowersItem(Long); given FollowersList (default constructor) followers ArrayList()")
   ...
   *
   * <ul>
   *   <li>Given {@link FollowersList} (default constructor).
   *   <li>Then return Followers size is one.
   * </ul>
   *
   * <p>Method under test: {@link FollowersList#addFollowersItem(Long)}
   */
  @Test
  @DisplayName(
      "Test addFollowersItem(Long); given FollowersList (default constructor); then return Followers size is one")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"FollowersList FollowersList.addFollowersItem(Long)"})
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(followersList.hashCode(), followersList2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link FollowersList#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void FollowersList.<init>()",
    "FollowersList FollowersList.followers(List)",
    "List FollowersList.getFollowers()",
    "void FollowersList.setFollowers(List)",
    "String FollowersList.toString()"
  })
