...
class V4UserRequestedToJoinRoomDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V4UserRequestedToJoinRoom} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V4UserRequestedToJoinRoom#addAffectedUsersItem(V4User)}
   */
  @Test
  @DisplayName("Test addAffectedUsersItem(V4User); given V4UserRequestedToJoinRoom (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V4UserRequestedToJoinRoom V4UserRequestedToJoinRoom.addAffectedUsersItem(V4User)"})
  void testAddAffectedUsersItem_givenV4UserRequestedToJoinRoom() {
    ...
    // Act and Assert
    assertSame(v4UserRequestedToJoinRoom, v4UserRequestedToJoinRoom.addAffectedUsersItem(new V4User()));
  }

  /**
   * Test {@link V4UserRequestedToJoinRoom#addAffectedUsersItem(V4User)}.
   * <ul>
   *   <li>Given {@link V4UserRequestedToJoinRoom} (default constructor) affectedUsers {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V4UserRequestedToJoinRoom#addAffectedUsersItem(V4User)}
   */
  @Test
  @DisplayName("Test addAffectedUsersItem(V4User); given V4UserRequestedToJoinRoom (default constructor) affectedUsers ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V4UserRequestedToJoinRoom V4UserRequestedToJoinRoom.addAffectedUsersItem(V4User)"})
  ...
  /**
   * Test {@link V4UserRequestedToJoinRoom#equals(Object)}, and {@link V4UserRequestedToJoinRoom#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V4UserRequestedToJoinRoom.equals(Object)", "int V4UserRequestedToJoinRoom.hashCode()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V4UserRequestedToJoinRoom#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V4UserRequestedToJoinRoom.<init>()",
      "V4UserRequestedToJoinRoom V4UserRequestedToJoinRoom.affectedUsers(List)",
      "List V4UserRequestedToJoinRoom.getAffectedUsers()", "V4Stream V4UserRequestedToJoinRoom.getStream()",
      "void V4UserRequestedToJoinRoom.setAffectedUsers(List)", "void V4UserRequestedToJoinRoom.setStream(V4Stream)",
  ...
  void testGettersAndSetters() {
    ...
    V4UserRequestedToJoinRoom actualAffectedUsersResult = actualV4UserRequestedToJoinRoom
    ...
    // Assert
    assertEquals("class V4UserRequestedToJoinRoom {\n" + "    stream: class V4Stream {\n" + "        streamId: null\n"
        + "        streamType: null\n" + "        roomName: null\n" + "        members: null\n"
