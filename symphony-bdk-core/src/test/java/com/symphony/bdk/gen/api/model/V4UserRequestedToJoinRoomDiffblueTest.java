...
class V4UserRequestedToJoinRoomDiffblueTest {
  ...
  void testAddAffectedUsersItem_givenV4UserRequestedToJoinRoom() {
    ...
    // Act
    V4UserRequestedToJoinRoom actualAddAffectedUsersItemResult =
        v4UserRequestedToJoinRoom.addAffectedUsersItem(new V4User());

    // Assert
    assertSame(v4UserRequestedToJoinRoom, actualAddAffectedUsersItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v4UserRequestedToJoinRoom.hashCode(), v4UserRequestedToJoinRoom2.hashCode());
  }
