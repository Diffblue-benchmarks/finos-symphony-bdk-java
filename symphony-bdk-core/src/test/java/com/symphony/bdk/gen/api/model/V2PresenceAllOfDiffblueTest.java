...
class V2PresenceAllOfDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2PresenceAllOf#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2PresenceAllOf.<init>()", "Long V2PresenceAllOf.getTimestamp()",
      "void V2PresenceAllOf.setTimestamp(Long)", "V2PresenceAllOf V2PresenceAllOf.timestamp(Long)",
