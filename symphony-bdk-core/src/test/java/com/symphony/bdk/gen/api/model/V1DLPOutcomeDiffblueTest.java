...
class V1DLPOutcomeDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpOutcome.hashCode(), v1dlpOutcome2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V1DLPOutcome#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V1DLPOutcome.<init>()",
    "String V1DLPOutcome.getType()",
    "void V1DLPOutcome.setType(String)",
    "String V1DLPOutcome.toString()",
    "V1DLPOutcome V1DLPOutcome.type(String)"
  })
