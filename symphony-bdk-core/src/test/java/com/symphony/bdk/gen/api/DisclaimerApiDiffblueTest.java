...
class DisclaimerApiDiffblueTest {
  ...
  void testV1AdminDisclaimerDidGet_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new DisclaimerApi(apiClient).v1AdminDisclaimerDidGet(null, "Did"));
  }
  ...
  void testV1AdminDisclaimerDidGet_whenNull_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new DisclaimerApi(apiClient).v1AdminDisclaimerDidGet("ABC123", null));
  }
  ...
  void testV1AdminDisclaimerDidUsersGet_whenNull_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new DisclaimerApi(apiClient).v1AdminDisclaimerDidUsersGet(null, "Did"));
  }
  ...
  void testV1AdminDisclaimerDidUsersGet_whenNull_thenThrowApiException2() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new DisclaimerApi(apiClient).v1AdminDisclaimerDidUsersGet("ABC123", null));
  }
  ...
  void testV1AdminDisclaimerListGet_thenThrowApiException() throws ApiException {
    ...
    // Act and Assert
    assertThrows(
        ApiException.class, () -> new DisclaimerApi(apiClient).v1AdminDisclaimerListGet(null));
  }
  ...
  void testV1AdminDisclaimerListGetWithHttpInfo_thenThrowApiException() throws ApiException {
    ...
    assertThrows(
        ApiException.class,
        () -> new DisclaimerApi(apiClient).v1AdminDisclaimerListGetWithHttpInfo(null));
  }
}
