...
class V5EventsReadBodyDiffblueTest {
  ...
  void testAddEventTypesItem_givenV5EventsReadBody() {
    ...
    // Act
    V5EventsReadBody actualAddEventTypesItemResult =
        v5EventsReadBody.addEventTypesItem("Event Types Item");

    // Assert
    assertSame(v5EventsReadBody, actualAddEventTypesItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v5EventsReadBody.hashCode(), v5EventsReadBody2.hashCode());
  }
