...
class V5EventsReadBodyDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V5EventsReadBody} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V5EventsReadBody#addEventTypesItem(String)}
   */
  @Test
   ...
   * Test {@link V5EventsReadBody#addEventTypesItem(String)}.
   * <ul>
   *   <li>Given {@link V5EventsReadBody} (default constructor) eventTypes {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V5EventsReadBody#addEventTypesItem(String)}
   */
  @Test
  @DisplayName("Test addEventTypesItem(String); given V5EventsReadBody (default constructor) eventTypes ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V5EventsReadBody V5EventsReadBody.addEventTypesItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V5EventsReadBody#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V5EventsReadBody.<init>()", "V5EventsReadBody V5EventsReadBody.ackId(String)",
      "V5EventsReadBody V5EventsReadBody.eventTypes(List)", "String V5EventsReadBody.getAckId()",
      "List V5EventsReadBody.getEventTypes()", "String V5EventsReadBody.getTag()", "String V5EventsReadBody.getType()",
      "Boolean V5EventsReadBody.getUpdatePresence()", "void V5EventsReadBody.setAckId(String)",
      "void V5EventsReadBody.setEventTypes(List)", "void V5EventsReadBody.setTag(String)",
      "void V5EventsReadBody.setType(String)", "void V5EventsReadBody.setUpdatePresence(Boolean)",
      "V5EventsReadBody V5EventsReadBody.tag(String)", "String V5EventsReadBody.toString()",
      "V5EventsReadBody V5EventsReadBody.type(String)", "V5EventsReadBody V5EventsReadBody.updatePresence(Boolean)"})
  void testGettersAndSetters() {
    ...
    assertEquals("class V5EventsReadBody {\n" + "    type: Type\n" + "    tag: Tag\n" + "    eventTypes: []\n"
