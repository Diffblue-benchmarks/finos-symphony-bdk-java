...
class AppPropertyDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, appProperty2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link AppProperty#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void AppProperty.<init>()", "String AppProperty.getKey()", "String AppProperty.getValue()",
      "AppProperty AppProperty.key(String)", "void AppProperty.setKey(String)", "void AppProperty.setValue(String)",
      "String AppProperty.toString()", "AppProperty AppProperty.value(String)"})
