...
class V2UserCreateDiffblueTest {
  ...
  void testAddRolesItem_givenV2UserCreate() {
    ...
    // Act
    V2UserCreate actualAddRolesItemResult = v2UserCreate.addRolesItem("Roles Item");

    // Assert
    assertSame(v2UserCreate, actualAddRolesItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v2UserCreate.hashCode(), v2UserCreate2.hashCode());
  }
