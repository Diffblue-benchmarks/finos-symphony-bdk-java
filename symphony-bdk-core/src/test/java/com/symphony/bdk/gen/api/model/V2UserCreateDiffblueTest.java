...
class V2UserCreateDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V2UserCreate} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V2UserCreate#addRolesItem(String)}
   */
  @Test
   ...
   * Test {@link V2UserCreate#addRolesItem(String)}.
   * <ul>
   *   <li>Given {@link V2UserCreate} (default constructor) roles {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V2UserCreate#addRolesItem(String)}
   */
  @Test
  @DisplayName("Test addRolesItem(String); given V2UserCreate (default constructor) roles ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2UserCreate V2UserCreate.addRolesItem(String)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2UserCreate#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2UserCreate.<init>()", "Password V2UserCreate.getPassword()",
      "List V2UserCreate.getRoles()", "V2UserAttributes V2UserCreate.getUserAttributes()",
      "V2UserCreate V2UserCreate.password(Password)", "V2UserCreate V2UserCreate.roles(List)",
      "void V2UserCreate.setPassword(Password)", "void V2UserCreate.setRoles(List)",
      "void V2UserCreate.setUserAttributes(V2UserAttributes)", "String V2UserCreate.toString()",
