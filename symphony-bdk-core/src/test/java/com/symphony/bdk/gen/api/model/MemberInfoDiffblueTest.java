...
class MemberInfoDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link MemberInfo} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link MemberInfo#addAddedThroughGroupsItem(Long)}
   */
  @Test
   ...
   * Test {@link MemberInfo#addAddedThroughGroupsItem(Long)}.
   * <ul>
   *   <li>Given {@link MemberInfo} (default constructor) AddedThroughGroups is {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link MemberInfo#addAddedThroughGroupsItem(Long)}
   */
  @Test
  @DisplayName("Test addAddedThroughGroupsItem(Long); given MemberInfo (default constructor) AddedThroughGroups is ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"MemberInfo MemberInfo.addAddedThroughGroupsItem(Long)"})
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void MemberInfo.<init>()", "MemberInfo MemberInfo.addedThroughGroups(List)",
      "List MemberInfo.getAddedThroughGroups()", "Long MemberInfo.getId()", "Long MemberInfo.getJoinDate()",
      "Boolean MemberInfo.getOwner()", "MemberInfo MemberInfo.id(Long)", "MemberInfo MemberInfo.joinDate(Long)",
      "MemberInfo MemberInfo.owner(Boolean)", "void MemberInfo.setAddedThroughGroups(List)",
      "void MemberInfo.setId(Long)", "void MemberInfo.setJoinDate(Long)", "void MemberInfo.setOwner(Boolean)",
  ...
  void testGettersAndSetters() {
    ...
    MemberInfo actualAddedThroughGroupsResult = actualMemberInfo.addedThroughGroups(addedThroughGroups);
