...
class V3HealthComponentDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "boolean V3HealthComponent.equals(Object)",
    "int V3HealthComponent.hashCode()"
  })
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v3HealthComponent.hashCode(), v3HealthComponent2.hashCode());
  }
   ...
   * </ul>
   *
   * <p>Method under test: {@link V3HealthComponent#equals(Object)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void V3HealthComponent.<init>()",
    "V3HealthComponent V3HealthComponent.authType(V3HealthAuthType)",
    "V3HealthAuthType V3HealthComponent.getAuthType()",
    "String V3HealthComponent.getMessage()",
    "V3HealthStatus V3HealthComponent.getStatus()",
    "String V3HealthComponent.getVersion()",
    "V3HealthComponent V3HealthComponent.message(String)",
    "void V3HealthComponent.setAuthType(V3HealthAuthType)",
    "void V3HealthComponent.setMessage(String)",
    "void V3HealthComponent.setStatus(V3HealthStatus)",
    "void V3HealthComponent.setVersion(String)",
    "V3HealthComponent V3HealthComponent.status(V3HealthStatus)",
    "String V3HealthComponent.toString()",
    "V3HealthComponent V3HealthComponent.version(String)"
  })
  void testGettersAndSetters() {
    ...
    V3HealthComponent actualMessageResult =
        actualV3HealthComponent.message("Not all who wander are lost");
