...
class V1DLPViolationSignalResponseDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V1DLPViolationSignalResponse#addViolationsItem(V1DLPViolationSignal)}
   */
  @Test
  ...
  void testAddViolationsItem() {
    ...
    // Act and Assert
    assertSame(v1dlpViolationSignalResponse,
        v1dlpViolationSignalResponse.addViolationsItem(new V1DLPViolationSignal()));
  }

  /**
   * Test {@link V1DLPViolationSignalResponse#equals(Object)}, and {@link V1DLPViolationSignalResponse#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V1DLPViolationSignalResponse.equals(Object)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPViolationSignalResponse#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V1DLPViolationSignalResponse(), "Different type to V1DLPViolationSignalResponse");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPViolationSignalResponse.<init>()",
      "String V1DLPViolationSignalResponse.getNextOffset()", "List V1DLPViolationSignalResponse.getViolations()",
      ...
      "void V1DLPViolationSignalResponse.setViolations(List)", "String V1DLPViolationSignalResponse.toString()",
      "V1DLPViolationSignalResponse V1DLPViolationSignalResponse.violations(List)"})
  void testGettersAndSetters() {
    // Arrange and Act
    V1DLPViolationSignalResponse actualV1dlpViolationSignalResponse = new V1DLPViolationSignalResponse();
    V1DLPViolationSignalResponse actualNextOffsetResult = actualV1dlpViolationSignalResponse.nextOffset("Next Offset");
    ...
    V1DLPViolationSignalResponse actualViolationsResult = actualV1dlpViolationSignalResponse.violations(violations);
    ...
    List<V1DLPViolationSignal> actualViolations = actualV1dlpViolationSignalResponse.getViolations();

    // Assert
    assertEquals("Next Offset", actualNextOffset);
    assertEquals("class V1DLPViolationSignalResponse {\n    violations: []\n    nextOffset: Next Offset\n}",
