...
class V1DLPViolationSignalResponseDiffblueTest {
  ...
  void testAddViolationsItem() {
    ...
    // Act
    V1DLPViolationSignalResponse actualAddViolationsItemResult =
        v1dlpViolationSignalResponse.addViolationsItem(new V1DLPViolationSignal());

    // Assert
    assertSame(v1dlpViolationSignalResponse, actualAddViolationsItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(v1dlpViolationSignalResponse.hashCode(), v1dlpViolationSignalResponse2.hashCode());
  }
