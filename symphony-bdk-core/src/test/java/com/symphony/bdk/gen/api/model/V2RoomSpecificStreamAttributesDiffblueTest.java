...
class V2RoomSpecificStreamAttributesDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V2RoomSpecificStreamAttributes} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V2RoomSpecificStreamAttributes#addGroupsItem(GroupItem)}
   */
  @Test
  @DisplayName("Test addGroupsItem(GroupItem); given V2RoomSpecificStreamAttributes (default constructor)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2RoomSpecificStreamAttributes V2RoomSpecificStreamAttributes.addGroupsItem(GroupItem)"})
  void testAddGroupsItem_givenV2RoomSpecificStreamAttributes() {
    // Arrange
    V2RoomSpecificStreamAttributes v2RoomSpecificStreamAttributes = new V2RoomSpecificStreamAttributes();

    // Act and Assert
    assertSame(v2RoomSpecificStreamAttributes, v2RoomSpecificStreamAttributes.addGroupsItem(new GroupItem()));
  }

  /**
   * Test {@link V2RoomSpecificStreamAttributes#addGroupsItem(GroupItem)}.
   * <ul>
   *   <li>Given {@link V2RoomSpecificStreamAttributes} (default constructor) groups {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V2RoomSpecificStreamAttributes#addGroupsItem(GroupItem)}
   */
  @Test
  @DisplayName("Test addGroupsItem(GroupItem); given V2RoomSpecificStreamAttributes (default constructor) groups ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2RoomSpecificStreamAttributes V2RoomSpecificStreamAttributes.addGroupsItem(GroupItem)"})
  ...
  /**
   * Test {@link V2RoomSpecificStreamAttributes#equals(Object)}, and {@link V2RoomSpecificStreamAttributes#hashCode()}.
   * <ul>
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean V2RoomSpecificStreamAttributes.equals(Object)",
      "int V2RoomSpecificStreamAttributes.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    V2RoomSpecificStreamAttributes v2RoomSpecificStreamAttributes = new V2RoomSpecificStreamAttributes();
    V2RoomSpecificStreamAttributes v2RoomSpecificStreamAttributes2 = new V2RoomSpecificStreamAttributes();
   ...
   * </ul>
   * <p>
   * Method under test: {@link V2RoomSpecificStreamAttributes#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new V2RoomSpecificStreamAttributes(), "Different type to V2RoomSpecificStreamAttributes");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V2RoomSpecificStreamAttributes.<init>()", "List V2RoomSpecificStreamAttributes.getGroups()",
      ...
      "void V2RoomSpecificStreamAttributes.setGroups(List)", "void V2RoomSpecificStreamAttributes.setName(String)",
      "String V2RoomSpecificStreamAttributes.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    V2RoomSpecificStreamAttributes actualV2RoomSpecificStreamAttributes = new V2RoomSpecificStreamAttributes();
    V2RoomSpecificStreamAttributes actualGroupsResult = actualV2RoomSpecificStreamAttributes.groups(new ArrayList<>());
    V2RoomSpecificStreamAttributes actualNameResult = actualV2RoomSpecificStreamAttributes.name("Name");
    ...
    assertEquals("class V2RoomSpecificStreamAttributes {\n    name: Name\n    groups: []\n}", actualToStringResult);
