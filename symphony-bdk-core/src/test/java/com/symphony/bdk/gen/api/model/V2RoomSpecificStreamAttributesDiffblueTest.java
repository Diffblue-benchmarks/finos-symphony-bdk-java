...
class V2RoomSpecificStreamAttributesDiffblueTest {
  ...
  void testAddGroupsItem_givenV2RoomSpecificStreamAttributes() {
    ...
    // Act
    V2RoomSpecificStreamAttributes actualAddGroupsItemResult =
        v2RoomSpecificStreamAttributes.addGroupsItem(new GroupItem());

    // Assert
    assertSame(v2RoomSpecificStreamAttributes, actualAddGroupsItemResult);
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(
        v2RoomSpecificStreamAttributes.hashCode(), v2RoomSpecificStreamAttributes2.hashCode());
  }
