...
class ExtensionAppAuthenticateRequestDiffblueTest {
  /**
   * Test {@link ExtensionAppAuthenticateRequest#equals(Object)}, and {@link ExtensionAppAuthenticateRequest#hashCode()}.
   * <ul>
  ...
  @MethodsUnderTest({"boolean ExtensionAppAuthenticateRequest.equals(Object)",
      "int ExtensionAppAuthenticateRequest.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    // Arrange
    ExtensionAppAuthenticateRequest extensionAppAuthenticateRequest = new ExtensionAppAuthenticateRequest();
    ExtensionAppAuthenticateRequest extensionAppAuthenticateRequest2 = new ExtensionAppAuthenticateRequest();
   ...
   * </ul>
   * <p>
   * Method under test: {@link ExtensionAppAuthenticateRequest#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    // Arrange, Act and Assert
    assertNotEquals(new ExtensionAppAuthenticateRequest(), "Different type to ExtensionAppAuthenticateRequest");
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void ExtensionAppAuthenticateRequest.<init>()",
      ...
      "void ExtensionAppAuthenticateRequest.setAppToken(String)", "String ExtensionAppAuthenticateRequest.toString()"})
  void testGettersAndSetters() {
    // Arrange and Act
    ExtensionAppAuthenticateRequest actualExtensionAppAuthenticateRequest = new ExtensionAppAuthenticateRequest();
    ExtensionAppAuthenticateRequest actualAppTokenResult = actualExtensionAppAuthenticateRequest.appToken("ABC123");
    ...
    assertEquals("class ExtensionAppAuthenticateRequest {\n    appToken: ABC123\n}", actualToStringResult);
