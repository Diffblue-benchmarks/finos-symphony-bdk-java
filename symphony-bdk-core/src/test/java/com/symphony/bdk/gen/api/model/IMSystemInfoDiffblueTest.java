...
class IMSystemInfoDiffblueTest {
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, imSystemInfo2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link IMSystemInfo#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void IMSystemInfo.<init>()", "IMSystemInfo IMSystemInfo.active(Boolean)",
      "IMSystemInfo IMSystemInfo.creationDate(Long)", "Boolean IMSystemInfo.getActive()",
      "Long IMSystemInfo.getCreationDate()", "String IMSystemInfo.getId()", "IMSystemInfo IMSystemInfo.id(String)",
      "void IMSystemInfo.setActive(Boolean)", "void IMSystemInfo.setCreationDate(Long)",
      "void IMSystemInfo.setId(String)", "String IMSystemInfo.toString()"})
  void testGettersAndSetters() {
    ...
    assertEquals("class IMSystemInfo {\n    id: 42\n    creationDate: 1\n    active: true\n}", actualToStringResult);
