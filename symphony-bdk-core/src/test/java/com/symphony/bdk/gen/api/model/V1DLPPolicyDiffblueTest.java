...
class V1DLPPolicyDiffblueTest {
   ...
   * <p>
   * Method under test: {@link V1DLPPolicy#addContentTypesItem(String)}
   */
  @Test
  ...
  void testAddContentTypesItem() {
    ...
    // Act and Assert
    assertSame(v1dlpPolicy, v1dlpPolicy.addContentTypesItem("text/plain"));
  }

  /**
   * Test {@link V1DLPPolicy#addDictionaryRefsItem(V1DLPDictionaryRef)}.
   * <p>
   * Method under test: {@link V1DLPPolicy#addDictionaryRefsItem(V1DLPDictionaryRef)}
   */
  @Test
  ...
  void testAddDictionaryRefsItem() {
    ...
    // Act and Assert
    assertSame(v1dlpPolicy, v1dlpPolicy.addDictionaryRefsItem(new V1DLPDictionaryRef()));
  }

  /**
   * Test {@link V1DLPPolicy#addScopesItem(String)}.
   * <p>
   * Method under test: {@link V1DLPPolicy#addScopesItem(String)}
   */
  @Test
  ...
  void testAddScopesItem() {
    ...
    // Act and Assert
    assertSame(v1dlpPolicy, v1dlpPolicy.addScopesItem("Scopes Item"));
  }
  ...
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    assertEquals(expectedHashCodeResult, v1dlpPolicy2.hashCode());
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link V1DLPPolicy#equals(Object)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void V1DLPPolicy.<init>()", "V1DLPPolicy V1DLPPolicy.active(Boolean)",
      "V1DLPPolicy V1DLPPolicy.contentTypes(List)", "V1DLPPolicy V1DLPPolicy.creationDate(Long)",
      "V1DLPPolicy V1DLPPolicy.creatorId(String)", "V1DLPPolicy V1DLPPolicy.dictionaryRefs(List)",
      "Boolean V1DLPPolicy.getActive()", "List V1DLPPolicy.getContentTypes()", "Long V1DLPPolicy.getCreationDate()",
      "String V1DLPPolicy.getCreatorId()", "List V1DLPPolicy.getDictionaryRefs()",
      "Long V1DLPPolicy.getLastDisabledDate()", "Long V1DLPPolicy.getLastUpdatedDate()", "String V1DLPPolicy.getName()",
      "String V1DLPPolicy.getPolicyId()", "List V1DLPPolicy.getScopes()", "String V1DLPPolicy.getType()",
      "String V1DLPPolicy.getVersion()", "V1DLPPolicy V1DLPPolicy.lastDisabledDate(Long)",
      "V1DLPPolicy V1DLPPolicy.lastUpdatedDate(Long)", "V1DLPPolicy V1DLPPolicy.name(String)",
      "V1DLPPolicy V1DLPPolicy.policyId(String)", "V1DLPPolicy V1DLPPolicy.scopes(List)",
      "void V1DLPPolicy.setActive(Boolean)", "void V1DLPPolicy.setContentTypes(List)",
      "void V1DLPPolicy.setCreationDate(Long)", "void V1DLPPolicy.setCreatorId(String)",
      "void V1DLPPolicy.setDictionaryRefs(List)", "void V1DLPPolicy.setLastDisabledDate(Long)",
      "void V1DLPPolicy.setLastUpdatedDate(Long)", "void V1DLPPolicy.setName(String)",
      "void V1DLPPolicy.setPolicyId(String)", "void V1DLPPolicy.setScopes(List)", "void V1DLPPolicy.setType(String)",
      "void V1DLPPolicy.setVersion(String)", "String V1DLPPolicy.toString()", "V1DLPPolicy V1DLPPolicy.type(String)",
  ...
  void testGettersAndSetters() {
    ...
    assertEquals("class V1DLPPolicy {\n" + "    active: true\n" + "    contentTypes: []\n" + "    creationDate: 1\n"
        + "    creatorId: 42\n" + "    dictionaryRefs: []\n" + "    lastDisabledDate: 1\n" + "    lastUpdatedDate: 1\n"
        + "    name: Name\n" + "    policyId: 42\n" + "    scopes: []\n" + "    type: Type\n" + "    version: 1.0.2\n"
