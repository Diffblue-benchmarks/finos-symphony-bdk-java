...
class V2AdminStreamListDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link V2AdminStreamList} (default constructor).</li>
   * </ul>
   * <p>
   * Method under test: {@link V2AdminStreamList#addStreamsItem(V2AdminStreamInfo)}
   */
  @Test
  @DisplayName("Test addStreamsItem(V2AdminStreamInfo); given V2AdminStreamList (default constructor)")
  ...
  void testAddStreamsItem_givenV2AdminStreamList() {
    ...
    // Act and Assert
    assertSame(v2AdminStreamList, v2AdminStreamList.addStreamsItem(new V2AdminStreamInfo()));
  }

  /**
   * Test {@link V2AdminStreamList#addStreamsItem(V2AdminStreamInfo)}.
   * <ul>
   *   <li>Given {@link V2AdminStreamList} (default constructor) streams {@link ArrayList#ArrayList()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link V2AdminStreamList#addStreamsItem(V2AdminStreamInfo)}
   */
  @Test
  @DisplayName("Test addStreamsItem(V2AdminStreamInfo); given V2AdminStreamList (default constructor) streams ArrayList()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"V2AdminStreamList V2AdminStreamList.addStreamsItem(V2AdminStreamInfo)"})
  ...
  @MethodsUnderTest({"void V2AdminStreamList.<init>()", "V2AdminStreamList V2AdminStreamList.count(Long)",
      "V2AdminStreamList V2AdminStreamList.filter(V2AdminStreamFilter)", "Long V2AdminStreamList.getCount()",
      "V2AdminStreamFilter V2AdminStreamList.getFilter()", "Integer V2AdminStreamList.getLimit()",
      "Integer V2AdminStreamList.getSkip()", "List V2AdminStreamList.getStreams()",
      "V2AdminStreamList V2AdminStreamList.limit(Integer)", "void V2AdminStreamList.setCount(Long)",
      "void V2AdminStreamList.setFilter(V2AdminStreamFilter)", "void V2AdminStreamList.setLimit(Integer)",
      "void V2AdminStreamList.setSkip(Integer)", "void V2AdminStreamList.setStreams(List)",
      "V2AdminStreamList V2AdminStreamList.skip(Integer)", "V2AdminStreamList V2AdminStreamList.streams(List)",
  ...
  void testGettersAndSetters() {
    ...
    V2AdminStreamList actualFilterResult = actualV2AdminStreamList.filter(new V2AdminStreamFilter());
