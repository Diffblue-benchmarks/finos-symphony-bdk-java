...
class MessageParserExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link MessageParserException#MessageParserException(String, Exception)}
   */
  @Test
  ...
  void testNewMessageParserException() {
    ...
    // Act
    MessageParserException actualMessageParserException =
        new MessageParserException("An error occurred", e);
