...
class CursorBasedPaginatedServiceDiffblueTest {
  ...
  void testNewCursorBasedPaginatedService() {
    ...
    CursorBasedPaginatedService<Object> actualCursorBasedPaginatedService =
        new CursorBasedPaginatedService<>(mock(CursorBasedPaginatedApi.class), null, null);
  ...
  @Test
  @DisplayName(
      "Test new CursorBasedPaginatedService(CursorBasedPaginatedApi, Integer, Integer); when three; then return chunkSize is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CursorBasedPaginatedService.<init>(CursorBasedPaginatedApi, Integer, Integer)"
