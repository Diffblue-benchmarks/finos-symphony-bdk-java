...
class RetryWithRecoveryBuilderDiffblueTest {
  ...
  void testCopyWithoutRecoveryStrategies_thenBuildReturnResilience4jRetryWithRecovery() {
    ...
    // Assert
    assertTrue(
        actualCopyWithoutRecoveryStrategiesResult.build() instanceof Resilience4jRetryWithRecovery);
  }
  ...
  void testIgnoreException() {
    ...
    // Act and Assert
    assertSame(
        retryWithRecoveryBuilder, retryWithRecoveryBuilder.ignoreException(mock(Predicate.class)));
  }
