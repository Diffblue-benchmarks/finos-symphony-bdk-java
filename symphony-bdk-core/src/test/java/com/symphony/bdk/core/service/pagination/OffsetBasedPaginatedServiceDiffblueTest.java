...
class OffsetBasedPaginatedServiceDiffblueTest {
  ...
  void testNewOffsetBasedPaginatedService() {
    ...
    OffsetBasedPaginatedService<Object> actualOffsetBasedPaginatedService =
        new OffsetBasedPaginatedService<>(mock(OffsetBasedPaginatedApi.class), null, null);
  ...
  @Test
  @DisplayName(
      "Test new OffsetBasedPaginatedService(OffsetBasedPaginatedApi, Integer, Integer); when three; then return chunkSize is three")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void OffsetBasedPaginatedService.<init>(OffsetBasedPaginatedApi, Integer, Integer)"
