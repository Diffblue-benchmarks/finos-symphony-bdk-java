...
class OnDiskDatafeedIdRepositoryDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test write(String, String) with 'datafeedId', 'agentBasePath'; given Files readSymbolicLink(Path) return 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OnDiskDatafeedIdRepository.write(String, String)"})
  void testWriteWithDatafeedIdAgentBasePath_givenFilesReadSymbolicLinkReturnNull()
      throws IOException {
    try (MockedStatic<Files> mockFiles = mockStatic(Files.class)) {
   ...
   *
   * <ul>
   *   <li>Given {@link Files} {@link Files#newOutputStream(Path, OpenOption[])} return {@link
  ...
  @Test
  @DisplayName(
      "Test write(String) with 'datafeedId'; given Files newOutputStream(Path, OpenOption[]) return ByteArrayOutputStream()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OnDiskDatafeedIdRepository.write(String)"})
  void testWriteWithDatafeedId_givenFilesNewOutputStreamReturnByteArrayOutputStream()
      throws IOException {
    try (MockedStatic<Files> mockFiles = mockStatic(Files.class)) {
  ...
  @Test
  @DisplayName(
      "Test write(String) with 'datafeedId'; given Files readSymbolicLink(Path) return 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void OnDiskDatafeedIdRepository.write(String)"})
   ...
   *
   * <ul>
   *   <li>Given {@link BdkDatafeedConfig} (default constructor) IdFilePath is {@code Config}.
   * </ul>
   *
   * <p>Method under test: {@link OnDiskDatafeedIdRepository#read()}
   */
  @Test
  @DisplayName("Test read(); given BdkDatafeedConfig (default constructor) IdFilePath is 'Config'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.util.Optional OnDiskDatafeedIdRepository.read()"})
  void testRead_givenBdkDatafeedConfigIdFilePathIsConfig() throws UnsupportedEncodingException {
    // Arrange
    BdkRsaKeyConfig privateKey = new BdkRsaKeyConfig();
    privateKey.setContent("AXAXAXAX".getBytes("UTF-8"));
    privateKey.setPath("Path");
   ...
   *
   * <ul>
   *   <li>Given {@link BdkDatafeedConfig} (default constructor) IdFilePath is {@code null}.
   * </ul>
   *
   * <p>Method under test: {@link OnDiskDatafeedIdRepository#read()}
   */
  @Test
  @DisplayName("Test read(); given BdkDatafeedConfig (default constructor) IdFilePath is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.util.Optional OnDiskDatafeedIdRepository.read()"})
  void testRead_givenBdkDatafeedConfigIdFilePathIsNull() throws UnsupportedEncodingException {
    // Arrange
    BdkRsaKeyConfig privateKey = new BdkRsaKeyConfig();
    privateKey.setContent("AXAXAXAX".getBytes("UTF-8"));
    privateKey.setPath("Path");
  ...
  @Test
  @DisplayName(
      "Test readAgentBasePath(); given BdkDatafeedConfig (default constructor) IdFilePath is 'Config'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.util.Optional OnDiskDatafeedIdRepository.readAgentBasePath()"})
  void testReadAgentBasePath_givenBdkDatafeedConfigIdFilePathIsConfig()
  ...
  @Test
  @DisplayName(
      "Test readAgentBasePath(); given BdkDatafeedConfig (default constructor) IdFilePath is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"java.util.Optional OnDiskDatafeedIdRepository.readAgentBasePath()"})
  void testReadAgentBasePath_givenBdkDatafeedConfigIdFilePathIsNull()
      throws UnsupportedEncodingException {
    // Arrange
    BdkRsaKeyConfig privateKey = new BdkRsaKeyConfig();
    privateKey.setContent("AXAXAXAX".getBytes("UTF-8"));
