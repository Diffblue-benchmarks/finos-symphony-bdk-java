...
class DatafeedLoadBalancedApiClientDiffblueTest {
  /**
   * Test {@link DatafeedLoadBalancedApiClient#DatafeedLoadBalancedApiClient(BdkConfig,
   * ApiClientFactory)}.
   *
   * <ul>
   ...
   * DatafeedLoadBalancedApiClient#DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory)}
   */
  @Test
  @DisplayName(
      "Test new DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory); given BdkLoadBalancingConfig (default constructor) Mode is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void DatafeedLoadBalancedApiClient.<init>(BdkConfig, ApiClientFactory)"})
  void testNewDatafeedLoadBalancedApiClient_givenBdkLoadBalancingConfigModeIsNull()
    ...
    assertThrows(
        ...
        () -> new DatafeedLoadBalancedApiClient(config, apiClientFactory));
  }
  ...
  @Test
  @DisplayName(
      "Test new DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory); given BdkLoadBalancingConfig (default constructor) Nodes is 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void DatafeedLoadBalancedApiClient.<init>(BdkConfig, ApiClientFactory)"})
  void testNewDatafeedLoadBalancedApiClient_givenBdkLoadBalancingConfigNodesIsNull()
      throws UnsupportedEncodingException {
    // Arrange
    BdkRsaKeyConfig privateKey = new BdkRsaKeyConfig();
    privateKey.setContent("AXAXAXAX".getBytes("UTF-8"));
  ...
  @Test
  @DisplayName(
      "Test new DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory); then throw ApiClientInitializationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void DatafeedLoadBalancedApiClient.<init>(BdkConfig, ApiClientFactory)"})
  void testNewDatafeedLoadBalancedApiClient_thenThrowApiClientInitializationException()
      throws UnsupportedEncodingException {
    // Arrange
    BdkRsaKeyConfig privateKey = new BdkRsaKeyConfig();
    privateKey.setContent("AXAXAXAX".getBytes("UTF-8"));
