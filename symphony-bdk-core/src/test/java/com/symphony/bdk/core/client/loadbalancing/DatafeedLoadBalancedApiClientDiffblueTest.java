...
class DatafeedLoadBalancedApiClientDiffblueTest {
  /**
   * Test {@link DatafeedLoadBalancedApiClient#DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory)}.
   * <p>
   * Method under test: {@link DatafeedLoadBalancedApiClient#DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory)}
   */
  @Test
  @DisplayName("Test new DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DatafeedLoadBalancedApiClient.<init>(BdkConfig, ApiClientFactory)"})
  void testNewDatafeedLoadBalancedApiClient() {
    // Arrange
    ...
    // Act
    DatafeedLoadBalancedApiClient actualDatafeedLoadBalancedApiClient = new DatafeedLoadBalancedApiClient(config,
        apiClientFactory);
    ...
    ApiClient apiClient = actualDatafeedLoadBalancedApiClient.apiClient;
    assertTrue(apiClient instanceof ApiClientJersey2);
    assertEquals("https://example.org/example", actualDatafeedLoadBalancedApiClient.getBasePath());
    assertEquals("https://example.org/example", apiClient.getBasePath());
    BdkLoadBalancingConfig bdkLoadBalancingConfig = actualDatafeedLoadBalancedApiClient.loadBalancingConfig;
    ...
    Map<String, Authentication> authentications = actualDatafeedLoadBalancedApiClient.getAuthentications();
   ...
   */
  @Test
  @DisplayName("Test new DatafeedLoadBalancedApiClient(BdkConfig, ApiClientFactory); then return loadBalancingConfig Mode is 'RANDOM'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DatafeedLoadBalancedApiClient.<init>(BdkConfig, ApiClientFactory)"})
  void testNewDatafeedLoadBalancedApiClient_thenReturnLoadBalancingConfigModeIsRandom() {
    // Arrange
    HashMap<String, String> defaultHeaders = new HashMap<>();
    defaultHeaders.put("Delivered-To", "alice.liddell@example.org");
