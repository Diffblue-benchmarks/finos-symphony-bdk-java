...
class RetryWithRecoveryDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link SSLHandshakeException#SSLHandshakeException(String)} with {@code Just
   *       cause}.
   * </ul>
   *
   * <p>Method under test: {@link RetryWithRecovery#networkIssueMessageError(Throwable, String)}
  ...
  @Test
  @DisplayName(
      "Test networkIssueMessageError(Throwable, String); given SSLHandshakeException(String) with 'Just cause'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String RetryWithRecovery.networkIssueMessageError(Throwable, String)"})
  void testNetworkIssueMessageError_givenSSLHandshakeExceptionWithJustCause() {
    // Arrange
    Exception t = new Exception("An error occurred");
    t.initCause(new SSLHandshakeException("Just cause"));
  ...
  @Test
  @DisplayName(
      "Test networkIssueMessageError(Throwable, String); given SSLHandshakeException(String) with 'Just cause'; when '/agent'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String RetryWithRecovery.networkIssueMessageError(Throwable, String)"})
  void testNetworkIssueMessageError_givenSSLHandshakeExceptionWithJustCause_whenAgent() {
    // Arrange
    Exception t = new Exception("An error occurred");
    t.initCause(new SSLHandshakeException("Just cause"));
  ...
  @Test
  @DisplayName(
      "Test networkIssueMessageError(Throwable, String); given SSLHandshakeException(String) with 'Just cause'; when '/keyauth'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String RetryWithRecovery.networkIssueMessageError(Throwable, String)"})
  void testNetworkIssueMessageError_givenSSLHandshakeExceptionWithJustCause_whenKeyauth() {
    // Arrange
    Exception t = new Exception("An error occurred");
    t.initCause(new SSLHandshakeException("Just cause"));
   ...
   */
  @Test
  @DisplayName("Test networkIssueMessageError(Throwable, String); when '/sessionauth'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"String RetryWithRecovery.networkIssueMessageError(Throwable, String)"})
  void testNetworkIssueMessageError_whenSessionauth() {
    // Arrange
    Exception t = new Exception("An error occurred");
    t.initCause(new SSLHandshakeException("Just cause"));
