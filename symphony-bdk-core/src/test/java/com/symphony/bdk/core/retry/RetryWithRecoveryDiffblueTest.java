...
class RetryWithRecoveryDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException); when '42 Main St'; then throw ApiRuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Object RetryWithRecovery.executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException)"
  ...
  @Test
  @DisplayName(
      "Test executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException); when '/agent'; then throw ApiRuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Object RetryWithRecovery.executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException)"
  ...
  @Test
  @DisplayName(
      "Test executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException); when '/keyauth'; then throw ApiRuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Object RetryWithRecovery.executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException)"
  ...
  @Test
  @DisplayName(
      "Test executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException); when '/relay'; then throw ApiRuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Object RetryWithRecovery.executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException)"
  ...
  @Test
  @DisplayName(
      "Test executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException); when '/sessionauth'; then throw ApiRuntimeException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Object RetryWithRecovery.executeAndRetry(RetryWithRecoveryBuilder, String, String, SupplierWithApiException)"
