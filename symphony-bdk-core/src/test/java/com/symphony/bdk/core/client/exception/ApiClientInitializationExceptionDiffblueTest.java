...
class ApiClientInitializationExceptionDiffblueTest {
   ...
   * <p>
   * Method under test: {@link ApiClientInitializationException#ApiClientInitializationException(String)}
   */
  @Test
  ...
  void testNewApiClientInitializationException() {
    // Arrange and Act
    ApiClientInitializationException actualApiClientInitializationException = new ApiClientInitializationException(
        "An error occurred");
