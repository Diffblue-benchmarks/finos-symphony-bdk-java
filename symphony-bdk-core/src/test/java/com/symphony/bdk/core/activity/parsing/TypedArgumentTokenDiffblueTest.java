...
class TypedArgumentTokenDiffblueTest {
   ...
   *   <li>Then return ArgumentName is {@code tter}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TypedArgumentToken#newInstance(Class, String)}
   */
  @Test
  @DisplayName("Test newInstance(Class, String); when 'Pattern'; then return ArgumentName is 'tter'")
  ...
  void testNewInstance_whenPattern_thenReturnArgumentNameIsTter() {
    ...
    // Act
    TypedArgumentToken<Object> actualNewInstanceResult = TypedArgumentToken.newInstance(type, "Pattern");
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String TypedArgumentToken.getArgumentName()", "Class TypedArgumentToken.getTokenType()"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link TypedArgumentToken#matches(Object)}
   */
  @Test
