...
class MessageParserDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test getMentions(V4Message); given 'Data'; when V4Message (default constructor) data 'Data'; then throw MessageParserException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List MessageParser.getMentions(V4Message)"})
  void testGetMentions_givenData_whenV4MessageDataData_thenThrowMessageParserException()
  ...
  @Test
  @DisplayName(
      "Test getHashtags(V4Message); given 'Data'; when V4Message (default constructor) data 'Data'; then throw MessageParserException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"List MessageParser.getHashtags(V4Message)"})
  void testGetHashtags_givenData_whenV4MessageDataData_thenThrowMessageParserException()
      throws MessageParserException {
    // Arrange
    V4Message message = new V4Message();
    message.data("Data");
