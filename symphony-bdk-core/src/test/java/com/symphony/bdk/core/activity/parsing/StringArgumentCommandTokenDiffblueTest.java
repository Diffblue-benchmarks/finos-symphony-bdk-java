...
class StringArgumentCommandTokenDiffblueTest {
   ...
   *   <li>Then return ArgumentName is {@code atter}.</li>
   * </ul>
   * <p>
   * Method under test: {@link StringArgumentCommandToken#newInstance(String)}
   */
  @Test
  ...
  void testNewInstance_whenPattern_thenReturnArgumentNameIsAtter() {
    // Arrange and Act
    StringArgumentCommandToken actualNewInstanceResult = StringArgumentCommandToken.newInstance("Pattern");
    ...
    assertEquals(StringArgumentCommandToken.ARGUMENT_VALUE_REGEX, actualNewInstanceResult.getRegexPattern().pattern());
  }
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void StringArgumentCommandToken.<init>(String)",
      "String StringArgumentCommandToken.getArgumentName()",
      "java.util.regex.Pattern StringArgumentCommandToken.getRegexPattern()"})
  void testGettersAndSetters() {
    // Arrange and Act
    StringArgumentCommandToken actualStringArgumentCommandToken = new StringArgumentCommandToken("Argument Name");
