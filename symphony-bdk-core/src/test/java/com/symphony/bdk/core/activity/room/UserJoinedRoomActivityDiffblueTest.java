...
class UserJoinedRoomActivityDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link UserJoinedRoomActivity#bindToRealTimeEventsSource(Consumer)}
   */
  @Test
  ...
  /**
   * Test {@link UserJoinedRoomActivity#beforeMatcher(UserJoinedRoomContext)} with {@code UserJoinedRoomContext}.
   * <p>
   * Method under test: {@link UserJoinedRoomActivity#beforeMatcher(UserJoinedRoomContext)}
   */
  @Test
