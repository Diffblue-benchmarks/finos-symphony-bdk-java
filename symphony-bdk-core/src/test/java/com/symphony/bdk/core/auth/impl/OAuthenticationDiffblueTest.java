...
class OAuthenticationDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@link SupplierWithApiException} {@link SupplierWithApiException#get()} return {@code Get}.</li>
   *   <li>Then {@link HashMap#HashMap()} size is one.</li>
   * </ul>
   * <p>
   * Method under test: {@link OAuthentication#apply(Map)}
   */
  @Test
  @DisplayName("Test apply(Map); given SupplierWithApiException get() return 'Get'; then HashMap() size is one")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void OAuthentication.apply(Map)"})
  void testApply_givenSupplierWithApiExceptionGetReturnGet_thenHashMapSizeIsOne() throws ApiException {
    // Arrange
