...
class PresentationMLParserDiffblueTest {
   ...
   * <p>
   * Method under test: {@link PresentationMLParser#getTextContent(String)}
   */
  @Test
  ...
  void testGetTextContentWithPresentationML() throws PresentationMLParserException {
    ...
    assertThrows(PresentationMLParserException.class, () -> PresentationMLParser.getTextContent("Presentation ML"));
  }

  /**
   * Test {@link PresentationMLParser#getTextContent(String, Boolean)} with {@code presentationML}, {@code trim}.
   * <p>
   * Method under test: {@link PresentationMLParser#getTextContent(String, Boolean)}
   */
  @Test
