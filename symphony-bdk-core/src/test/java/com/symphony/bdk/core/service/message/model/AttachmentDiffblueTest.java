...
class AttachmentDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test new Attachment(InputStream, String); when empty string; then throw MessageCreationException")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void Attachment.<init>(InputStream, String)"})
  void testNewAttachment_whenEmptyString_thenThrowMessageCreationException()
  ...
  void testNewAttachment_whenFooTxt_thenReturnFilenameIsFooTxt() throws IOException {
    ...
    int actualReadResult2 = content.read(new byte[] {});
