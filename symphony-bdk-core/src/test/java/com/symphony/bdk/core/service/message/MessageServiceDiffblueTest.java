...
class MessageServiceDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"OboMessageService MessageService.obo(AuthSession)"})
  void testObo_thenReturnMessageService() {
    ...
    // Act
    OboMessageService actualOboResult = messageService.obo(new AuthSessionImpl(authenticator));

    // Assert
    assertTrue(actualOboResult instanceof MessageService);
  }
  ...
  void testSendWithStringMessage_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(
        IllegalArgumentException.class, () -> messageService.send("42", mock(Message.class)));
    verify(messagesApi).getApiClient();
  }
  ...
  void testSendWithStringString_thenThrowIllegalArgumentException() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> messageService.send("42", "Not all who wander are lost"));
    verify(messagesApi).getApiClient();
  }
  ...
  void testGetAttachmentTypes_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> messageService.getAttachmentTypes());
  ...
  void testUpdateWithStreamIdMessageIdContent_thenThrowIllegalArgumentException() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> messageService.update("42", "42", mock(Message.class)));
    verify(messagesApi).getApiClient();
  }
  ...
  void testGetAttachment_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(
        IllegalArgumentException.class, () -> messageService.getAttachment("42", "42", "42"));
  ...
  void testSuppressMessage_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> messageService.suppressMessage("42"));
  ...
  void testGetMessageStatus_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> messageService.getMessageStatus("42"));
    verify(messageApi).getApiClient();
  }
  ...
  void testGetMessage_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> messageService.getMessage("42"));
    verify(messagesApi).getApiClient();
  }
  ...
  void testListMessageReceipts_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(IllegalArgumentException.class, () -> messageService.listMessageReceipts("42"));
  ...
  void testGetMessageRelationships_thenThrowIllegalArgumentException() {
    ...
    // Act and Assert
    assertThrows(
        IllegalArgumentException.class, () -> messageService.getMessageRelationships("42"));
    verify(defaultApi).getApiClient();
  }
}
