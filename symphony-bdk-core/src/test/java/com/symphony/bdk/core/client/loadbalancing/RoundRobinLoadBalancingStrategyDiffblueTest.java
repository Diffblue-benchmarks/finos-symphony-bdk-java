...
class RoundRobinLoadBalancingStrategyDiffblueTest {
   ...
   * <p>
   * Method under test: {@link RoundRobinLoadBalancingStrategy#RoundRobinLoadBalancingStrategy(List)}
   */
  @Test
  ...
  void testNewRoundRobinLoadBalancingStrategy() {
    ...
    // Act and Assert
    assertEquals("Scheme://localhost:8080/Context", (new RoundRobinLoadBalancingStrategy(nodes)).getNewBasePath());
  }

  /**
   * Test {@link RoundRobinLoadBalancingStrategy#RoundRobinLoadBalancingStrategy(List)}.
   * <ul>
   *   <li>Then return NewBasePath is {@code Scheme://Context:1}.</li>
   * </ul>
   * <p>
   * Method under test: {@link RoundRobinLoadBalancingStrategy#RoundRobinLoadBalancingStrategy(List)}
   */
  @Test
  @DisplayName("Test new RoundRobinLoadBalancingStrategy(List); then return NewBasePath is 'Scheme://Context:1'")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void RoundRobinLoadBalancingStrategy.<init>(List)"})
   ...
   * </ul>
   * <p>
   * Method under test: {@link RoundRobinLoadBalancingStrategy#getNewBasePath()}
   */
  @Test
