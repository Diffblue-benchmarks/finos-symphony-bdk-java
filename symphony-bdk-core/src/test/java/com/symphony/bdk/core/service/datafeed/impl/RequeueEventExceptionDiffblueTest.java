...
class RequeueEventExceptionDiffblueTest {
  /**
   * Test {@link RequeueEventException#RequeueEventException(V4Event, RealTimeEventListener,
   * EventException)}.
   *
   * <p>Method under test: {@link RequeueEventException#RequeueEventException(V4Event,
   * RealTimeEventListener, EventException)}
   */
  @Test
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void RequeueEventException.<init>(V4Event, RealTimeEventListener, EventException)"
  })
  void testNewRequeueEventException() {
    ...
    // Act
    RequeueEventException actualRequeueEventException =
        new RequeueEventException(event, listener, e);
