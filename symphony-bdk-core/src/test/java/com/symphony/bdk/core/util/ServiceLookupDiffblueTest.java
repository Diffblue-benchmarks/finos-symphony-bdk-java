...
class ServiceLookupDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link ServiceLookup#lookupSingleService(Class)}
   */
  @Test
  @DisplayName("Test lookupSingleService(Class); when 'java.lang.Object'; then throw IllegalStateException")
