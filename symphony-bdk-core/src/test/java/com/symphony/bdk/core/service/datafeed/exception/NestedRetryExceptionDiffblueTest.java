...
class NestedRetryExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link NestedRetryException#NestedRetryException(String, Throwable)}
   */
  @Test
  ...
  void testNewNestedRetryException() {
    ...
    // Act
    NestedRetryException actualNestedRetryException =
        new NestedRetryException("An error occurred", cause);
