...
class HealthServiceDiffblueTest {
  ...
  void testHealthCheck() throws ApiException {
    ...
    // Act and Assert
    assertThrows(ApiRuntimeException.class, () -> healthService.healthCheck());
  ...
  void testHealthCheck_givenSystemApiV3HealthReturnV3Health_thenReturnV3Health()
    ...
    // Act
    V3Health actualHealthCheckResult = healthService.healthCheck();
  ...
  void testHealthCheckExtended() throws ApiException {
    ...
    // Act and Assert
    assertThrows(ApiRuntimeException.class, () -> healthService.healthCheckExtended());
  ...
  void testHealthCheckExtended_thenReturnV3Health() throws ApiException {
    ...
    // Act
    V3Health actualHealthCheckExtendedResult = healthService.healthCheckExtended();
  ...
  void testDatafeedHealthCheck_givenDatafeedLoopLastPullTimestampReturnOne() {
    ...
    // Act
    healthService.datafeedHealthCheck();
  ...
  void testDatafeedHealthCheck_thenReturnDown() {
    ...
    // Act and Assert
    assertEquals(V3HealthStatus.DOWN, healthService.datafeedHealthCheck());
  }
  ...
  void testDatafeedHealthCheck_thenReturnUp() {
    ...
    // Act
    V3HealthStatus actualDatafeedHealthCheckResult = healthService.datafeedHealthCheck();
  ...
  void testDatafeedHealthCheck_thenThrowApiRuntimeException() {
    ...
    // Act and Assert
    assertThrows(ApiRuntimeException.class, () -> healthService.datafeedHealthCheck());
    verify(datafeedLoop).lastPullTimestamp();
  }
  ...
  void testGetAgentInfo() throws ApiException {
    ...
    // Act and Assert
    assertThrows(ApiRuntimeException.class, () -> healthService.getAgentInfo());
  ...
  void testGetAgentInfo_givenSignalsApiV1InfoGetReturnAgentInfo_thenReturnAgentInfo()
    ...
    // Act
    AgentInfo actualAgentInfo = healthService.getAgentInfo();
