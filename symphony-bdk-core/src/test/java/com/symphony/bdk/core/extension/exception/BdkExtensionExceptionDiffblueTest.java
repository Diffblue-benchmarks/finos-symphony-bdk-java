...
class BdkExtensionExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link BdkExtensionException#BdkExtensionException(String, Throwable)}
   */
  @Test
  ...
  void testNewBdkExtensionException() {
    ...
    // Act
    BdkExtensionException actualBdkExtensionException =
        new BdkExtensionException("An error occurred", cause);
