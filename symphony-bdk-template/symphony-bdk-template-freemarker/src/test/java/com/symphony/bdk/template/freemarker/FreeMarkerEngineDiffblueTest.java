...
class FreeMarkerEngineDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test newTemplateFromString(String); when 'computer/'; then return FreeMarkerTemplate")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "com.symphony.bdk.template.api.Template FreeMarkerEngine.newTemplateFromString(String)"
  })
  void testNewTemplateFromString_whenComputer_thenReturnFreeMarkerTemplate() {
    // Arrange, Act and Assert
    assertTrue(
        new FreeMarkerEngine().newTemplateFromString("computer/") instanceof FreeMarkerTemplate);
  }
