...
class GifCommandDiffblueTest {
   ...
   * <p>
   * Method under test: {@link GifCommand#pattern()}
   */
  @Test
   ...
   *   <li>Then calls {@link GifCommandContext#getCategory()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link GifCommand#onActivity(GifCommandContext)}
   */
  @Test
  @DisplayName("Test onActivity(GifCommandContext) with 'GifCommandContext'; given 'Category'; then calls getCategory()")
  @Tag("MaintainedByDiffblue")
   ...
   * <p>
   * Method under test: {@link GifCommand#info()}
   */
  @Test
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link GifCommand}
   */
  @Test
