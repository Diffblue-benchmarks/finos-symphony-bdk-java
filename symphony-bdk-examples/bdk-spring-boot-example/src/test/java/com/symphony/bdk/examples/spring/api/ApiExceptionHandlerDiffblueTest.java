...
class ApiExceptionHandlerDiffblueTest {
  ...
  @Test
  @DisplayName(
      "Test resourceNotFoundException(ApiRuntimeException); given 'java.lang.Object'; then calls findAndAddModules()")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "org.springframework.http.ResponseEntity ApiExceptionHandler.resourceNotFoundException(ApiRuntimeException)"
  })
  void testResourceNotFoundException_givenJavaLangObject_thenCallsFindAndAddModules()
    ...
    ApiExceptionHandler apiExceptionHandler =
        new ApiExceptionHandler(builder.findAndAddModules().build());
