...
class EchoActivityDiffblueTest {
  @Autowired
  private EchoActivity echoActivity;

  @MockBean
  private MessageService messageService;

  /**
   * Test {@link EchoActivity#echo(CommandContext, String, Cashtag)} with {@code context}, {@code argument}, {@code cashtag}.
   * <ul>
   *   <li>Then calls {@link CommandContext#getStreamId()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link EchoActivity#echo(CommandContext, String, Cashtag)}
   */
  @Test
  @DisplayName("Test echo(CommandContext, String, Cashtag) with 'context', 'argument', 'cashtag'; then calls getStreamId()")
  ...
  void testEchoWithContextArgumentCashtag_thenCallsGetStreamId() {
    // Arrange
    when(messageService.send(Mockito.<String>any(), Mockito.<String>any())).thenReturn(new V4Message());
    ...
    verify(messageService).send(eq("42"), eq("Received argument: Argument and cashtag: 42"));
  }

  /**
   * Test {@link EchoActivity#echo(CommandContext, String)} with {@code context}, {@code argument}.
   * <ul>
   *   <li>Then calls {@link ActivityContext#getEventTimestamp()}.</li>
   * </ul>
   * <p>
   * Method under test: {@link EchoActivity#echo(CommandContext, String)}
   */
  @Test
  @DisplayName("Test echo(CommandContext, String) with 'context', 'argument'; then calls getEventTimestamp()")
  @Tag("MaintainedByDiffblue")
  ...
  void testEchoWithContextArgument_thenCallsGetEventTimestamp() {
    ...
    verify(context).getStreamId();
    verify(messageService).send(eq("42"), eq("Received argument: Argument at 1970-01-01T00:00:00.001Z"));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link EchoActivity#echo(CommandContext, Cashtag)}
   */
  @Test
  @DisplayName("Test echo(CommandContext, Cashtag) with 'context', 'cashtag'; then calls getStreamId()")
  @Tag("MaintainedByDiffblue")
  ...
  void testEchoWithContextCashtag_thenCallsGetStreamId() {
    ...
    // Assert
    verify(context).getStreamId();
    verify(messageService).send(eq("42"), eq("Received cashtag: 42"));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link EchoActivity#echo(CommandContext, Hashtag)}
   */
  @Test
  @DisplayName("Test echo(CommandContext, Hashtag) with 'context', 'hashtag'; then calls getStreamId()")
  @Tag("MaintainedByDiffblue")
  ...
  void testEchoWithContextHashtag_thenCallsGetStreamId() {
    ...
    // Assert
    verify(context).getStreamId();
    verify(messageService).send(eq("42"), eq("Received hashtag: 42"));
  }
   ...
   * </ul>
   * <p>
   * Method under test: {@link EchoActivity#echo(CommandContext, Mention)}
   */
  @Test
  @DisplayName("Test echo(CommandContext, Mention) with 'context', 'mention'; then calls getStreamId()")
  @Tag("MaintainedByDiffblue")
  ...
  void testEchoWithContextMention_thenCallsGetStreamId() {
    ...
    // Assert
    verify(context).getStreamId();
    verify(messageService).send(eq("42"), eq("Received mention: ext of id: 1"));
  }
}
